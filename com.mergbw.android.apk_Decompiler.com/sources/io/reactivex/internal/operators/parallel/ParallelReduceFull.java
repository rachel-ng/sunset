        ...
        public SlotPair<T> addValue(T t) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.current, (Object) null, slotPair)) {
                        continue;
                    }
                }
                ...
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.current, slotPair, (Object) null);
            }
            if (tryAcquireSlot == 0) {
                slotPair.first = t;
            } else {
