            ...
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    ...
                    if (!this.cancelled) {
                        ...
                        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.timer, (Object) null, schedulePeriodicallyDirect)) {
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                synchronized (BufferSkipBoundedObserver.this) {
                    BufferSkipBoundedObserver.this.buffers.remove(this.f57b);
                }
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.f57b, false, bufferSkipBoundedObserver.w);
            }
        }
