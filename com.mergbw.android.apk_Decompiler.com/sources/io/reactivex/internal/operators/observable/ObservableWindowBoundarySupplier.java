...
public final class ObservableWindowBoundarySupplier<T, B> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    static final class WindowBoundaryMainObserver<T, B> extends AtomicInteger implements Observer<T>, Disposable, Runnable {
        ...
        public void innerNext(WindowBoundaryInnerObserver<T, B> windowBoundaryInnerObserver) {
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.boundaryObserver, windowBoundaryInnerObserver, (Object) null);
            this.queue.offer(NEXT_WINDOW);
            drain();
        }
                        ...
                        if (z && z2) {
                            ...
                            if (!this.stopWindows.get()) {
                                ...
                                try {
                                    ...
                                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.boundaryObserver, (Object) null, windowBoundaryInnerObserver)) {
