...
public final class ObservableSwitchMapMaybe<T, R> extends Observable<R> {
    ...
    static final class SwitchMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void innerError(SwitchMapMaybeObserver<R> switchMapMaybeObserver, Throwable th) {
            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapMaybeObserver, (Object) null) || !this.errors.addThrowable(th)) {
                RxJavaPlugins.onError(th);
                return;
            }
            if (!this.delayErrors) {
        ...
        public void innerComplete(SwitchMapMaybeObserver<R> switchMapMaybeObserver) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapMaybeObserver, (Object) null)) {
                drain();
            }
        }
                ...
                while (!this.cancelled) {
                    if (atomicThrowable.get() == null || this.delayErrors) {
                        ...
                        if (z && z2) {
                            ...
                            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, switchMapMaybeObserver, (Object) null);
