...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void innerError(SwitchMapSingleObserver<R> switchMapSingleObserver, Throwable th) {
            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapSingleObserver, (Object) null) || !this.errors.addThrowable(th)) {
                RxJavaPlugins.onError(th);
                return;
            }
            if (!this.delayErrors) {
                ...
                while (!this.cancelled) {
                    if (atomicThrowable.get() == null || this.delayErrors) {
                        ...
                        if (z && z2) {
                            ...
                            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, switchMapSingleObserver, (Object) null);
