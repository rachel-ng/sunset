...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        public void innerError(SwitchMapInnerObserver switchMapInnerObserver, Throwable th) {
            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, (Object) null) || !this.errors.addThrowable(th)) {
                RxJavaPlugins.onError(th);
            } else if (!this.delayErrors) {
                dispose();
                Throwable terminate = this.errors.terminate();
        ...
        public void innerComplete(SwitchMapInnerObserver switchMapInnerObserver) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, (Object) null) && this.done) {
                Throwable terminate = this.errors.terminate();
                if (terminate == null) {
                    this.downstream.onComplete();
                } else {
