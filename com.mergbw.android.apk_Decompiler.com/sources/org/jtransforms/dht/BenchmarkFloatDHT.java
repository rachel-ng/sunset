...
public class BenchmarkFloatDHT {
    ...
    public static void benchmarkForward_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                FloatDHT_1D floatDHT_1D = new FloatDHT_1D(sizes1D[i2]);
                long j = sizes1D[i2];
            ...
            FloatDHT_1D floatDHT_1D2 = new FloatDHT_1D(sizes1D[i2]);
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDHT_1D.txt", nthread, niter, doWarmup, doScaling, sizes1D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_2D_input_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                long j = sizes2D[i2];
                FloatDHT_2D floatDHT_2D = new FloatDHT_2D(j, j);
                long j2 = sizes2D[i2];
            ...
            long nanoTime = System.nanoTime();
            long j5 = sizes2D[i2];
            FloatDHT_2D floatDHT_2D2 = new FloatDHT_2D(j5, j5);
            dArr2[i2] = ((double) (System.nanoTime() - nanoTime)) / 1000000.0d;
            long j6 = sizes2D[i2];
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                floatDHT_2D2.forward(floatLargeArray2);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDHT_2D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes2D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_2D_input_2D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDHT_2D_input_2D.txt", nthread, niter, doWarmup, doScaling, sizes2D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_3D_input_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                long j = sizes3D[i2];
                FloatDHT_3D floatDHT_3D = new FloatDHT_3D(j, j, j);
                long j2 = sizes3D[i2];
            ...
            long nanoTime = System.nanoTime();
            long j5 = sizes3D[i2];
            FloatDHT_3D floatDHT_3D2 = new FloatDHT_3D(j5, j5, j5);
            dArr2[i2] = ((double) (System.nanoTime() - nanoTime)) / 1000000.0d;
            long j6 = sizes3D[i2];
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                floatDHT_3D2.forward(floatLargeArray3);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDHT_3D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes3D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_3D_input_3D() {
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDHT_3D_input_3D.txt", nthread, niter, doWarmup, doScaling, sizes3D, dArr, dArr2);
    }
