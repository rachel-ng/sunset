...
public class DoubleDCT_3D {
    ...
    public void forward(double[] dArr, boolean z) {
        ...
        double[] dArr2 = dArr;
        boolean z2 = z;
        Class<DoubleDCT_3D> cls = DoubleDCT_3D.class;
        ...
        if (!this.isPowerOfTwo) {
            ...
            if (numberOfThreads <= 1 || !this.useThreads || (i2 = this.slices) < numberOfThreads || this.rows < numberOfThreads || this.columns < numberOfThreads) {
                for (int i4 = 0; i4 < this.slices; i4++) {
                    ...
                    for (int i6 = 0; i6 < this.rows; i6++) {
                        this.dctColumns.forward(dArr2, (this.rowStride * i6) + i5, z2);
                    }
                }
                ...
                for (int i12 = 0; i12 < this.rows; i12++) {
                    ...
                    for (int i14 = 0; i14 < this.columns; i14++) {
                        ...
                        this.dctSlices.forward(dArr4, z2);
                ...
                futureArr[i18] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i19; i < i20; i++) {
                            int access$000 = DoubleDCT_3D.this.sliceStride * i;
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.rows; i2++) {
                                DoubleDCT_3D.this.dctColumns.forward(dArr5, (DoubleDCT_3D.this.rowStride * i2) + access$000, z3);
                            }
                        }
                    }
                });
            ...
            while (i21 < numberOfThreads) {
                ...
                futureArr[i21] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        double[] dArr = new double[DoubleDCT_3D.this.rows];
                        for (int i = i22; i < i23; i++) {
                            int access$000 = DoubleDCT_3D.this.sliceStride * i;
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.columns; i2++) {
                                for (int i3 = 0; i3 < DoubleDCT_3D.this.rows; i3++) {
                                    dArr[i3] = dArr6[(DoubleDCT_3D.this.rowStride * i3) + access$000 + i2];
                                }
                                DoubleDCT_3D.this.dctRows.forward(dArr, z4);
                                for (int i4 = 0; i4 < DoubleDCT_3D.this.rows; i4++) {
                                    dArr6[(DoubleDCT_3D.this.rowStride * i4) + access$000 + i2] = dArr[i4];
                                }
                            }
                        }
                    }
            ...
            while (i3 < numberOfThreads) {
                ...
                futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        double[] dArr = new double[DoubleDCT_3D.this.slices];
                        for (int i = i25; i < i26; i++) {
                            int access$200 = DoubleDCT_3D.this.rowStride * i;
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.columns; i2++) {
                                for (int i3 = 0; i3 < DoubleDCT_3D.this.slices; i3++) {
                                    dArr[i3] = dArr7[(DoubleDCT_3D.this.sliceStride * i3) + access$200 + i2];
                                }
                                DoubleDCT_3D.this.dctSlices.forward(dArr, z5);
                                for (int i4 = 0; i4 < DoubleDCT_3D.this.slices; i4++) {
                                    dArr7[(DoubleDCT_3D.this.sliceStride * i4) + access$200 + i2] = dArr[i4];
                                }
                            }
                        }
                    }
        ...
        if (!this.isPowerOfTwo) {
                ...
                if (j >= j2 && this.rowsl >= j2 && this.columnsl >= j2) {
                        ...
                        futureArr[i] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                for (long j = j4; j < j5; j++) {
                                    long access$800 = DoubleDCT_3D.this.sliceStridel * j;
                                    for (long j2 = 0; j2 < DoubleDCT_3D.this.rowsl; j2++) {
                                        DoubleDCT_3D.this.dctColumns.forward(doubleLargeArray3, (DoubleDCT_3D.this.rowStridel * j2) + access$800, z3);
                                    }
                                }
                            }
                        });
                    ...
                    while (i2 < numberOfThreads) {
                        ...
                        futureArr[i2] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                DoubleLargeArray doubleLargeArray = new DoubleLargeArray(DoubleDCT_3D.this.rowsl, false);
                                for (long j = j8; j < j9; j++) {
                                    long access$800 = DoubleDCT_3D.this.sliceStridel * j;
                                    for (long j2 = 0; j2 < DoubleDCT_3D.this.columnsl; j2++) {
                                        for (long j3 = 0; j3 < DoubleDCT_3D.this.rowsl; j3++) {
                                            doubleLargeArray.setDouble(j3, doubleLargeArray4.getDouble((DoubleDCT_3D.this.rowStridel * j3) + access$800 + j2));
                                        }
                                        DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, z4);
                                        long j4 = 0;
                                        while (j4 < DoubleDCT_3D.this.rowsl) {
                                            doubleLargeArray4.setDouble((DoubleDCT_3D.this.rowStridel * j4) + access$800 + j2, doubleLargeArray.getDouble(j4));
                                            j4++;
                    ...
                    while (i3 < numberOfThreads) {
                        ...
                        futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                DoubleLargeArray doubleLargeArray = new DoubleLargeArray(DoubleDCT_3D.this.slicesl, false);
                                for (long j = j11; j < j12; j++) {
                                    long access$1000 = DoubleDCT_3D.this.rowStridel * j;
                                    for (long j2 = 0; j2 < DoubleDCT_3D.this.columnsl; j2++) {
                                        for (long j3 = 0; j3 < DoubleDCT_3D.this.slicesl; j3++) {
                                            doubleLargeArray.setDouble(j3, doubleLargeArray5.getDouble((DoubleDCT_3D.this.sliceStridel * j3) + access$1000 + j2));
                                        }
                                        DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, z5);
                                        long j4 = 0;
                                        while (j4 < DoubleDCT_3D.this.slicesl) {
                                            doubleLargeArray5.setDouble((DoubleDCT_3D.this.sliceStridel * j4) + access$1000 + j2, doubleLargeArray.getDouble(j4));
                                            j4++;
            ...
            for (long j13 = 0; j13 < this.slicesl; j13++) {
                ...
                for (long j15 = 0; j15 < this.rowsl; j15++) {
                    this.dctColumns.forward(doubleLargeArray2, (this.rowStridel * j15) + j14, z2);
                }
            }
            ...
            for (long j16 = 0; j16 < this.slicesl; j16++) {
                ...
                for (long j18 = 0; j18 < this.columnsl; j18++) {
                    ...
                    this.dctRows.forward(doubleLargeArray6, z2);
                    long j20 = 0;
            ...
            for (long j22 = 0; j22 < this.rowsl; j22++) {
                ...
                for (long j24 = 0; j24 < this.columnsl; j24++) {
                    ...
                    this.dctSlices.forward(doubleLargeArray7, z2);
                    long j26 = 0;
            ...
            if (numberOfThreads <= 1 || !this.useThreads || (i2 = this.slices) < numberOfThreads || this.rows < numberOfThreads || this.columns < numberOfThreads) {
                for (int i4 = 0; i4 < this.slices; i4++) {
                    for (int i5 = 0; i5 < this.rows; i5++) {
                        this.dctColumns.forward(dArr2[i4][i5], z2);
                    }
                }
                double[] dArr3 = new double[this.rows];
                int i6 = 0;
                ...
                futureArr[i15] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i16; i < i17; i++) {
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.rows; i2++) {
                                DoubleDCT_3D.this.dctColumns.forward(dArr5[i][i2], z3);
                            }
                        }
                    }
                });
        ...
        if (!this.isPowerOfTwo) {
            ...
            if (numberOfThreads <= 1 || !this.useThreads || (i2 = this.slices) < numberOfThreads || this.rows < numberOfThreads || this.columns < numberOfThreads) {
                for (int i4 = 0; i4 < this.slices; i4++) {
                    int i5 = this.sliceStride * i4;
                    for (int i6 = 0; i6 < this.rows; i6++) {
                        this.dctColumns.inverse(dArr2, (this.rowStride * i6) + i5, z2);
                    }
                }
                double[] dArr3 = new double[this.rows];
                int i7 = 0;
                ...
                for (int i12 = 0; i12 < this.rows; i12++) {
                    ...
                    for (int i14 = 0; i14 < this.columns; i14++) {
                        ...
                        this.dctSlices.inverse(dArr4, z2);
                        for (int i16 = 0; i16 < this.slices; i16++) {
                            dArr2[(this.sliceStride * i16) + i13 + i14] = dArr4[i16];
                        }
                    }
                ...
                futureArr[i18] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i19; i < i20; i++) {
                            int access$000 = DoubleDCT_3D.this.sliceStride * i;
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.rows; i2++) {
                                DoubleDCT_3D.this.dctColumns.inverse(dArr5, (DoubleDCT_3D.this.rowStride * i2) + access$000, z3);
                            }
                        }
                    }
                });
                    ...
                    public void run() {
                        ...
                        for (int i = i22; i < i23; i++) {
                            ...
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.columns; i2++) {
                                ...
                                DoubleDCT_3D.this.dctRows.inverse(dArr, z4);
                                for (int i4 = 0; i4 < DoubleDCT_3D.this.rows; i4++) {
                                    dArr6[(DoubleDCT_3D.this.rowStride * i4) + access$000 + i2] = dArr[i4];
                                }
                            }
                    ...
                    public void run() {
                        ...
                        for (int i = i25; i < i26; i++) {
                            ...
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.columns; i2++) {
                                ...
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, z5);
                                for (int i4 = 0; i4 < DoubleDCT_3D.this.slices; i4++) {
                                    dArr7[(DoubleDCT_3D.this.sliceStride * i4) + access$200 + i2] = dArr[i4];
                                }
                            }
    ...
    public void inverse(DoubleLargeArray doubleLargeArray, boolean z) {
        ...
        if (!this.isPowerOfTwo) {
                        ...
                        futureArr[i] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                for (long j = j4; j < j5; j++) {
                                    long access$800 = DoubleDCT_3D.this.sliceStridel * j;
                                    for (long j2 = 0; j2 < DoubleDCT_3D.this.rowsl; j2++) {
                                        DoubleDCT_3D.this.dctColumns.inverse(doubleLargeArray3, (DoubleDCT_3D.this.rowStridel * j2) + access$800, z3);
                                    }
                                }
                            }
                        });
                            ...
                            public void run() {
                                ...
                                for (long j = j8; j < j9; j++) {
                                    ...
                                    for (long j2 = 0; j2 < DoubleDCT_3D.this.columnsl; j2++) {
                                        ...
                                        DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, z4);
                                        long j4 = 0;
                                        while (j4 < DoubleDCT_3D.this.rowsl) {
                                            doubleLargeArray4.setDouble((DoubleDCT_3D.this.rowStridel * j4) + access$800 + j2, doubleLargeArray.getDouble(j4));
                                            j4++;
                            ...
                            public void run() {
                                ...
                                for (long j = j11; j < j12; j++) {
                                    ...
                                    for (long j2 = 0; j2 < DoubleDCT_3D.this.columnsl; j2++) {
                                        ...
                                        DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, z5);
                                        long j4 = 0;
                                        while (j4 < DoubleDCT_3D.this.slicesl) {
                                            doubleLargeArray5.setDouble((DoubleDCT_3D.this.sliceStridel * j4) + access$1000 + j2, doubleLargeArray.getDouble(j4));
                                            j4++;
            ...
            for (long j13 = 0; j13 < this.slicesl; j13++) {
                long j14 = this.sliceStridel * j13;
                for (long j15 = 0; j15 < this.rowsl; j15++) {
                    this.dctColumns.inverse(doubleLargeArray2, (this.rowStridel * j15) + j14, z2);
                }
            }
            DoubleLargeArray doubleLargeArray6 = new DoubleLargeArray(this.rowsl, false);
            for (long j16 = 0; j16 < this.slicesl; j16++) {
                ...
                for (long j18 = 0; j18 < this.columnsl; j18++) {
                    ...
                    this.dctRows.inverse(doubleLargeArray6, z2);
                    long j20 = 0;
                    while (j20 < this.rowsl) {
                        doubleLargeArray2.setDouble((this.rowStridel * j20) + j17 + j18, doubleLargeArray6.getDouble(j20));
                        j20++;
            ...
            for (long j22 = 0; j22 < this.rowsl; j22++) {
                ...
                for (long j24 = 0; j24 < this.columnsl; j24++) {
                    ...
                    this.dctSlices.inverse(doubleLargeArray7, z2);
                    long j26 = 0;
                    while (j26 < this.slicesl) {
                        doubleLargeArray2.setDouble((this.sliceStridel * j26) + j23 + j24, doubleLargeArray7.getDouble(j26));
                        j26++;
    ...
    public void inverse(double[][][] dArr, boolean z) {
        ...
        if (!this.isPowerOfTwo) {
            ...
            if (numberOfThreads <= 1 || !this.useThreads || (i2 = this.slices) < numberOfThreads || this.rows < numberOfThreads || this.columns < numberOfThreads) {
                for (int i4 = 0; i4 < this.slices; i4++) {
                    for (int i5 = 0; i5 < this.rows; i5++) {
                        this.dctColumns.inverse(dArr2[i4][i5], z2);
                    }
                }
                double[] dArr3 = new double[this.rows];
                int i6 = 0;
            ...
            while (i15 < numberOfThreads) {
                ...
                futureArr[i15] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i16; i < i17; i++) {
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.rows; i2++) {
                                DoubleDCT_3D.this.dctColumns.inverse(dArr5[i][i2], z3);
                            }
                        }
                    }
                });
    ...
    private void ddxt3da_sub(int i, DoubleLargeArray doubleLargeArray, boolean z) {
        ...
        if (i == -1) {
            ...
            while (j5 < this.slicesl) {
                ...
                for (long j7 = 0; j7 < this.rowsl; j7++) {
                    this.dctColumns.forward(doubleLargeArray2, (this.rowStridel * j7) + j6, z3);
                }
                ...
                if (j8 > j4) {
                    ...
                    while (j9 < this.columnsl) {
                        ...
                        long j16 = j6;
                        long j17 = j9;
                        this.dctRows.forward(doubleLargeArray3, 0, z3);
                        this.dctRows.forward(doubleLargeArray3, this.rowsl, z3);
                        this.dctRows.forward(doubleLargeArray3, this.rowsl * 2, z3);
                        this.dctRows.forward(doubleLargeArray3, this.rowsl * 3, z3);
                        long j18 = 0;
                        while (true) {
                            long j19 = this.rowsl;
                            if (j18 >= j19) {
        ...
        while (j27 < this.slicesl) {
            ...
            for (long j29 = 0; j29 < this.rowsl; j29++) {
                this.dctColumns.inverse(doubleLargeArray2, (this.rowStridel * j29) + j28, z3);
            }
            ...
            if (j30 > 2) {
                ...
                while (true) {
                    ...
                    long j36 = j28;
                    long j37 = j31;
                    this.dctRows.inverse(doubleLargeArray3, 0, z3);
                    this.dctRows.inverse(doubleLargeArray3, this.rowsl, z3);
                    this.dctRows.inverse(doubleLargeArray3, this.rowsl * 2, z3);
                    this.dctRows.inverse(doubleLargeArray3, this.rowsl * 3, z3);
                    long j38 = 0;
                    while (true) {
                        long j39 = this.rowsl;
                        if (j38 >= j39) {
                ...
                if (j30 == 2) {
                    ...
                    z2 = z;
                    this.dctRows.inverse(doubleLargeArray3, 0, z2);
                    this.dctRows.inverse(doubleLargeArray3, this.rowsl, z2);
            ...
            if (j3 > 2) {
                ...
                while (j4 < this.rowsl) {
                    ...
                    while (j6 < this.columnsl) {
                        ...
                        long j11 = j4;
                        long j12 = j5;
                        this.dctSlices.forward(doubleLargeArray3, 0, z2);
                        this.dctSlices.forward(doubleLargeArray3, this.slicesl, z2);
                        this.dctSlices.forward(doubleLargeArray3, this.slicesl * 2, z2);
                        this.dctSlices.forward(doubleLargeArray3, this.slicesl * 3, z2);
                        long j13 = 0;
                        while (true) {
            ...
            if (j24 > 2) {
                ...
                while (j25 < this.rowsl) {
                    ...
                    while (j27 < this.columnsl) {
                        ...
                        long j33 = j26;
                        long j34 = j27;
                        this.dctSlices.inverse(doubleLargeArray3, 0, z2);
                        this.dctSlices.inverse(doubleLargeArray3, this.slicesl, z2);
                        this.dctSlices.inverse(doubleLargeArray3, this.slicesl * 2, z2);
                        this.dctSlices.inverse(doubleLargeArray3, this.slicesl * 3, z2);
                        long j35 = 0;
                        while (true) {
                ...
                for (long j39 = 0; j39 < this.rowsl; j39++) {
                    ...
                    boolean z4 = z;
                    this.dctSlices.inverse(doubleLargeArray3, 0, z4);
                    this.dctSlices.inverse(doubleLargeArray3, this.slicesl, z4);
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            ...
            futureArr[i6] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (i8 == -1) {
                        int i = i9;
                        while (i < DoubleDCT_3D.this.slices) {
                            int access$000 = DoubleDCT_3D.this.sliceStride * i;
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.rows; i2++) {
                                DoubleDCT_3D.this.dctColumns.forward(dArr2, (DoubleDCT_3D.this.rowStride * i2) + access$000, z2);
                            }
                            if (DoubleDCT_3D.this.columns > 2) {
                                for (int i3 = 0; i3 < DoubleDCT_3D.this.columns; i3 += 4) {
                                    for (int i4 = 0; i4 < DoubleDCT_3D.this.rows; i4++) {
                                        int access$200 = (DoubleDCT_3D.this.rowStride * i4) + access$000 + i3;
                                        int access$100 = DoubleDCT_3D.this.rows + i4;
                                        double[] dArr2 = dArr2;
                                        dArr[i4] = dArr2[access$200];
                                        dArr[access$100] = dArr2[access$200 + 1];
                                        dArr[DoubleDCT_3D.this.rows + access$100] = dArr2[access$200 + 2];
                                        dArr[access$100 + (DoubleDCT_3D.this.rows * 2)] = dArr2[access$200 + 3];
                                    }
                                    DoubleDCT_3D.this.dctRows.forward(dArr, 0, z2);
                                    DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows, z2);
                                    DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows * 2, z2);
                                    DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows * 3, z2);
                                    for (int i5 = 0; i5 < DoubleDCT_3D.this.rows; i5++) {
                                        int access$2002 = (DoubleDCT_3D.this.rowStride * i5) + access$000 + i3;
                                        int access$1002 = DoubleDCT_3D.this.rows + i5;
                                        double[] dArr3 = dArr2;
                                        dArr3[access$2002] = dArr[i5];
                                        dArr3[access$2002 + 1] = dArr[access$1002];
                                        dArr3[access$2002 + 2] = dArr[DoubleDCT_3D.this.rows + access$1002];
                                        dArr2[access$2002 + 3] = dArr[access$1002 + (DoubleDCT_3D.this.rows * 2)];
                                    }
                                }
                            } else if (DoubleDCT_3D.this.columns == 2) {
                                for (int i6 = 0; i6 < DoubleDCT_3D.this.rows; i6++) {
                                    int access$2003 = (DoubleDCT_3D.this.rowStride * i6) + access$000;
                                    dArr[i6] = dArr2[access$2003];
                                    dArr[DoubleDCT_3D.this.rows + i6] = dArr2[access$2003 + 1];
                                }
                                DoubleDCT_3D.this.dctRows.forward(dArr, 0, z2);
                                DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows, z2);
                                for (int i7 = 0; i7 < DoubleDCT_3D.this.rows; i7++) {
                                    int access$2004 = (DoubleDCT_3D.this.rowStride * i7) + access$000;
                                    double[] dArr4 = dArr2;
                                    dArr4[access$2004] = dArr[i7];
                                    dArr4[access$2004 + 1] = dArr[DoubleDCT_3D.this.rows + i7];
                                }
                            }
                            i += i10;
                        }
                    ...
                    int i8 = i9;
                    while (i8 < DoubleDCT_3D.this.slices) {
                        int access$0002 = DoubleDCT_3D.this.sliceStride * i8;
                        for (int i9 = 0; i9 < DoubleDCT_3D.this.rows; i9++) {
                            DoubleDCT_3D.this.dctColumns.inverse(dArr2, (DoubleDCT_3D.this.rowStride * i9) + access$0002, z2);
                        }
                        if (DoubleDCT_3D.this.columns > 2) {
                            for (int i10 = 0; i10 < DoubleDCT_3D.this.columns; i10 += 4) {
                                for (int i11 = 0; i11 < DoubleDCT_3D.this.rows; i11++) {
                                    int access$2005 = (DoubleDCT_3D.this.rowStride * i11) + access$0002 + i10;
                                    int access$1003 = DoubleDCT_3D.this.rows + i11;
                                    double[] dArr5 = dArr2;
                                    dArr[i11] = dArr5[access$2005];
                                    dArr[access$1003] = dArr5[access$2005 + 1];
                                    dArr[DoubleDCT_3D.this.rows + access$1003] = dArr2[access$2005 + 2];
                                    dArr[access$1003 + (DoubleDCT_3D.this.rows * 2)] = dArr2[access$2005 + 3];
                                }
                                DoubleDCT_3D.this.dctRows.inverse(dArr, 0, z2);
                                DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows, z2);
                                DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows * 2, z2);
                                DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows * 3, z2);
                                for (int i12 = 0; i12 < DoubleDCT_3D.this.rows; i12++) {
                                    int access$2006 = (DoubleDCT_3D.this.rowStride * i12) + access$0002 + i10;
                                    int access$1004 = DoubleDCT_3D.this.rows + i12;
                                    double[] dArr6 = dArr2;
                                    dArr6[access$2006] = dArr[i12];
                                    dArr6[access$2006 + 1] = dArr[access$1004];
                                    dArr6[access$2006 + 2] = dArr[DoubleDCT_3D.this.rows + access$1004];
                                    dArr2[access$2006 + 3] = dArr[access$1004 + (DoubleDCT_3D.this.rows * 2)];
                                }
                            }
                        } else if (DoubleDCT_3D.this.columns == 2) {
                            for (int i13 = 0; i13 < DoubleDCT_3D.this.rows; i13++) {
                                int access$2007 = (DoubleDCT_3D.this.rowStride * i13) + access$0002;
                                dArr[i13] = dArr2[access$2007];
                                dArr[DoubleDCT_3D.this.rows + i13] = dArr2[access$2007 + 1];
                            }
                            DoubleDCT_3D.this.dctRows.inverse(dArr, 0, z2);
                            DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows, z2);
                            for (int i14 = 0; i14 < DoubleDCT_3D.this.rows; i14++) {
                                int access$2008 = (DoubleDCT_3D.this.rowStride * i14) + access$0002;
                                double[] dArr7 = dArr2;
                                dArr7[access$2008] = dArr[i14];
                                dArr7[access$2008 + 1] = dArr[DoubleDCT_3D.this.rows + i14];
                            }
                        }
                        i8 += i10;
                    }
        ...
        while (i3 < i2) {
            ...
            futureArr[i6] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (i4 == -1) {
                        long j5 = j4;
                        while (j5 < DoubleDCT_3D.this.slicesl) {
                            long access$800 = DoubleDCT_3D.this.sliceStridel * j5;
                            for (long j6 = 0; j6 < DoubleDCT_3D.this.rowsl; j6 += j4) {
                                DoubleDCT_3D.this.dctColumns.forward(doubleLargeArray2, (DoubleDCT_3D.this.rowStridel * j6) + access$800, z2);
                            }
                            if (DoubleDCT_3D.this.columnsl > j3) {
                                long j7 = 0;
                                while (j7 < DoubleDCT_3D.this.columnsl) {
                                    long j8 = 0;
                                    while (j8 < DoubleDCT_3D.this.rowsl) {
                                        long access$1000 = (DoubleDCT_3D.this.rowStridel * j8) + access$800 + j7;
                                        long access$900 = DoubleDCT_3D.this.rowsl + j8;
                                        ...
                                        doubleLargeArray.setDouble(DoubleDCT_3D.this.rowsl + access$900, doubleLargeArray2.getDouble(access$1000 + 2));
                                        doubleLargeArray.setDouble(access$900 + (DoubleDCT_3D.this.rowsl * 2), doubleLargeArray2.getDouble(access$1000 + 3));
                                        j8++;
                                        j5 = j5;
                                        j7 = j7;
                                    }
                                    long j9 = j5;
                                    long j10 = j7;
                                    DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, 0, z2);
                                    DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, DoubleDCT_3D.this.rowsl, z2);
                                    DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, DoubleDCT_3D.this.rowsl * 2, z2);
                                    DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, DoubleDCT_3D.this.rowsl * 3, z2);
                                    for (long j11 = 0; j11 < DoubleDCT_3D.this.rowsl; j11++) {
                                        long access$10002 = (DoubleDCT_3D.this.rowStridel * j11) + access$800 + j10;
                                        long access$9002 = DoubleDCT_3D.this.rowsl + j11;
                                        ...
                                        doubleLargeArray2.setDouble(access$10002 + 2, doubleLargeArray.getDouble(access$9002 + DoubleDCT_3D.this.rowsl));
                                        doubleLargeArray2.setDouble(access$10002 + 3, doubleLargeArray.getDouble(access$9002 + (DoubleDCT_3D.this.rowsl * 2)));
                                    }
                                    j7 = j10 + 4;
                                    j5 = j9;
                                }
                                ...
                                j2 = j5;
                                if (DoubleDCT_3D.this.columnsl == j3) {
                                    for (long j12 = 0; j12 < DoubleDCT_3D.this.rowsl; j12++) {
                                        long access$10003 = (DoubleDCT_3D.this.rowStridel * j12) + access$800;
                                        doubleLargeArray.setDouble(j12, doubleLargeArray2.getDouble(access$10003));
                                        doubleLargeArray.setDouble(DoubleDCT_3D.this.rowsl + j12, doubleLargeArray2.getDouble(access$10003 + 1));
                                    }
                                    DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, 0, z2);
                                    DoubleDCT_3D.this.dctRows.forward(doubleLargeArray, DoubleDCT_3D.this.rowsl, z2);
                                    for (long j13 = 0; j13 < DoubleDCT_3D.this.rowsl; j13++) {
                                        long access$10004 = (DoubleDCT_3D.this.rowStridel * j13) + access$800;
                                        doubleLargeArray2.setDouble(access$10004, doubleLargeArray.getDouble(j13));
                                        doubleLargeArray2.setDouble(access$10004 + 1, doubleLargeArray.getDouble(DoubleDCT_3D.this.rowsl + j13));
                                    }
                                }
                            }
                            j5 = j2 + ((long) i5);
                    ...
                    while (j14 < DoubleDCT_3D.this.slicesl) {
                        long access$8002 = DoubleDCT_3D.this.sliceStridel * j14;
                        for (long j15 = 0; j15 < DoubleDCT_3D.this.rowsl; j15++) {
                            DoubleDCT_3D.this.dctColumns.inverse(doubleLargeArray2, (DoubleDCT_3D.this.rowStridel * j15) + access$8002, z2);
                        }
                        if (DoubleDCT_3D.this.columnsl > 2) {
                            long j16 = 0;
                            while (j16 < DoubleDCT_3D.this.columnsl) {
                                long j17 = 0;
                                while (j17 < DoubleDCT_3D.this.rowsl) {
                                    long access$10005 = (DoubleDCT_3D.this.rowStridel * j17) + access$8002 + j16;
                                    long access$9003 = DoubleDCT_3D.this.rowsl + j17;
                                    ...
                                    doubleLargeArray.setDouble(DoubleDCT_3D.this.rowsl + access$9003, doubleLargeArray2.getDouble(access$10005 + 2));
                                    doubleLargeArray.setDouble(access$9003 + (DoubleDCT_3D.this.rowsl * 2), doubleLargeArray2.getDouble(access$10005 + 3));
                                    j17++;
                                    j14 = j14;
                                    j16 = j16;
                                }
                                long j18 = j14;
                                long j19 = j16;
                                DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, 0, z2);
                                DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, DoubleDCT_3D.this.rowsl, z2);
                                DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, DoubleDCT_3D.this.rowsl * 2, z2);
                                DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, DoubleDCT_3D.this.rowsl * 3, z2);
                                for (long j20 = 0; j20 < DoubleDCT_3D.this.rowsl; j20++) {
                                    long access$10006 = (DoubleDCT_3D.this.rowStridel * j20) + access$8002 + j19;
                                    long access$9004 = DoubleDCT_3D.this.rowsl + j20;
                                    ...
                                    doubleLargeArray2.setDouble(access$10006 + 2, doubleLargeArray.getDouble(access$9004 + DoubleDCT_3D.this.rowsl));
                                    doubleLargeArray2.setDouble(access$10006 + 3, doubleLargeArray.getDouble(access$9004 + (DoubleDCT_3D.this.rowsl * 2)));
                                }
                                j16 = j19 + 4;
                                j14 = j18;
                            }
                            ...
                            j = j14;
                            if (DoubleDCT_3D.this.columnsl == 2) {
                                for (long j21 = 0; j21 < DoubleDCT_3D.this.rowsl; j21++) {
                                    long access$10007 = (DoubleDCT_3D.this.rowStridel * j21) + access$8002;
                                    doubleLargeArray.setDouble(j21, doubleLargeArray2.getDouble(access$10007));
                                    doubleLargeArray.setDouble(DoubleDCT_3D.this.rowsl + j21, doubleLargeArray2.getDouble(access$10007 + 1));
                                }
                                DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, 0, z2);
                                DoubleDCT_3D.this.dctRows.inverse(doubleLargeArray, DoubleDCT_3D.this.rowsl, z2);
                                for (long j22 = 0; j22 < DoubleDCT_3D.this.rowsl; j22++) {
                                    long access$10008 = (DoubleDCT_3D.this.rowStridel * j22) + access$8002;
                                    doubleLargeArray2.setDouble(access$10008, doubleLargeArray.getDouble(j22));
                                    doubleLargeArray2.setDouble(access$10008 + 1, doubleLargeArray.getDouble(DoubleDCT_3D.this.rowsl + j22));
                                }
                            }
                        }
                        j14 = j + ((long) i5);
            ...
            futureArr[i6] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (i8 == -1) {
                        ...
                        while (i < DoubleDCT_3D.this.slices) {
                            for (int i2 = 0; i2 < DoubleDCT_3D.this.rows; i2++) {
                                DoubleDCT_3D.this.dctColumns.forward(dArr2[i][i2], z2);
                            }
                            if (DoubleDCT_3D.this.columns > 2) {
                                for (int i3 = 0; i3 < DoubleDCT_3D.this.columns; i3 += 4) {
                                    for (int i4 = 0; i4 < DoubleDCT_3D.this.rows; i4++) {
                                        ...
                                        dArr[DoubleDCT_3D.this.rows + access$100] = dArr2[i][i4][i3 + 2];
                                        dArr[access$100 + (DoubleDCT_3D.this.rows * 2)] = dArr2[i][i4][i3 + 3];
                                    }
                                    DoubleDCT_3D.this.dctRows.forward(dArr, 0, z2);
                                    DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows, z2);
                                    DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows * 2, z2);
                                    ...
                                    for (int i5 = 0; i5 < DoubleDCT_3D.this.rows; i5++) {
                                        ...
                                        dArr3[i3 + 2] = dArr[DoubleDCT_3D.this.rows + access$1002];
                                        dArr2[i][i5][i3 + 3] = dArr[access$1002 + (DoubleDCT_3D.this.rows * 2)];
                                    }
                                }
                            } else if (DoubleDCT_3D.this.columns == 2) {
                                for (int i6 = 0; i6 < DoubleDCT_3D.this.rows; i6++) {
                                    dArr[i6] = dArr2[i][i6][0];
                                    dArr[DoubleDCT_3D.this.rows + i6] = dArr2[i][i6][1];
                                }
                                DoubleDCT_3D.this.dctRows.forward(dArr, 0, z2);
                                DoubleDCT_3D.this.dctRows.forward(dArr, DoubleDCT_3D.this.rows, z2);
                                for (int i7 = 0; i7 < DoubleDCT_3D.this.rows; i7++) {
                                    ...
                                    dArr4[0] = dArr[i7];
                                    dArr4[1] = dArr[DoubleDCT_3D.this.rows + i7];
                                }
                            }
                            i += i10;
                        }
                    ...
                    while (i8 < DoubleDCT_3D.this.slices) {
                        for (int i9 = 0; i9 < DoubleDCT_3D.this.rows; i9++) {
                            DoubleDCT_3D.this.dctColumns.inverse(dArr2[i8][i9], z2);
                        }
                        if (DoubleDCT_3D.this.columns > 2) {
                            for (int i10 = 0; i10 < DoubleDCT_3D.this.columns; i10 += 4) {
                                for (int i11 = 0; i11 < DoubleDCT_3D.this.rows; i11++) {
                                    ...
                                    dArr[DoubleDCT_3D.this.rows + access$1003] = dArr2[i8][i11][i10 + 2];
                                    dArr[access$1003 + (DoubleDCT_3D.this.rows * 2)] = dArr2[i8][i11][i10 + 3];
                                }
                                DoubleDCT_3D.this.dctRows.inverse(dArr, 0, z2);
                                DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows, z2);
                                DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows * 2, z2);
                                ...
                                for (int i12 = 0; i12 < DoubleDCT_3D.this.rows; i12++) {
                                    ...
                                    dArr6[i10 + 2] = dArr[DoubleDCT_3D.this.rows + access$1004];
                                    dArr2[i8][i12][i10 + 3] = dArr[access$1004 + (DoubleDCT_3D.this.rows * 2)];
                                }
                            }
                        } else if (DoubleDCT_3D.this.columns == 2) {
                            for (int i13 = 0; i13 < DoubleDCT_3D.this.rows; i13++) {
                                dArr[i13] = dArr2[i8][i13][0];
                                dArr[DoubleDCT_3D.this.rows + i13] = dArr2[i8][i13][1];
                            }
                            DoubleDCT_3D.this.dctRows.inverse(dArr, 0, z2);
                            DoubleDCT_3D.this.dctRows.inverse(dArr, DoubleDCT_3D.this.rows, z2);
                            for (int i14 = 0; i14 < DoubleDCT_3D.this.rows; i14++) {
                                ...
                                dArr7[0] = dArr[i14];
                                dArr7[1] = dArr[DoubleDCT_3D.this.rows + i14];
                            }
                        }
                        i8 += i10;
                    }
            ...
            futureArr[i6] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (i8 == -1) {
                        if (DoubleDCT_3D.this.columns > 2) {
                            int i = i9;
                            while (i < DoubleDCT_3D.this.rows) {
                                int access$200 = DoubleDCT_3D.this.rowStride * i;
                                for (int i2 = 0; i2 < DoubleDCT_3D.this.columns; i2 += 4) {
                                    for (int i3 = 0; i3 < DoubleDCT_3D.this.slices; i3++) {
                                        int access$000 = (DoubleDCT_3D.this.sliceStride * i3) + access$200 + i2;
                                        int access$600 = DoubleDCT_3D.this.slices + i3;
                                        double[] dArr2 = dArr2;
                                        dArr[i3] = dArr2[access$000];
                                        dArr[access$600] = dArr2[access$000 + 1];
                                        dArr[DoubleDCT_3D.this.slices + access$600] = dArr2[access$000 + 2];
                                        dArr[access$600 + (DoubleDCT_3D.this.slices * 2)] = dArr2[access$000 + 3];
                                    }
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, 0, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices * 2, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices * 3, z2);
                                    for (int i4 = 0; i4 < DoubleDCT_3D.this.slices; i4++) {
                                        int access$0002 = (DoubleDCT_3D.this.sliceStride * i4) + access$200 + i2;
                                        int access$6002 = DoubleDCT_3D.this.slices + i4;
                                        double[] dArr3 = dArr2;
                                        dArr3[access$0002] = dArr[i4];
                                        dArr3[access$0002 + 1] = dArr[access$6002];
                                        dArr3[access$0002 + 2] = dArr[DoubleDCT_3D.this.slices + access$6002];
                                        dArr2[access$0002 + 3] = dArr[access$6002 + (DoubleDCT_3D.this.slices * 2)];
                                    }
                                }
                                i += i10;
                            }
                            ...
                            int i5 = i9;
                            while (i5 < DoubleDCT_3D.this.rows) {
                                int access$2002 = DoubleDCT_3D.this.rowStride * i5;
                                for (int i6 = 0; i6 < DoubleDCT_3D.this.slices; i6++) {
                                    int access$0003 = (DoubleDCT_3D.this.sliceStride * i6) + access$2002;
                                    dArr[i6] = dArr2[access$0003];
                                    dArr[DoubleDCT_3D.this.slices + i6] = dArr2[access$0003 + 1];
                                }
                                DoubleDCT_3D.this.dctSlices.forward(dArr, 0, z2);
                                DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices, z2);
                                for (int i7 = 0; i7 < DoubleDCT_3D.this.slices; i7++) {
                                    int access$0004 = (DoubleDCT_3D.this.sliceStride * i7) + access$2002;
                                    double[] dArr4 = dArr2;
                                    dArr4[access$0004] = dArr[i7];
                                    dArr4[access$0004 + 1] = dArr[DoubleDCT_3D.this.slices + i7];
                                }
                                i5 += i10;
                            }
                        }
                        ...
                        int i8 = i9;
                        while (i8 < DoubleDCT_3D.this.rows) {
                            int access$2003 = DoubleDCT_3D.this.rowStride * i8;
                            for (int i9 = 0; i9 < DoubleDCT_3D.this.columns; i9 += 4) {
                                for (int i10 = 0; i10 < DoubleDCT_3D.this.slices; i10++) {
                                    int access$0005 = (DoubleDCT_3D.this.sliceStride * i10) + access$2003 + i9;
                                    int access$6003 = DoubleDCT_3D.this.slices + i10;
                                    double[] dArr5 = dArr2;
                                    dArr[i10] = dArr5[access$0005];
                                    dArr[access$6003] = dArr5[access$0005 + 1];
                                    dArr[DoubleDCT_3D.this.slices + access$6003] = dArr2[access$0005 + 2];
                                    dArr[access$6003 + (DoubleDCT_3D.this.slices * 2)] = dArr2[access$0005 + 3];
                                }
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, 0, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices * 2, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices * 3, z2);
                                for (int i11 = 0; i11 < DoubleDCT_3D.this.slices; i11++) {
                                    int access$0006 = (DoubleDCT_3D.this.sliceStride * i11) + access$2003 + i9;
                                    int access$6004 = DoubleDCT_3D.this.slices + i11;
                                    double[] dArr6 = dArr2;
                                    dArr6[access$0006] = dArr[i11];
                                    dArr6[access$0006 + 1] = dArr[access$6004];
                                    dArr6[access$0006 + 2] = dArr[DoubleDCT_3D.this.slices + access$6004];
                                    dArr2[access$0006 + 3] = dArr[access$6004 + (DoubleDCT_3D.this.slices * 2)];
                                }
                            }
                            i8 += i10;
                        }
                        ...
                        while (i12 < DoubleDCT_3D.this.rows) {
                            int access$2004 = DoubleDCT_3D.this.rowStride * i12;
                            for (int i13 = 0; i13 < DoubleDCT_3D.this.slices; i13++) {
                                int access$0007 = (DoubleDCT_3D.this.sliceStride * i13) + access$2004;
                                dArr[i13] = dArr2[access$0007];
                                dArr[DoubleDCT_3D.this.slices + i13] = dArr2[access$0007 + 1];
                            }
                            DoubleDCT_3D.this.dctSlices.inverse(dArr, 0, z2);
                            DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices, z2);
                            for (int i14 = 0; i14 < DoubleDCT_3D.this.slices; i14++) {
                                int access$0008 = (DoubleDCT_3D.this.sliceStride * i14) + access$2004;
                                double[] dArr7 = dArr2;
                                dArr7[access$0008] = dArr[i14];
                                dArr7[access$0008 + 1] = dArr[DoubleDCT_3D.this.slices + i14];
                            }
                            i12 += i10;
                        }
                    }
            ...
            futureArr[i6] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (i4 == -1) {
                        if (DoubleDCT_3D.this.columnsl > 2) {
                            long j2 = j4;
                            while (j2 < DoubleDCT_3D.this.rowsl) {
                                long access$1000 = DoubleDCT_3D.this.rowStridel * j2;
                                long j3 = 0;
                                while (j3 < DoubleDCT_3D.this.columnsl) {
                                    long j4 = 0;
                                    while (j4 < DoubleDCT_3D.this.slicesl) {
                                        long access$800 = (DoubleDCT_3D.this.sliceStridel * j4) + access$1000 + j3;
                                        long access$1200 = DoubleDCT_3D.this.slicesl + j4;
                                        ...
                                        doubleLargeArray.setDouble(DoubleDCT_3D.this.slicesl + access$1200, doubleLargeArray2.getDouble(access$800 + 2));
                                        doubleLargeArray.setDouble(access$1200 + (DoubleDCT_3D.this.slicesl * 2), doubleLargeArray2.getDouble(access$800 + 3));
                                        j4++;
                                        j = 1;
                                        j2 = j2;
                                    }
                                    long j5 = j2;
                                    DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, 0, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, DoubleDCT_3D.this.slicesl, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, DoubleDCT_3D.this.slicesl * 2, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, DoubleDCT_3D.this.slicesl * 3, z2);
                                    for (long j6 = 0; j6 < DoubleDCT_3D.this.slicesl; j6++) {
                                        long access$8002 = (DoubleDCT_3D.this.sliceStridel * j6) + access$1000 + j3;
                                        long access$12002 = DoubleDCT_3D.this.slicesl + j6;
                                        ...
                                        doubleLargeArray2.setDouble(access$8002 + 2, doubleLargeArray.getDouble(access$12002 + DoubleDCT_3D.this.slicesl));
                                        doubleLargeArray2.setDouble(access$8002 + 3, doubleLargeArray.getDouble(access$12002 + (DoubleDCT_3D.this.slicesl * 2)));
                                    }
                                    j3 += 4;
                                    j2 = j5;
                                    j = 1;
                            ...
                            for (long j7 = j4; j7 < DoubleDCT_3D.this.rowsl; j7 += (long) i5) {
                                long access$10002 = DoubleDCT_3D.this.rowStridel * j7;
                                for (long j8 = 0; j8 < DoubleDCT_3D.this.slicesl; j8++) {
                                    long access$8003 = (DoubleDCT_3D.this.sliceStridel * j8) + access$10002;
                                    doubleLargeArray.setDouble(j8, doubleLargeArray2.getDouble(access$8003));
                                    doubleLargeArray.setDouble(DoubleDCT_3D.this.slicesl + j8, doubleLargeArray2.getDouble(access$8003 + 1));
                                }
                                DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, 0, z2);
                                DoubleDCT_3D.this.dctSlices.forward(doubleLargeArray, DoubleDCT_3D.this.slicesl, z2);
                                for (long j9 = 0; j9 < DoubleDCT_3D.this.slicesl; j9++) {
                                    long access$8004 = (DoubleDCT_3D.this.sliceStridel * j9) + access$10002;
                                    doubleLargeArray2.setDouble(access$8004, doubleLargeArray.getDouble(j9));
                                    doubleLargeArray2.setDouble(access$8004 + 1, doubleLargeArray.getDouble(DoubleDCT_3D.this.slicesl + j9));
                                }
                            }
                        }
                    } else if (DoubleDCT_3D.this.columnsl > 2) {
                        long j10 = j4;
                        while (j10 < DoubleDCT_3D.this.rowsl) {
                            long access$10003 = DoubleDCT_3D.this.rowStridel * j10;
                            long j11 = 0;
                            while (j11 < DoubleDCT_3D.this.columnsl) {
                                long j12 = 0;
                                while (j12 < DoubleDCT_3D.this.slicesl) {
                                    long access$8005 = (DoubleDCT_3D.this.sliceStridel * j12) + access$10003 + j11;
                                    long access$12003 = DoubleDCT_3D.this.slicesl + j12;
                                    ...
                                    doubleLargeArray.setDouble(DoubleDCT_3D.this.slicesl + access$12003, doubleLargeArray2.getDouble(access$8005 + 2));
                                    doubleLargeArray.setDouble(access$12003 + (DoubleDCT_3D.this.slicesl * 2), doubleLargeArray2.getDouble(access$8005 + 3));
                                    j12++;
                                    j10 = j10;
                                    j11 = j11;
                                }
                                long j13 = j10;
                                long j14 = j11;
                                DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, 0, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, DoubleDCT_3D.this.slicesl, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, DoubleDCT_3D.this.slicesl * 2, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, DoubleDCT_3D.this.slicesl * 3, z2);
                                for (long j15 = 0; j15 < DoubleDCT_3D.this.slicesl; j15++) {
                                    long access$8006 = (DoubleDCT_3D.this.sliceStridel * j15) + access$10003 + j14;
                                    long access$12004 = DoubleDCT_3D.this.slicesl + j15;
                                    ...
                                    doubleLargeArray2.setDouble(access$8006 + 2, doubleLargeArray.getDouble(access$12004 + DoubleDCT_3D.this.slicesl));
                                    doubleLargeArray2.setDouble(access$8006 + 3, doubleLargeArray.getDouble(access$12004 + (DoubleDCT_3D.this.slicesl * 2)));
                                }
                                j11 = j14 + 4;
                                j10 = j13;
                            }
                        ...
                        for (long j16 = j4; j16 < DoubleDCT_3D.this.rowsl; j16 += (long) i5) {
                            long access$10004 = DoubleDCT_3D.this.rowStridel * j16;
                            for (long j17 = 0; j17 < DoubleDCT_3D.this.slicesl; j17++) {
                                long access$8007 = (DoubleDCT_3D.this.sliceStridel * j17) + access$10004;
                                doubleLargeArray.setDouble(j17, doubleLargeArray2.getDouble(access$8007));
                                doubleLargeArray.setDouble(DoubleDCT_3D.this.slicesl + j17, doubleLargeArray2.getDouble(access$8007 + 1));
                            }
                            DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, 0, z2);
                            DoubleDCT_3D.this.dctSlices.inverse(doubleLargeArray, DoubleDCT_3D.this.slicesl, z2);
                            for (long j18 = 0; j18 < DoubleDCT_3D.this.slicesl; j18++) {
                                long access$8008 = (DoubleDCT_3D.this.sliceStridel * j18) + access$10004;
                                doubleLargeArray2.setDouble(access$8008, doubleLargeArray.getDouble(j18));
                                doubleLargeArray2.setDouble(access$8008 + 1, doubleLargeArray.getDouble(DoubleDCT_3D.this.slicesl + j18));
                            }
                        }
                    }
                }
                    ...
                    if (i8 == -1) {
                        if (DoubleDCT_3D.this.columns > 2) {
                            ...
                            while (i < DoubleDCT_3D.this.rows) {
                                for (int i2 = 0; i2 < DoubleDCT_3D.this.columns; i2 += 4) {
                                    for (int i3 = 0; i3 < DoubleDCT_3D.this.slices; i3++) {
                                        ...
                                        dArr[DoubleDCT_3D.this.slices + access$600] = dArr2[i3][i][i2 + 2];
                                        dArr[access$600 + (DoubleDCT_3D.this.slices * 2)] = dArr2[i3][i][i2 + 3];
                                    }
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, 0, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices, z2);
                                    DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices * 2, z2);
                                    ...
                                    for (int i4 = 0; i4 < DoubleDCT_3D.this.slices; i4++) {
                                        ...
                                        dArr3[i2 + 2] = dArr[DoubleDCT_3D.this.slices + access$6002];
                                        dArr2[i4][i][i2 + 3] = dArr[access$6002 + (DoubleDCT_3D.this.slices * 2)];
                                    }
                                }
                                i += i10;
                            }
                            ...
                            while (i5 < DoubleDCT_3D.this.rows) {
                                for (int i6 = 0; i6 < DoubleDCT_3D.this.slices; i6++) {
                                    ...
                                    dArr[DoubleDCT_3D.this.slices + i6] = dArr2[i6][i5][1];
                                }
                                DoubleDCT_3D.this.dctSlices.forward(dArr, 0, z2);
                                DoubleDCT_3D.this.dctSlices.forward(dArr, DoubleDCT_3D.this.slices, z2);
                                for (int i7 = 0; i7 < DoubleDCT_3D.this.slices; i7++) {
                                    ...
                                    dArr4[0] = dArr[i7];
                                    dArr4[1] = dArr[DoubleDCT_3D.this.slices + i7];
                                }
                                i5 += i10;
                            }
                        }
                        ...
                        while (i8 < DoubleDCT_3D.this.rows) {
                            for (int i9 = 0; i9 < DoubleDCT_3D.this.columns; i9 += 4) {
                                for (int i10 = 0; i10 < DoubleDCT_3D.this.slices; i10++) {
                                    ...
                                    dArr[DoubleDCT_3D.this.slices + access$6003] = dArr2[i10][i8][i9 + 2];
                                    dArr[access$6003 + (DoubleDCT_3D.this.slices * 2)] = dArr2[i10][i8][i9 + 3];
                                }
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, 0, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices, z2);
                                DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices * 2, z2);
                                ...
                                for (int i11 = 0; i11 < DoubleDCT_3D.this.slices; i11++) {
                                    ...
                                    dArr6[i9 + 2] = dArr[DoubleDCT_3D.this.slices + access$6004];
                                    dArr2[i11][i8][i9 + 3] = dArr[access$6004 + (DoubleDCT_3D.this.slices * 2)];
                                }
                            }
                            i8 += i10;
                        }
                        ...
                        while (i12 < DoubleDCT_3D.this.rows) {
                            for (int i13 = 0; i13 < DoubleDCT_3D.this.slices; i13++) {
                                ...
                                dArr[DoubleDCT_3D.this.slices + i13] = dArr2[i13][i12][1];
                            }
                            DoubleDCT_3D.this.dctSlices.inverse(dArr, 0, z2);
                            DoubleDCT_3D.this.dctSlices.inverse(dArr, DoubleDCT_3D.this.slices, z2);
                            for (int i14 = 0; i14 < DoubleDCT_3D.this.slices; i14++) {
                                ...
                                dArr7[0] = dArr[i14];
                                dArr7[1] = dArr[DoubleDCT_3D.this.slices + i14];
                            }
                            i12 += i10;
                        }
                    }
