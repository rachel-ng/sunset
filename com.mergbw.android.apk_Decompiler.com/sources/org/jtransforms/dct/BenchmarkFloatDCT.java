...
public class BenchmarkFloatDCT {
    ...
    public static void benchmarkForward_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                FloatDCT_1D floatDCT_1D = new FloatDCT_1D(sizes1D[i2]);
                long j = sizes1D[i2];
            ...
            FloatDCT_1D floatDCT_1D2 = new FloatDCT_1D(sizes1D[i2]);
    ...
    public static void benchmarkForward_2D_input_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                long j = sizes2D[i2];
                FloatDCT_2D floatDCT_2D = new FloatDCT_2D(j, j);
                long j2 = sizes2D[i2];
            ...
            long nanoTime = System.nanoTime();
            long j5 = sizes2D[i2];
            FloatDCT_2D floatDCT_2D2 = new FloatDCT_2D(j5, j5);
            dArr2[i2] = ((double) (System.nanoTime() - nanoTime)) / 1000000.0d;
            long j6 = sizes2D[i2];
    ...
    public static void benchmarkForward_3D_input_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                long j = sizes3D[i2];
                FloatDCT_3D floatDCT_3D = new FloatDCT_3D(j, j, j);
                long j2 = sizes3D[i2];
            ...
            long nanoTime = System.nanoTime();
            long j5 = sizes3D[i2];
            FloatDCT_3D floatDCT_3D2 = new FloatDCT_3D(j5, j5, j5);
            dArr2[i2] = ((double) (System.nanoTime() - nanoTime)) / 1000000.0d;
            long j6 = sizes3D[i2];
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                floatDCT_3D2.forward(floatLargeArray3, doScaling);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
    ...
    public static void benchmarkForward_3D_input_3D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                floatDCT_3D2.forward(fArr3, doScaling);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
