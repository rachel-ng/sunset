...
public class DoubleDST_2D {
    ...
    public void forward(double[] dArr, boolean z) {
        int i;
        int i2;
        Class<DoubleDST_2D> cls = DoubleDST_2D.class;
        ...
        if (this.isPowerOfTwo) {
            ...
            while (true) {
                ...
                this.dstColumns.forward(dArr, this.columns * i4, z);
                i4++;
            }
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            DoubleDST_2D.this.dstColumns.forward(dArr3, DoubleDST_2D.this.columns * i, z2);
                        }
                    }
                });
                i9++;
            ...
            while (i3 < numberOfThreads) {
                ...
                futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        double[] dArr = new double[DoubleDST_2D.this.rows];
                        for (int i = i13; i < i14; i++) {
                            for (int i2 = 0; i2 < DoubleDST_2D.this.rows; i2++) {
                                dArr[i2] = dArr4[(DoubleDST_2D.this.columns * i2) + i];
                            }
                            DoubleDST_2D.this.dstRows.forward(dArr, z3);
                            for (int i3 = 0; i3 < DoubleDST_2D.this.rows; i3++) {
                                dArr4[(DoubleDST_2D.this.columns * i3) + i] = dArr[i3];
                            }
                        }
                    }
                });
    ...
    public void forward(DoubleLargeArray doubleLargeArray, boolean z) {
        ...
        if (!this.isPowerOfTwo) {
                ...
                if (j >= j2 && this.columnsl >= j2) {
                        ...
                        futureArr[i2] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                for (long j = j4; j < j5; j++) {
                                    DoubleDST_2D.this.dstColumns.forward(doubleLargeArray3, DoubleDST_2D.this.columnsl * j, z3);
                                }
                            }
                        });
                        i2++;
                    ...
                    while (i < numberOfThreads) {
                        ...
                        futureArr[i] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                DoubleLargeArray doubleLargeArray = new DoubleLargeArray(DoubleDST_2D.this.rowsl, false);
                                for (long j = j9; j < j10; j++) {
                                    for (long j2 = 0; j2 < DoubleDST_2D.this.rowsl; j2++) {
                                        doubleLargeArray.setDouble(j2, doubleLargeArray4.getDouble((DoubleDST_2D.this.columnsl * j2) + j));
                                    }
                                    DoubleDST_2D.this.dstRows.forward(doubleLargeArray, z4);
                                    for (long j3 = 0; j3 < DoubleDST_2D.this.rowsl; j3++) {
                                        doubleLargeArray4.setDouble((DoubleDST_2D.this.columnsl * j3) + j, doubleLargeArray.getDouble(j3));
                                    }
                                }
                            }
                        });
            ...
            for (long j11 = 0; j11 < this.rowsl; j11++) {
                this.dstColumns.forward(doubleLargeArray2, this.columnsl * j11, z2);
            }
            ...
            for (long j12 = 0; j12 < this.columnsl; j12++) {
                ...
                this.dstRows.forward(doubleLargeArray5, z2);
            ...
            for (long j15 = 0; j15 < this.rowsl; j15++) {
                this.dstColumns.forward(doubleLargeArray2, this.columnsl * j15, z2);
            }
        } else {
    ...
    public void forward(double[][] dArr, boolean z) {
        ...
        if (this.isPowerOfTwo) {
            ...
            while (true) {
                ...
                this.dstColumns.forward(dArr[i4], z);
                i4++;
            }
            double[] dArr2 = new double[i];
            for (int i5 = 0; i5 < this.columns; i5++) {
            ...
            while (i9 < numberOfThreads) {
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            DoubleDST_2D.this.dstColumns.forward(dArr3[i], z2);
                        }
                    }
                });
                i9++;
    ...
    public void inverse(double[] dArr, boolean z) {
        ...
        if (this.isPowerOfTwo) {
            ...
            while (true) {
                ...
                this.dstColumns.inverse(dArr, this.columns * i4, z);
                i4++;
            }
            double[] dArr2 = new double[i];
            for (int i5 = 0; i5 < this.columns; i5++) {
            ...
            while (i9 < numberOfThreads) {
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            DoubleDST_2D.this.dstColumns.inverse(dArr3, DoubleDST_2D.this.columns * i, z2);
                        }
                    }
                });
                i9++;
                ...
                futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        ...
                        for (int i = i13; i < i14; i++) {
                            ...
                            DoubleDST_2D.this.dstRows.inverse(dArr, z3);
                            for (int i3 = 0; i3 < DoubleDST_2D.this.rows; i3++) {
                                dArr4[(DoubleDST_2D.this.columns * i3) + i] = dArr[i3];
                            }
                        }
    ...
    public void inverse(DoubleLargeArray doubleLargeArray, boolean z) {
        ...
        if (!this.isPowerOfTwo) {
                ...
                if (j >= j2 && this.columnsl >= j2) {
                    ...
                    while (i2 < numberOfThreads) {
                        ...
                        futureArr[i2] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                for (long j = j4; j < j5; j++) {
                                    DoubleDST_2D.this.dstColumns.inverse(doubleLargeArray3, DoubleDST_2D.this.columnsl * j, z3);
                                }
                            }
                        });
                        i2++;
                        ...
                        futureArr[i] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                ...
                                for (long j = j9; j < j10; j++) {
                                    ...
                                    DoubleDST_2D.this.dstRows.inverse(doubleLargeArray, z4);
                                    for (long j3 = 0; j3 < DoubleDST_2D.this.rowsl; j3++) {
                                        doubleLargeArray4.setDouble((DoubleDST_2D.this.columnsl * j3) + j, doubleLargeArray.getDouble(j3));
                                    }
                                }
            ...
            for (long j11 = 0; j11 < this.rowsl; j11++) {
                this.dstColumns.inverse(doubleLargeArray2, this.columnsl * j11, z2);
            }
            DoubleLargeArray doubleLargeArray5 = new DoubleLargeArray(this.rowsl, false);
            for (long j12 = 0; j12 < this.columnsl; j12++) {
                for (long j13 = 0; j13 < this.rowsl; j13++) {
                ...
                this.dstRows.inverse(doubleLargeArray5, z2);
                for (long j14 = 0; j14 < this.rowsl; j14++) {
                    doubleLargeArray2.setDouble((this.columnsl * j14) + j12, doubleLargeArray5.getDouble(j14));
                }
            }
            ...
            ddxt2d_sub(1, doubleLargeArray2, z2);
            for (long j15 = 0; j15 < this.rowsl; j15++) {
                this.dstColumns.inverse(doubleLargeArray2, this.columnsl * j15, z2);
            }
        } else {
            ddxt2d_subth(1, doubleLargeArray2, z2);
            ddxt2d0_subth(1, doubleLargeArray2, z2);
    ...
    public void inverse(double[][] dArr, boolean z) {
        ...
        if (this.isPowerOfTwo) {
            ...
            while (true) {
                ...
                this.dstColumns.inverse(dArr[i4], z);
                i4++;
            }
            double[] dArr2 = new double[i];
            for (int i5 = 0; i5 < this.columns; i5++) {
            ...
            while (i9 < numberOfThreads) {
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            DoubleDST_2D.this.dstColumns.inverse(dArr3[i], z2);
                        }
                    }
                });
                i9++;
            ...
            futureArr[i5] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (DoubleDST_2D.this.columns > 2) {
                        if (i7 == -1) {
                            int i = i8 * 4;
                            while (i < DoubleDST_2D.this.columns) {
                                for (int i2 = 0; i2 < DoubleDST_2D.this.rows; i2++) {
                                    int access$000 = (DoubleDST_2D.this.columns * i2) + i;
                                    int access$200 = DoubleDST_2D.this.rows + i2;
                                    double[] dArr2 = dArr2;
                                    dArr[i2] = dArr2[access$000];
                                    dArr[access$200] = dArr2[access$000 + 1];
                                    dArr[DoubleDST_2D.this.rows + access$200] = dArr2[access$000 + 2];
                                    dArr[access$200 + (DoubleDST_2D.this.rows * 2)] = dArr2[access$000 + 3];
                                }
                                DoubleDST_2D.this.dstRows.forward(dArr, 0, z2);
                                DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows, z2);
                                DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows * 2, z2);
                                DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows * 3, z2);
                                for (int i3 = 0; i3 < DoubleDST_2D.this.rows; i3++) {
                                    int access$0002 = (DoubleDST_2D.this.columns * i3) + i;
                                    int access$2002 = DoubleDST_2D.this.rows + i3;
                                    double[] dArr3 = dArr2;
                                    dArr3[access$0002] = dArr[i3];
                                    dArr3[access$0002 + 1] = dArr[access$2002];
                                    dArr3[access$0002 + 2] = dArr[DoubleDST_2D.this.rows + access$2002];
                                    dArr2[access$0002 + 3] = dArr[access$2002 + (DoubleDST_2D.this.rows * 2)];
                                }
                                i += i9 * 4;
                            }
                            return;
                        ...
                        int i4 = i8 * 4;
                        while (i4 < DoubleDST_2D.this.columns) {
                            for (int i5 = 0; i5 < DoubleDST_2D.this.rows; i5++) {
                                int access$0003 = (DoubleDST_2D.this.columns * i5) + i4;
                                int access$2003 = DoubleDST_2D.this.rows + i5;
                                double[] dArr4 = dArr2;
                                dArr[i5] = dArr4[access$0003];
                                dArr[access$2003] = dArr4[access$0003 + 1];
                                dArr[DoubleDST_2D.this.rows + access$2003] = dArr2[access$0003 + 2];
                                dArr[access$2003 + (DoubleDST_2D.this.rows * 2)] = dArr2[access$0003 + 3];
                            }
                            DoubleDST_2D.this.dstRows.inverse(dArr, 0, z2);
                            DoubleDST_2D.this.dstRows.inverse(dArr, DoubleDST_2D.this.rows, z2);
                            DoubleDST_2D.this.dstRows.inverse(dArr, DoubleDST_2D.this.rows * 2, z2);
                            DoubleDST_2D.this.dstRows.inverse(dArr, DoubleDST_2D.this.rows * 3, z2);
                            for (int i6 = 0; i6 < DoubleDST_2D.this.rows; i6++) {
                                int access$0004 = (DoubleDST_2D.this.columns * i6) + i4;
                                int access$2004 = DoubleDST_2D.this.rows + i6;
                                double[] dArr5 = dArr2;
                                dArr5[access$0004] = dArr[i6];
                                dArr5[access$0004 + 1] = dArr[access$2004];
                                dArr5[access$0004 + 2] = dArr[DoubleDST_2D.this.rows + access$2004];
                                dArr2[access$0004 + 3] = dArr[access$2004 + (DoubleDST_2D.this.rows * 2)];
                            }
                            i4 += i9 * 4;
                        }
                    } else if (DoubleDST_2D.this.columns == 2) {
                        for (int i7 = 0; i7 < DoubleDST_2D.this.rows; i7++) {
                            int access$0005 = (DoubleDST_2D.this.columns * i7) + (i8 * 2);
                            dArr[i7] = dArr2[access$0005];
                            dArr[DoubleDST_2D.this.rows + i7] = dArr2[access$0005 + 1];
                        }
                        if (i7 == -1) {
                            DoubleDST_2D.this.dstRows.forward(dArr, 0, z2);
                            DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows, z2);
                        ...
                        for (int i8 = 0; i8 < DoubleDST_2D.this.rows; i8++) {
                            int access$0006 = (DoubleDST_2D.this.columns * i8) + (i8 * 2);
                            double[] dArr6 = dArr2;
                            dArr6[access$0006] = dArr[i8];
                            dArr6[access$0006 + 1] = dArr[DoubleDST_2D.this.rows + i8];
                        }
                    }
                }
            });
    ...
    private void ddxt2d_subth(int r19, pl.edu.icm.jlargearrays.DoubleLargeArray r20, boolean r21) {
        ...
        L_0x006e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jtransforms.dst.DoubleDST_2D.ddxt2d_subth(int, pl.edu.icm.jlargearrays.DoubleLargeArray, boolean):void");
    }
                    ...
                    if (DoubleDST_2D.this.columns > 2) {
                        if (i7 == -1) {
                            ...
                            while (i < DoubleDST_2D.this.columns) {
                                for (int i2 = 0; i2 < DoubleDST_2D.this.rows; i2++) {
                                    ...
                                    dArr[DoubleDST_2D.this.rows + access$200] = dArr2[i2][i + 2];
                                    dArr[access$200 + (DoubleDST_2D.this.rows * 2)] = dArr2[i2][i + 3];
                                }
                                DoubleDST_2D.this.dstRows.forward(dArr, 0, z2);
                                DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows, z2);
                                DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows * 2, z2);
                                ...
                                for (int i3 = 0; i3 < DoubleDST_2D.this.rows; i3++) {
                                    ...
                                    dArr3[i + 2] = dArr[DoubleDST_2D.this.rows + access$2002];
                                    dArr2[i3][i + 3] = dArr[access$2002 + (DoubleDST_2D.this.rows * 2)];
                                }
                                i += i9 * 4;
                            }
                            return;
                        ...
                        while (i4 < DoubleDST_2D.this.columns) {
                            for (int i5 = 0; i5 < DoubleDST_2D.this.rows; i5++) {
                                ...
                                dArr[DoubleDST_2D.this.rows + access$2003] = dArr2[i5][i4 + 2];
                                dArr[access$2003 + (DoubleDST_2D.this.rows * 2)] = dArr2[i5][i4 + 3];
                            }
                            DoubleDST_2D.this.dstRows.inverse(dArr, 0, z2);
                            DoubleDST_2D.this.dstRows.inverse(dArr, DoubleDST_2D.this.rows, z2);
                            DoubleDST_2D.this.dstRows.inverse(dArr, DoubleDST_2D.this.rows * 2, z2);
                            ...
                            for (int i6 = 0; i6 < DoubleDST_2D.this.rows; i6++) {
                                ...
                                dArr5[i4 + 2] = dArr[DoubleDST_2D.this.rows + access$2004];
                                dArr2[i6][i4 + 3] = dArr[access$2004 + (DoubleDST_2D.this.rows * 2)];
                            }
                            i4 += i9 * 4;
                        }
                    } else if (DoubleDST_2D.this.columns == 2) {
                        for (int i7 = 0; i7 < DoubleDST_2D.this.rows; i7++) {
                            ...
                            dArr[DoubleDST_2D.this.rows + i7] = dArr2[i7][(i8 * 2) + 1];
                        }
                        if (i7 == -1) {
                            DoubleDST_2D.this.dstRows.forward(dArr, 0, z2);
                            DoubleDST_2D.this.dstRows.forward(dArr, DoubleDST_2D.this.rows, z2);
                        ...
                        for (int i8 = 0; i8 < DoubleDST_2D.this.rows; i8++) {
                            ...
                            int i9 = i8;
                            dArr6[i9 * 2] = dArr[i8];
                            dArr6[(i9 * 2) + 1] = dArr[DoubleDST_2D.this.rows + i8];
                        }
                    }
                }
            });
                ...
                public void run() {
                    if (i4 == -1) {
                        ...
                        while (i < DoubleDST_2D.this.rows) {
                            DoubleDST_2D.this.dstColumns.forward(dArr2, DoubleDST_2D.this.columns * i, z2);
                            i += i6;
                        }
                        return;
                    }
                    int i2 = i5;
                    while (i2 < DoubleDST_2D.this.rows) {
                        DoubleDST_2D.this.dstColumns.inverse(dArr2, DoubleDST_2D.this.columns * i2, z2);
                        i2 += i6;
                    }
                }
            });
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    if (i4 == -1) {
                        long j = j2;
                        while (j < DoubleDST_2D.this.rowsl) {
                            DoubleDST_2D.this.dstColumns.forward(doubleLargeArray2, DoubleDST_2D.this.columnsl * j, z2);
                            j += (long) i5;
                        }
                        return;
                    }
                    long j2 = j2;
                    while (j2 < ((long) DoubleDST_2D.this.rows)) {
                        DoubleDST_2D.this.dstColumns.inverse(doubleLargeArray2, DoubleDST_2D.this.columnsl * j2, z2);
                        j2 += (long) i5;
                    }
                }
            });
            ...
            futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    if (i4 == -1) {
                        int i = i5;
                        while (i < DoubleDST_2D.this.rows) {
                            DoubleDST_2D.this.dstColumns.forward(dArr2[i], z2);
                            i += i6;
                        }
                        return;
                    }
                    int i2 = i5;
                    while (i2 < DoubleDST_2D.this.rows) {
                        DoubleDST_2D.this.dstColumns.inverse(dArr2[i2], z2);
                        i2 += i6;
                    }
                }
            });
    ...
    private void ddxt2d_sub(int r24, pl.edu.icm.jlargearrays.DoubleLargeArray r25, boolean r26) {
        ...
        L_0x0038:
            ...
            goto L_0x0038
        L_0x007c:
            org.jtransforms.dst.DoubleDST_1D r1 = r0.dstRows
            r4 = 0
        ...
        L_0x020a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jtransforms.dst.DoubleDST_2D.ddxt2d_sub(int, pl.edu.icm.jlargearrays.DoubleLargeArray, boolean):void");
    }
