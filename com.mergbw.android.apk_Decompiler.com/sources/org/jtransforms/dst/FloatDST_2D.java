...
public class FloatDST_2D {
    ...
    public FloatDST_2D(long j, long j2) {
        boolean z = false;
        if (j <= 1 || j2 <= 1) {
        ...
        if (j == j2) {
            this.dstColumns = floatDST_1D;
        } else {
            this.dstColumns = new FloatDST_1D(j2);
        }
    }
    ...
    public void forward(float[] fArr, boolean z) {
        int i;
        int i2;
        Class<FloatDST_2D> cls = FloatDST_2D.class;
        ...
        if (this.isPowerOfTwo) {
            if (numberOfThreads <= 1 || !this.useThreads) {
                ddxt2d_sub(-1, fArr, z);
                while (i3 < this.rows) {
                    this.dstColumns.forward(fArr, this.columns * i3, z);
                    i3++;
                }
                return;
            }
            ...
            while (true) {
                ...
                this.dstColumns.forward(fArr, this.columns * i4, z);
                i4++;
            }
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            FloatDST_2D.this.dstColumns.forward(fArr3, FloatDST_2D.this.columns * i, z2);
                        }
                    }
                });
                i9++;
            ...
            while (i3 < numberOfThreads) {
                ...
                futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        float[] fArr = new float[FloatDST_2D.this.rows];
                        for (int i = i13; i < i14; i++) {
                            for (int i2 = 0; i2 < FloatDST_2D.this.rows; i2++) {
                                fArr[i2] = fArr4[(FloatDST_2D.this.columns * i2) + i];
                            }
                            FloatDST_2D.this.dstRows.forward(fArr, z3);
                            for (int i3 = 0; i3 < FloatDST_2D.this.rows; i3++) {
                                fArr4[(FloatDST_2D.this.columns * i3) + i] = fArr[i3];
                            }
                        }
                    }
                });
    ...
    public void forward(FloatLargeArray floatLargeArray, boolean z) {
        ...
        if (!this.isPowerOfTwo) {
                ...
                if (j >= j2 && this.columnsl >= j2) {
                        ...
                        futureArr[i2] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                for (long j = j4; j < j5; j++) {
                                    FloatDST_2D.this.dstColumns.forward(floatLargeArray3, FloatDST_2D.this.columnsl * j, z3);
                                }
                            }
                        });
                        i2++;
                    ...
                    while (i < numberOfThreads) {
                        ...
                        futureArr[i] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                FloatLargeArray floatLargeArray = new FloatLargeArray(FloatDST_2D.this.rowsl, false);
                                for (long j = j9; j < j10; j++) {
                                    for (long j2 = 0; j2 < FloatDST_2D.this.rowsl; j2++) {
                                        floatLargeArray.setFloat(j2, floatLargeArray4.getFloat((FloatDST_2D.this.columnsl * j2) + j));
                                    }
                                    FloatDST_2D.this.dstRows.forward(floatLargeArray, z4);
                                    for (long j3 = 0; j3 < FloatDST_2D.this.rowsl; j3++) {
                                        floatLargeArray4.setFloat((FloatDST_2D.this.columnsl * j3) + j, floatLargeArray.getFloat(j3));
                                    }
                                }
                            }
                        });
            ...
            for (long j11 = 0; j11 < this.rowsl; j11++) {
                this.dstColumns.forward(floatLargeArray2, this.columnsl * j11, z2);
            }
            ...
            for (long j12 = 0; j12 < this.columnsl; j12++) {
                ...
                this.dstRows.forward(floatLargeArray5, z2);
            ...
            for (long j15 = 0; j15 < this.rowsl; j15++) {
                this.dstColumns.forward(floatLargeArray2, this.columnsl * j15, z2);
            }
        } else {
    ...
    public void forward(float[][] fArr, boolean z) {
        ...
        if (this.isPowerOfTwo) {
            if (numberOfThreads <= 1 || !this.useThreads) {
                ddxt2d_sub(-1, fArr, z);
                while (i3 < this.rows) {
                    this.dstColumns.forward(fArr[i3], z);
                    i3++;
                }
                return;
            }
            ...
            while (true) {
                ...
                this.dstColumns.forward(fArr[i4], z);
                i4++;
            }
            float[] fArr2 = new float[i];
            for (int i5 = 0; i5 < this.columns; i5++) {
            ...
            while (i9 < numberOfThreads) {
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            FloatDST_2D.this.dstColumns.forward(fArr3[i], z2);
                        }
                    }
                });
                i9++;
    ...
    public void inverse(float[] fArr, boolean z) {
        ...
        if (this.isPowerOfTwo) {
            if (numberOfThreads <= 1 || !this.useThreads) {
                ddxt2d_sub(1, fArr, z);
                while (i3 < this.rows) {
                    this.dstColumns.inverse(fArr, this.columns * i3, z);
                    i3++;
                }
                return;
            }
            ...
            while (true) {
                ...
                this.dstColumns.inverse(fArr, this.columns * i4, z);
                i4++;
            }
            float[] fArr2 = new float[i];
            for (int i5 = 0; i5 < this.columns; i5++) {
            ...
            while (i9 < numberOfThreads) {
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            FloatDST_2D.this.dstColumns.inverse(fArr3, FloatDST_2D.this.columns * i, z2);
                        }
                    }
                });
                i9++;
                ...
                futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        ...
                        for (int i = i13; i < i14; i++) {
                            ...
                            FloatDST_2D.this.dstRows.inverse(fArr, z3);
                            for (int i3 = 0; i3 < FloatDST_2D.this.rows; i3++) {
                                fArr4[(FloatDST_2D.this.columns * i3) + i] = fArr[i3];
                            }
                        }
    ...
    public void inverse(FloatLargeArray floatLargeArray, boolean z) {
        ...
        if (!this.isPowerOfTwo) {
                ...
                if (j >= j2 && this.columnsl >= j2) {
                    ...
                    while (i2 < numberOfThreads) {
                        ...
                        futureArr[i2] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                for (long j = j4; j < j5; j++) {
                                    FloatDST_2D.this.dstColumns.inverse(floatLargeArray3, FloatDST_2D.this.columnsl * j, z3);
                                }
                            }
                        });
                        i2++;
                        ...
                        futureArr[i] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                            public void run() {
                                ...
                                for (long j = j9; j < j10; j++) {
                                    ...
                                    FloatDST_2D.this.dstRows.inverse(floatLargeArray, z4);
                                    for (long j3 = 0; j3 < FloatDST_2D.this.rowsl; j3++) {
                                        floatLargeArray4.setFloat((FloatDST_2D.this.columnsl * j3) + j, floatLargeArray.getFloat(j3));
                                    }
                                }
            ...
            for (long j11 = 0; j11 < this.rowsl; j11++) {
                this.dstColumns.inverse(floatLargeArray2, this.columnsl * j11, z2);
            }
            FloatLargeArray floatLargeArray5 = new FloatLargeArray(this.rowsl, false);
            for (long j12 = 0; j12 < this.columnsl; j12++) {
                for (long j13 = 0; j13 < this.rowsl; j13++) {
                ...
                this.dstRows.inverse(floatLargeArray5, z2);
                for (long j14 = 0; j14 < this.rowsl; j14++) {
                    floatLargeArray2.setFloat((this.columnsl * j14) + j12, floatLargeArray5.getFloat(j14));
                }
            }
            ...
            ddxt2d_sub(1, floatLargeArray2, z2);
            for (long j15 = 0; j15 < this.rowsl; j15++) {
                this.dstColumns.inverse(floatLargeArray2, this.columnsl * j15, z2);
            }
        } else {
            ddxt2d_subth(1, floatLargeArray2, z2);
            ddxt2d0_subth(1, floatLargeArray2, z2);
    ...
    public void inverse(float[][] fArr, boolean z) {
        ...
        if (this.isPowerOfTwo) {
            if (numberOfThreads <= 1 || !this.useThreads) {
                ddxt2d_sub(1, fArr, z);
                while (i3 < this.rows) {
                    this.dstColumns.inverse(fArr[i3], z);
                    i3++;
                }
                return;
            }
            ...
            while (true) {
                ...
                this.dstColumns.inverse(fArr[i4], z);
                i4++;
            }
            float[] fArr2 = new float[i];
            for (int i5 = 0; i5 < this.columns; i5++) {
            ...
            while (i9 < numberOfThreads) {
                ...
                futureArr[i9] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                    public void run() {
                        for (int i = i10; i < i11; i++) {
                            FloatDST_2D.this.dstColumns.inverse(fArr3[i], z2);
                        }
                    }
                });
                i9++;
            ...
            futureArr[i5] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    ...
                    if (FloatDST_2D.this.columns > 2) {
                        if (i7 == -1) {
                            int i = i8 * 4;
                            while (i < FloatDST_2D.this.columns) {
                                for (int i2 = 0; i2 < FloatDST_2D.this.rows; i2++) {
                                    int access$000 = (FloatDST_2D.this.columns * i2) + i;
                                    int access$200 = FloatDST_2D.this.rows + i2;
                                    float[] fArr2 = fArr2;
                                    fArr[i2] = fArr2[access$000];
                                    fArr[access$200] = fArr2[access$000 + 1];
                                    fArr[FloatDST_2D.this.rows + access$200] = fArr2[access$000 + 2];
                                    fArr[access$200 + (FloatDST_2D.this.rows * 2)] = fArr2[access$000 + 3];
                                }
                                FloatDST_2D.this.dstRows.forward(fArr, 0, z2);
                                FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows, z2);
                                FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows * 2, z2);
                                FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows * 3, z2);
                                for (int i3 = 0; i3 < FloatDST_2D.this.rows; i3++) {
                                    int access$0002 = (FloatDST_2D.this.columns * i3) + i;
                                    int access$2002 = FloatDST_2D.this.rows + i3;
                                    float[] fArr3 = fArr2;
                                    fArr3[access$0002] = fArr[i3];
                                    fArr3[access$0002 + 1] = fArr[access$2002];
                                    fArr3[access$0002 + 2] = fArr[FloatDST_2D.this.rows + access$2002];
                                    fArr2[access$0002 + 3] = fArr[access$2002 + (FloatDST_2D.this.rows * 2)];
                                }
                                i += i9 * 4;
                            }
                            return;
                        ...
                        int i4 = i8 * 4;
                        while (i4 < FloatDST_2D.this.columns) {
                            for (int i5 = 0; i5 < FloatDST_2D.this.rows; i5++) {
                                int access$0003 = (FloatDST_2D.this.columns * i5) + i4;
                                int access$2003 = FloatDST_2D.this.rows + i5;
                                float[] fArr4 = fArr2;
                                fArr[i5] = fArr4[access$0003];
                                fArr[access$2003] = fArr4[access$0003 + 1];
                                fArr[FloatDST_2D.this.rows + access$2003] = fArr2[access$0003 + 2];
                                fArr[access$2003 + (FloatDST_2D.this.rows * 2)] = fArr2[access$0003 + 3];
                            }
                            FloatDST_2D.this.dstRows.inverse(fArr, 0, z2);
                            FloatDST_2D.this.dstRows.inverse(fArr, FloatDST_2D.this.rows, z2);
                            FloatDST_2D.this.dstRows.inverse(fArr, FloatDST_2D.this.rows * 2, z2);
                            FloatDST_2D.this.dstRows.inverse(fArr, FloatDST_2D.this.rows * 3, z2);
                            for (int i6 = 0; i6 < FloatDST_2D.this.rows; i6++) {
                                int access$0004 = (FloatDST_2D.this.columns * i6) + i4;
                                int access$2004 = FloatDST_2D.this.rows + i6;
                                float[] fArr5 = fArr2;
                                fArr5[access$0004] = fArr[i6];
                                fArr5[access$0004 + 1] = fArr[access$2004];
                                fArr5[access$0004 + 2] = fArr[FloatDST_2D.this.rows + access$2004];
                                fArr2[access$0004 + 3] = fArr[access$2004 + (FloatDST_2D.this.rows * 2)];
                            }
                            i4 += i9 * 4;
                        }
                    } else if (FloatDST_2D.this.columns == 2) {
                        for (int i7 = 0; i7 < FloatDST_2D.this.rows; i7++) {
                            int access$0005 = (FloatDST_2D.this.columns * i7) + (i8 * 2);
                            fArr[i7] = fArr2[access$0005];
                            fArr[FloatDST_2D.this.rows + i7] = fArr2[access$0005 + 1];
                        }
                        if (i7 == -1) {
                            FloatDST_2D.this.dstRows.forward(fArr, 0, z2);
                            FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows, z2);
                        ...
                        for (int i8 = 0; i8 < FloatDST_2D.this.rows; i8++) {
                            int access$0006 = (FloatDST_2D.this.columns * i8) + (i8 * 2);
                            float[] fArr6 = fArr2;
                            fArr6[access$0006] = fArr[i8];
                            fArr6[access$0006 + 1] = fArr[FloatDST_2D.this.rows + i8];
                        }
                    }
                }
            });
    ...
    private void ddxt2d_subth(int r19, pl.edu.icm.jlargearrays.FloatLargeArray r20, boolean r21) {
        /*
            r18 = this;
            r11 = r18
            java.lang.Class<org.jtransforms.dst.FloatDST_2D> r12 = org.jtransforms.dst.FloatDST_2D.class
        ...
        L_0x002b:
            ...
            long r6 = (long) r10
            org.jtransforms.dst.FloatDST_2D$14 r16 = new org.jtransforms.dst.FloatDST_2D$14
            r1 = r16
            r2 = r18
            r3 = r13
            r5 = r19
        ...
        L_0x006e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jtransforms.dst.FloatDST_2D.ddxt2d_subth(int, pl.edu.icm.jlargearrays.FloatLargeArray, boolean):void");
    }
                    ...
                    if (FloatDST_2D.this.columns > 2) {
                        if (i7 == -1) {
                            ...
                            while (i < FloatDST_2D.this.columns) {
                                for (int i2 = 0; i2 < FloatDST_2D.this.rows; i2++) {
                                    ...
                                    fArr[FloatDST_2D.this.rows + access$200] = fArr2[i2][i + 2];
                                    fArr[access$200 + (FloatDST_2D.this.rows * 2)] = fArr2[i2][i + 3];
                                }
                                FloatDST_2D.this.dstRows.forward(fArr, 0, z2);
                                FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows, z2);
                                FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows * 2, z2);
                                ...
                                for (int i3 = 0; i3 < FloatDST_2D.this.rows; i3++) {
                                    ...
                                    fArr3[i + 2] = fArr[FloatDST_2D.this.rows + access$2002];
                                    fArr2[i3][i + 3] = fArr[access$2002 + (FloatDST_2D.this.rows * 2)];
                                }
                                i += i9 * 4;
                            }
                            return;
                        ...
                        while (i4 < FloatDST_2D.this.columns) {
                            for (int i5 = 0; i5 < FloatDST_2D.this.rows; i5++) {
                                ...
                                fArr[FloatDST_2D.this.rows + access$2003] = fArr2[i5][i4 + 2];
                                fArr[access$2003 + (FloatDST_2D.this.rows * 2)] = fArr2[i5][i4 + 3];
                            }
                            FloatDST_2D.this.dstRows.inverse(fArr, 0, z2);
                            FloatDST_2D.this.dstRows.inverse(fArr, FloatDST_2D.this.rows, z2);
                            FloatDST_2D.this.dstRows.inverse(fArr, FloatDST_2D.this.rows * 2, z2);
                            ...
                            for (int i6 = 0; i6 < FloatDST_2D.this.rows; i6++) {
                                ...
                                fArr5[i4 + 2] = fArr[FloatDST_2D.this.rows + access$2004];
                                fArr2[i6][i4 + 3] = fArr[access$2004 + (FloatDST_2D.this.rows * 2)];
                            }
                            i4 += i9 * 4;
                        }
                    } else if (FloatDST_2D.this.columns == 2) {
                        for (int i7 = 0; i7 < FloatDST_2D.this.rows; i7++) {
                            ...
                            fArr[FloatDST_2D.this.rows + i7] = fArr2[i7][(i8 * 2) + 1];
                        }
                        if (i7 == -1) {
                            FloatDST_2D.this.dstRows.forward(fArr, 0, z2);
                            FloatDST_2D.this.dstRows.forward(fArr, FloatDST_2D.this.rows, z2);
                        ...
                        for (int i8 = 0; i8 < FloatDST_2D.this.rows; i8++) {
                            ...
                            int i9 = i8;
                            fArr6[i9 * 2] = fArr[i8];
                            fArr6[(i9 * 2) + 1] = fArr[FloatDST_2D.this.rows + i8];
                        }
                    }
                }
            });
                ...
                public void run() {
                    if (i4 == -1) {
                        ...
                        while (i < FloatDST_2D.this.rows) {
                            FloatDST_2D.this.dstColumns.forward(fArr2, FloatDST_2D.this.columns * i, z2);
                            i += i6;
                        }
                        return;
                    }
                    int i2 = i5;
                    while (i2 < FloatDST_2D.this.rows) {
                        FloatDST_2D.this.dstColumns.inverse(fArr2, FloatDST_2D.this.columns * i2, z2);
                        i2 += i6;
                    }
                }
            });
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    if (i4 == -1) {
                        long j = j2;
                        while (j < FloatDST_2D.this.rowsl) {
                            FloatDST_2D.this.dstColumns.forward(floatLargeArray2, FloatDST_2D.this.columnsl * j, z2);
                            j += (long) i5;
                        }
                        return;
                    }
                    long j2 = j2;
                    while (j2 < ((long) FloatDST_2D.this.rows)) {
                        FloatDST_2D.this.dstColumns.inverse(floatLargeArray2, FloatDST_2D.this.columnsl * j2, z2);
                        j2 += (long) i5;
                    }
                }
            });
            ...
            futureArr[i3] = ConcurrencyUtils.submit((Runnable) new Runnable() {
                public void run() {
                    if (i4 == -1) {
                        int i = i5;
                        while (i < FloatDST_2D.this.rows) {
                            FloatDST_2D.this.dstColumns.forward(fArr2[i], z2);
                            i += i6;
                        }
                        return;
                    }
                    int i2 = i5;
                    while (i2 < FloatDST_2D.this.rows) {
                        FloatDST_2D.this.dstColumns.inverse(fArr2[i2], z2);
                        i2 += i6;
                    }
                }
            });
    ...
    private void ddxt2d_sub(int r24, pl.edu.icm.jlargearrays.FloatLargeArray r25, boolean r26) {
        ...
        L_0x0038:
            ...
            goto L_0x0038
        L_0x007a:
            org.jtransforms.dst.FloatDST_1D r1 = r0.dstRows
            r4 = 0
        ...
        L_0x0208:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jtransforms.dst.FloatDST_2D.ddxt2d_sub(int, pl.edu.icm.jlargearrays.FloatLargeArray, boolean):void");
    }
