...
public class BenchmarkDoubleDST {
    ...
    public static void benchmarkForward_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                DoubleDST_1D doubleDST_1D = new DoubleDST_1D(sizes1D[i2]);
                long j = sizes1D[i2];
                double[] dArr3 = new double[((int) j)];
                IOUtils.fillMatrix_1D(j, dArr3);
                doubleDST_1D.forward(dArr3, doScaling);
                IOUtils.fillMatrix_1D(sizes1D[i2], dArr3);
                doubleDST_1D.forward(dArr3, doScaling);
            }
            long nanoTime = System.nanoTime();
            DoubleDST_1D doubleDST_1D2 = new DoubleDST_1D(sizes1D[i2]);
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                doubleDST_1D2.forward(dArr4, doScaling);
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDST_1D.txt", nthread, niter, doWarmup, doScaling, sizes1D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_2D_input_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            long nanoTime = System.nanoTime();
            long j5 = sizes2D[i2];
            DoubleDST_2D doubleDST_2D2 = new DoubleDST_2D(j5, j5);
            dArr2[i2] = ((double) (System.nanoTime() - nanoTime)) / 1000000.0d;
            long j6 = sizes2D[i2];
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                doubleDST_2D2.forward(doubleLargeArray2, doScaling);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDST_2D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes2D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_2D_input_2D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                ...
                doubleDST_2D.forward(dArr3, doScaling);
                long j4 = sizes2D[i2];
            ...
            for (int i5 = 0; i5 < niter; i5++) {
                ...
                long nanoTime2 = System.nanoTime();
                doubleDST_2D2.forward(dArr4, doScaling);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDST_2D_input_2D.txt", nthread, niter, doWarmup, doScaling, sizes2D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_3D_input_1D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                long j = sizes3D[i2];
                DoubleDST_3D doubleDST_3D = new DoubleDST_3D(j, j, j);
                long j2 = sizes3D[i2];
                ...
                doubleDST_3D.forward(doubleLargeArray, doScaling);
                long j4 = sizes3D[i2];
            ...
            long nanoTime = System.nanoTime();
            long j5 = sizes3D[i2];
            DoubleDST_3D doubleDST_3D2 = new DoubleDST_3D(j5, j5, j5);
            dArr2[i2] = ((double) (System.nanoTime() - nanoTime)) / 1000000.0d;
            long j6 = sizes3D[i2];
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                doubleDST_3D2.forward(doubleLargeArray3, doScaling);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDST_3D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes3D, dArr, dArr2);
    }
    ...
    public static void benchmarkForward_3D_input_3D() {
        ...
        for (int i2 = 0; i2 < nsize; i2++) {
            ...
            if (doWarmup) {
                ...
                doubleDST_3D.forward(dArr3, doScaling);
                long j4 = sizes3D[i2];
            ...
            for (int i3 = 0; i3 < niter; i3++) {
                ...
                long nanoTime2 = System.nanoTime();
                doubleDST_3D2.forward(dArr5, doScaling);
                double nanoTime3 = (double) (System.nanoTime() - nanoTime2);
                if (nanoTime3 < d) {
                    d = nanoTime3;
                }
        ...
        IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDST_3D_input_3D.txt", nthread, niter, doWarmup, doScaling, sizes3D, dArr, dArr2);
    }
