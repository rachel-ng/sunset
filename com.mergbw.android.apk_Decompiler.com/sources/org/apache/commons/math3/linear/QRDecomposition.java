...
public class QRDecomposition {
    ...
    public void performHouseholderReflection(int i, double[][] dArr) {
        ...
        double sqrt = dArr3[i] > 0.0d ? -FastMath.sqrt(d) : FastMath.sqrt(d);
        this.rDiag[i] = sqrt;
        if (sqrt != 0.0d) {
            ...
            for (int i3 = i + 1; i3 < dArr2.length; i3++) {
                ...
                double d4 = d3 / (dArr3[i] * sqrt);
                for (int i5 = i; i5 < dArr4.length; i5++) {
                    dArr4[i5] = dArr4[i5] - (dArr3[i5] * d4);
                }
            }
        }
    }
        ...
        public RealMatrix solve(RealMatrix realMatrix) {
            ...
            if (realMatrix.getRowDimension() != length2) {
                ...
                while (i3 < i2) {
                    ...
                    int i5 = min - i4;
                    realMatrix.copySubMatrix(0, length2 - 1, i4, min - 1, dArr2);
                    int i6 = i;
                    while (true) {
                        d = 1.0d;
                        if (i6 >= FastMath.min(length2, length)) {
                            break;
                        }
                        double[] dArr4 = this.qrt[i6];
                        double d2 = 1.0d / (this.rDiag[i6] * dArr4[i6]);
                        int i7 = columnDimension;
                        int i8 = i2;
                    ...
                    while (length3 >= 0) {
                        ...
                        double[] dArr8 = createBlocksLayout[(i15 * i14) + i3];
                        int i17 = (length3 - i16) * i5;
                        int i18 = 0;
                        while (i18 < i5) {
                            double d6 = dArr7[i18] * d5;
                            dArr7[i18] = d6;
                            dArr8[i17] = d6;
                            i18++;
                            i17++;
                        ...
                        for (int i19 = 0; i19 < length3; i19++) {
                            ...
                            for (int i20 = 0; i20 < i5; i20++) {
                                dArr10[i20] = dArr10[i20] - (dArr7[i20] * d7);
                            }
                        }
                        length3--;
                        d = 1.0d;
