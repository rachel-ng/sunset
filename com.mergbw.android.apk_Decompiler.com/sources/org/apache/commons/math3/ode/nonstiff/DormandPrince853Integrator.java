...
public class DormandPrince853Integrator extends EmbeddedRungeKuttaIntegrator {
    ...
    public double estimateError(double[][] dArr, double[] dArr2, double[] dArr3, double d) {
        ...
        while (i2 < this.mainSetDimension) {
            double d5 = dArr[c2][i2];
            double d6 = E1_01 * d5;
            double d7 = dArr[5][i2];
            double d8 = d6 + (E1_06 * d7);
            double d9 = dArr[6][i2];
            double d10 = d8 + (E1_07 * d9);
            double d11 = dArr[7][i2];
            double d12 = d10 + (E1_08 * d11);
            double d13 = dArr[8][i2];
            double d14 = d12 + (E1_09 * d13);
            double d15 = dArr[9][i2];
            double d16 = d14 + (E1_10 * d15);
            double d17 = dArr[10][i2];
            double d18 = d16 + (E1_11 * d17);
            double d19 = dArr[11][i2];
            double d20 = d18 + (E1_12 * d19);
            double d21 = (d5 * E2_01) + (d7 * E2_06) + (d9 * E2_07) + (d11 * E2_08) + (d13 * E2_09) + (d15 * E2_10) + (d17 * E2_11) + (d19 * E2_12);
            double max = FastMath.max(FastMath.abs(dArr2[i2]), FastMath.abs(dArr3[i2]));
            if (this.vecAbsoluteTolerance == null) {
                i = i2;
                d2 = this.scalAbsoluteTolerance + (this.scalRelativeTolerance * max);
            } else {
                i = i2;
                d2 = this.vecAbsoluteTolerance[i] + (this.vecRelativeTolerance[i] * max);
            }
            double d22 = d20 / d2;
            d3 += d22 * d22;
            double d23 = d21 / d2;
        ...
        double d24 = (d4 * 0.01d) + d3;
        if (d24 <= 0.0d) {
            d24 = 1.0d;
        }
        return (FastMath.abs(d) * d3) / FastMath.sqrt(((double) this.mainSetDimension) * d24);
    }
}
