...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2308deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2310deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m2309deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        Intrinsics.checkNotNullExpressionValue(enabledCipherSuites, "socketEnabledCipherSuites");
        String[] effectiveCipherSuites = Internal.effectiveCipherSuites(this, enabledCipherSuites);
        if (this.tlsVersionsAsString != null) {
            String[] enabledProtocols = sSLSocket.getEnabledProtocols();
            Intrinsics.checkNotNullExpressionValue(enabledProtocols, "sslSocket.enabledProtocols");
            strArr = Util.intersect(enabledProtocols, this.tlsVersionsAsString, ComparisonsKt.naturalOrder());
        } else {
        ...
        Intrinsics.checkNotNullExpressionValue(strArr, "tlsVersionsIntersection");
        return cipherSuites.tlsVersions((String[]) Arrays.copyOf(strArr, strArr.length)).build();
    }
