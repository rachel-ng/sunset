...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        public Reader(Source source2, int i, int i2) {
            Intrinsics.checkNotNullParameter(source2, FirebaseAnalytics.Param.SOURCE);
    ...
    public final ByteString checkLowercase(ByteString byteString) throws IOException {
        Intrinsics.checkNotNullParameter(byteString, AppMeasurementSdk.ConditionalUserProperty.NAME);
