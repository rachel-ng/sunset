...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0076, code lost:
        if (r4.exhausted() == false) goto L_0x0078;
     */
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:24:0x0088=Splitter:B:24:0x0088, B:16:0x0069=Splitter:B:16:0x0069} */
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            r4 = r2
            okio.BufferedSource r4 = (okio.BufferedSource) r4     // Catch:{ all -> 0x00b3 }
            java.lang.String r5 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00b3 }
            java.lang.String r6 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00b3 }
            java.lang.String r7 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00b3 }
            java.lang.String r8 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00b3 }
            java.lang.String r9 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00b3 }
            java.lang.String r10 = MAGIC     // Catch:{ all -> 0x00b3 }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r5)     // Catch:{ all -> 0x00b3 }
            if (r10 == 0) goto L_0x0088
            java.lang.String r10 = VERSION_1     // Catch:{ all -> 0x00b3 }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r6)     // Catch:{ all -> 0x00b3 }
            if (r10 == 0) goto L_0x0088
            int r10 = r11.appVersion     // Catch:{ all -> 0x00b3 }
            java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ all -> 0x00b3 }
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r7)     // Catch:{ all -> 0x00b3 }
            if (r7 == 0) goto L_0x0088
            int r7 = r11.valueCount     // Catch:{ all -> 0x00b3 }
            java.lang.String r7 = java.lang.String.valueOf(r7)     // Catch:{ all -> 0x00b3 }
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r7, (java.lang.Object) r8)     // Catch:{ all -> 0x00b3 }
            if (r7 == 0) goto L_0x0088
            r7 = r9
            java.lang.CharSequence r7 = (java.lang.CharSequence) r7     // Catch:{ all -> 0x00b3 }
            int r7 = r7.length()     // Catch:{ all -> 0x00b3 }
            if (r7 > 0) goto L_0x0088
            r0 = 0
        L_0x005f:
            java.lang.String r1 = r4.readUtf8LineStrict()     // Catch:{ EOFException -> 0x0069 }
            r11.readJournalLine(r1)     // Catch:{ EOFException -> 0x0069 }
            int r0 = r0 + 1
            goto L_0x005f
        L_0x0069:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r1 = r11.lruEntries     // Catch:{ all -> 0x00b3 }
            int r1 = r1.size()     // Catch:{ all -> 0x00b3 }
            int r0 = r0 - r1
            r11.redundantOpCount = r0     // Catch:{ all -> 0x00b3 }
            boolean r0 = r4.exhausted()     // Catch:{ all -> 0x00b3 }
        ...
        L_0x0088:
            ...
            r4.append(r0)     // Catch:{ all -> 0x00b3 }
            r4.append(r6)     // Catch:{ all -> 0x00b3 }
            r4.append(r0)     // Catch:{ all -> 0x00b3 }
            r4.append(r8)     // Catch:{ all -> 0x00b3 }
            r4.append(r0)     // Catch:{ all -> 0x00b3 }
            r4.append(r9)     // Catch:{ all -> 0x00b3 }
            r0 = 93
            r4.append(r0)     // Catch:{ all -> 0x00b3 }
            java.lang.String r0 = r4.toString()     // Catch:{ all -> 0x00b3 }
            r3.<init>(r0)     // Catch:{ all -> 0x00b3 }
            java.lang.Throwable r3 = (java.lang.Throwable) r3     // Catch:{ all -> 0x00b3 }
    ...
    public final class Editor {
        ...
        public final okio.Source newSource(int r5) {
            /*
                ...
                monitor-enter(r0)
                boolean r1 = r4.done     // Catch:{ all -> 0x0050 }
                if (r1 != 0) goto L_0x0042
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0050 }
                boolean r1 = r1.getReadable$okhttp()     // Catch:{ all -> 0x0050 }
                r2 = 0
                if (r1 == 0) goto L_0x0040
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0050 }
                okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0050 }
                r3 = r4
                okhttp3.internal.cache.DiskLruCache$Editor r3 = (okhttp3.internal.cache.DiskLruCache.Editor) r3     // Catch:{ all -> 0x0050 }
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x0050 }
                if (r1 == 0) goto L_0x0040
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0050 }
                boolean r1 = r1.getZombie$okhttp()     // Catch:{ all -> 0x0050 }
            ...
            L_0x0042:
                ...
                java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0050 }
                java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0050 }
                r1.<init>(r5)     // Catch:{ all -> 0x0050 }
        ...
        public final okio.Sink newSink(int r5) {
            /*
                ...
                okhttp3.internal.cache.DiskLruCache r0 = r4.this$0
                monitor-enter(r0)
                boolean r1 = r4.done     // Catch:{ all -> 0x0066 }
                if (r1 != 0) goto L_0x0058
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0066 }
                okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0066 }
                r2 = r4
                okhttp3.internal.cache.DiskLruCache$Editor r2 = (okhttp3.internal.cache.DiskLruCache.Editor) r2     // Catch:{ all -> 0x0066 }
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x0066 }
                if (r1 != 0) goto L_0x001c
                okio.Sink r5 = okio.Okio.blackhole()     // Catch:{ all -> 0x0066 }
                monitor-exit(r0)
                return r5
            L_0x001c:
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0066 }
                boolean r1 = r1.getReadable$okhttp()     // Catch:{ all -> 0x0066 }
                if (r1 != 0) goto L_0x002c
                boolean[] r1 = r4.written     // Catch:{ all -> 0x0066 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x0066 }
                r2 = 1
                r1[r5] = r2     // Catch:{ all -> 0x0066 }
            L_0x002c:
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0066 }
                java.util.List r1 = r1.getDirtyFiles$okhttp()     // Catch:{ all -> 0x0066 }
                java.lang.Object r1 = r1.get(r5)     // Catch:{ all -> 0x0066 }
                java.io.File r1 = (java.io.File) r1     // Catch:{ all -> 0x0066 }
                ...
                okhttp3.internal.cache.FaultHidingSink r2 = new okhttp3.internal.cache.FaultHidingSink     // Catch:{ all -> 0x0066 }
                okhttp3.internal.cache.DiskLruCache$Editor$newSink$$inlined$synchronized$lambda$1 r3 = new okhttp3.internal.cache.DiskLruCache$Editor$newSink$$inlined$synchronized$lambda$1     // Catch:{ all -> 0x0066 }
                r3.<init>(r4, r5)     // Catch:{ all -> 0x0066 }
                kotlin.jvm.functions.Function1 r3 = (kotlin.jvm.functions.Function1) r3     // Catch:{ all -> 0x0066 }
                r2.<init>(r1, r3)     // Catch:{ all -> 0x0066 }
                okio.Sink r2 = (okio.Sink) r2     // Catch:{ all -> 0x0066 }
                monitor-exit(r0)
                return r2
            L_0x0052:
                okio.Sink r5 = okio.Okio.blackhole()     // Catch:{ all -> 0x0066 }
            ...
            L_0x0058:
                ...
                java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x0066 }
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0010\u0010\u0003\u001a\u00020\u00048\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u00020\f8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\u000f\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000R\u0010\u0010\u0010\u001a\u00020\u00068\u0006XD¢\u0006\u0002\n\u0000¨\u0006\u0011"}, d2 = {"Lokhttp3/internal/cache/DiskLruCache$Companion;", "", "()V", "ANY_SEQUENCE_NUMBER", "", "CLEAN", "", "DIRTY", "JOURNAL_FILE", "JOURNAL_FILE_BACKUP", "JOURNAL_FILE_TEMP", "LEGAL_KEY_PATTERN", "Lkotlin/text/Regex;", "MAGIC", "READ", "REMOVE", "VERSION_1", "okhttp"}, k = 1, mv = {1, 4, 1})
    /* compiled from: DiskLruCache.kt */
