...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:20:0x005e A[Catch:{ all -> 0x007f, all -> 0x00c9 }] */
        /* JADX WARNING: Removed duplicated region for block: B:26:0x0084 A[Catch:{ all -> 0x007f, all -> 0x00c9 }] */
        /* JADX WARNING: Removed duplicated region for block: B:27:0x00a3 A[Catch:{ all -> 0x007f, all -> 0x00c9 }] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void run() {
            /*
                r8 = this;
                ...
                r3.setName(r2)
                okhttp3.internal.connection.RealCall r2 = r8.this$0     // Catch:{ all -> 0x00c9 }
                okhttp3.internal.connection.RealCall$timeout$1 r2 = r2.timeout     // Catch:{ all -> 0x00c9 }
                r2.enter()     // Catch:{ all -> 0x00c9 }
                r2 = 0
                okhttp3.internal.connection.RealCall r5 = r8.this$0     // Catch:{ IOException -> 0x0081, all -> 0x0056 }
                okhttp3.Response r2 = r5.getResponseWithInterceptorChain$okhttp()     // Catch:{ IOException -> 0x0081, all -> 0x0056 }
                r5 = 1
                okhttp3.Callback r6 = r8.responseCallback     // Catch:{ IOException -> 0x0053, all -> 0x0050 }
                okhttp3.internal.connection.RealCall r7 = r8.this$0     // Catch:{ IOException -> 0x0053, all -> 0x0050 }
                okhttp3.Call r7 = (okhttp3.Call) r7     // Catch:{ IOException -> 0x0053, all -> 0x0050 }
                r6.onResponse(r7, r2)     // Catch:{ IOException -> 0x0053, all -> 0x0050 }
                okhttp3.internal.connection.RealCall r0 = r8.this$0     // Catch:{ all -> 0x00c9 }
                okhttp3.OkHttpClient r0 = r0.getClient()     // Catch:{ all -> 0x00c9 }
                okhttp3.Dispatcher r0 = r0.dispatcher()     // Catch:{ all -> 0x00c9 }
            L_0x004c:
                r0.finished$okhttp((okhttp3.internal.connection.RealCall.AsyncCall) r8)     // Catch:{ all -> 0x00c9 }
                goto L_0x00b7
            L_0x0050:
                r1 = move-exception
                r2 = r5
            ...
            L_0x0056:
                r1 = move-exception
            L_0x0057:
                okhttp3.internal.connection.RealCall r5 = r8.this$0     // Catch:{ all -> 0x007f }
                r5.cancel()     // Catch:{ all -> 0x007f }
                if (r2 != 0) goto L_0x007e
                java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x007f }
                ...
                java.lang.String r0 = r5.toString()     // Catch:{ all -> 0x007f }
                r2.<init>(r0)     // Catch:{ all -> 0x007f }
                r0 = r2
                java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x007f }
                kotlin.ExceptionsKt.addSuppressed(r0, r1)     // Catch:{ all -> 0x007f }
                okhttp3.Callback r0 = r8.responseCallback     // Catch:{ all -> 0x007f }
                okhttp3.internal.connection.RealCall r5 = r8.this$0     // Catch:{ all -> 0x007f }
                okhttp3.Call r5 = (okhttp3.Call) r5     // Catch:{ all -> 0x007f }
                r0.onFailure(r5, r2)     // Catch:{ all -> 0x007f }
            L_0x007e:
            ...
            L_0x0082:
                ...
                okhttp3.internal.platform.Platform$Companion r2 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x007f }
                okhttp3.internal.platform.Platform r2 = r2.get()     // Catch:{ all -> 0x007f }
                java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x007f }
                r5.<init>(r1)     // Catch:{ all -> 0x007f }
                okhttp3.internal.connection.RealCall r1 = r8.this$0     // Catch:{ all -> 0x007f }
                java.lang.String r1 = r1.toLoggableString()     // Catch:{ all -> 0x007f }
                r5.append(r1)     // Catch:{ all -> 0x007f }
                java.lang.String r1 = r5.toString()     // Catch:{ all -> 0x007f }
                java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x007f }
                r5 = 4
                r2.log(r1, r5, r0)     // Catch:{ all -> 0x007f }
                goto L_0x00ac
            L_0x00a3:
                okhttp3.Callback r1 = r8.responseCallback     // Catch:{ all -> 0x007f }
                okhttp3.internal.connection.RealCall r2 = r8.this$0     // Catch:{ all -> 0x007f }
                okhttp3.Call r2 = (okhttp3.Call) r2     // Catch:{ all -> 0x007f }
                r1.onFailure(r2, r0)     // Catch:{ all -> 0x007f }
            L_0x00ac:
                okhttp3.internal.connection.RealCall r0 = r8.this$0     // Catch:{ all -> 0x00c9 }
                okhttp3.OkHttpClient r0 = r0.getClient()     // Catch:{ all -> 0x00c9 }
                okhttp3.Dispatcher r0 = r0.dispatcher()     // Catch:{ all -> 0x00c9 }
            ...
            L_0x00b7:
                ...
                return
            L_0x00bb:
                okhttp3.internal.connection.RealCall r1 = r8.this$0     // Catch:{ all -> 0x00c9 }
                okhttp3.OkHttpClient r1 = r1.getClient()     // Catch:{ all -> 0x00c9 }
                okhttp3.Dispatcher r1 = r1.dispatcher()     // Catch:{ all -> 0x00c9 }
                r1.finished$okhttp((okhttp3.internal.connection.RealCall.AsyncCall) r8)     // Catch:{ all -> 0x00c9 }
