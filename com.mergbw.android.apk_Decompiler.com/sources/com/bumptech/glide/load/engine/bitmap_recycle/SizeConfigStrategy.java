...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            configArr[configArr.length - 1] = DiskLruCache$$ExternalSyntheticApiModelOutline0.m$1();
        }
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        if (Build.VERSION.SDK_INT >= 26 && DiskLruCache$$ExternalSyntheticApiModelOutline0.m$1().equals(config)) {
