...
public final class Downsampler {
    ...
    private Bitmap decodeFromWrappedStreams(ImageReader imageReader, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z, int i, int i2, boolean z2, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        if (preferredColorSpace3 != null) {
            if (Build.VERSION.SDK_INT >= 28) {
                options3.inPreferredColorSpace = ColorSpace.get((preferredColorSpace3 != PreferredColorSpace.DISPLAY_P3 || DiskLruCache$$ExternalSyntheticApiModelOutline0.m(options) == null || !DiskLruCache$$ExternalSyntheticApiModelOutline0.m(options).isWideGamut()) ? ColorKt$$ExternalSyntheticApiModelOutline0.m() : DiskLruCache$$ExternalSyntheticApiModelOutline0.m());
            } else if (Build.VERSION.SDK_INT >= 26) {
                options3.inPreferredColorSpace = ColorSpace.get(ColorKt$$ExternalSyntheticApiModelOutline0.m());
            }
        }
    ...
    private static void setInBitmap(BitmapFactory.Options options, BitmapPool bitmapPool2, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            config = null;
        } else if (options.inPreferredConfig != DiskLruCache$$ExternalSyntheticApiModelOutline0.m()) {
            config = DiskLruCache$$ExternalSyntheticApiModelOutline0.m(options);
        } else {
            return;
        }
        if (config == null) {
