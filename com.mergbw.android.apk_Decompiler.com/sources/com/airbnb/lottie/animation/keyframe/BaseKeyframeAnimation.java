...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    public A getValue() {
        ...
        if (currentKeyframe.xInterpolator == null || currentKeyframe.yInterpolator == null) {
            ...
            a2 = getValue(currentKeyframe, linearCurrentKeyframeProgress, currentKeyframe.xInterpolator.getInterpolation(linearCurrentKeyframeProgress), currentKeyframe.yInterpolator.getInterpolation(linearCurrentKeyframeProgress));
        }
