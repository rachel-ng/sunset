...
public class MultipleBluetoothController {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized com.clj.fastble.bluetooth.BleBluetooth getBleBluetooth(com.clj.fastble.data.BleDevice r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            if (r3 == 0) goto L_0x0020
            com.clj.fastble.utils.BleLruHashMap<java.lang.String, com.clj.fastble.bluetooth.BleBluetooth> r0 = r2.bleLruHashMap     // Catch:{ all -> 0x001d }
            java.lang.String r1 = r3.getKey()     // Catch:{ all -> 0x001d }
            boolean r0 = r0.containsKey(r1)     // Catch:{ all -> 0x001d }
            if (r0 == 0) goto L_0x0020
            com.clj.fastble.utils.BleLruHashMap<java.lang.String, com.clj.fastble.bluetooth.BleBluetooth> r0 = r2.bleLruHashMap     // Catch:{ all -> 0x001d }
            java.lang.String r3 = r3.getKey()     // Catch:{ all -> 0x001d }
            java.lang.Object r3 = r0.get(r3)     // Catch:{ all -> 0x001d }
            com.clj.fastble.bluetooth.BleBluetooth r3 = (com.clj.fastble.bluetooth.BleBluetooth) r3     // Catch:{ all -> 0x001d }
            monitor-exit(r2)
            return r3
        L_0x001d:
            r3 = move-exception
        ...
        L_0x0020:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.clj.fastble.bluetooth.MultipleBluetoothController.getBleBluetooth(com.clj.fastble.data.BleDevice):com.clj.fastble.bluetooth.BleBluetooth");
    }
