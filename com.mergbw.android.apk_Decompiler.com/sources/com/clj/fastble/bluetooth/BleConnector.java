            ...
            if (i == 49) {
                ...
                switch (i) {
                    ...
                    case 18:
                        ...
                        if (i6 == 0) {
                            bleNotifyCallback2.onNotifySuccess(BleConnector.this.mBleBluetooth.getDevice());
                            return;
                        } else {
                    ...
                    case 19:
                        ...
                        if (bleNotifyCallback3 != null) {
                            bleNotifyCallback3.onCharacteristicChanged(BleConnector.this.mBleBluetooth.getDevice(), byteArray3);
                            return;
                        }
                        return;
                    default:
