...
final class _ARouter {
        ...
        try {
            ...
            interceptorService.doInterceptions(postcard, new InterceptorCallback() {
                public void onContinue(Postcard postcard) {
                    Object unused = _ARouter.this._navigation(postcard, i, navigationCallback);
                }

                public void onInterrupt(Throwable th) {
                    NavigationCallback navigationCallback = navigationCallback;
                    if (navigationCallback != null) {
    ...
    /* access modifiers changed from: private */
    public Object _navigation(Postcard postcard, int i, NavigationCallback navigationCallback) {
        ...
        if (i2 == 1) {
            ...
            runInMainThread(new Runnable() {
                public void run() {
                    _ARouter.this.startActivity(i3, context, intent, postcard2, navigationCallback2);
                }
            });
            return null;
        } else if (i2 == 2) {
            ...
            if (i2 == 3 || i2 == 4 || i2 == 5) {
                try {
                    Object newInstance = postcard.getDestination().getConstructor((Class[]) null).newInstance((Object[]) null);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:7:0x001d A[Catch:{ Exception -> 0x0075 }] */
    ...
    public boolean addRouteGroup(com.alibaba.android.arouter.facade.template.IRouteGroup r8) {
        /*
            ...
            return r1
        L_0x0006:
            java.util.HashMap r2 = new java.util.HashMap     // Catch:{ Exception -> 0x0075 }
            r2.<init>()     // Catch:{ Exception -> 0x0075 }
            r8.loadInto(r2)     // Catch:{ Exception -> 0x0075 }
            java.util.Set r3 = r2.entrySet()     // Catch:{ Exception -> 0x0075 }
            java.util.Iterator r3 = r3.iterator()     // Catch:{ Exception -> 0x0075 }
            r4 = 0
        L_0x0017:
            boolean r5 = r3.hasNext()     // Catch:{ Exception -> 0x0075 }
            if (r5 == 0) goto L_0x0049
            java.lang.Object r5 = r3.next()     // Catch:{ Exception -> 0x0075 }
            java.util.Map$Entry r5 = (java.util.Map.Entry) r5     // Catch:{ Exception -> 0x0075 }
            java.lang.Object r6 = r5.getKey()     // Catch:{ Exception -> 0x0075 }
            java.lang.String r6 = (java.lang.String) r6     // Catch:{ Exception -> 0x0075 }
            java.lang.String r6 = r7.extractGroup(r6)     // Catch:{ Exception -> 0x0075 }
            java.lang.Object r5 = r5.getValue()     // Catch:{ Exception -> 0x0075 }
            com.alibaba.android.arouter.facade.model.RouteMeta r5 = (com.alibaba.android.arouter.facade.model.RouteMeta) r5     // Catch:{ Exception -> 0x0075 }
            if (r4 != 0) goto L_0x0036
            r4 = r6
        L_0x0036:
            if (r4 == 0) goto L_0x0048
            boolean r6 = r4.equals(r6)     // Catch:{ Exception -> 0x0075 }
            if (r6 == 0) goto L_0x0048
            java.lang.String r5 = r5.getGroup()     // Catch:{ Exception -> 0x0075 }
            boolean r5 = r4.equals(r5)     // Catch:{ Exception -> 0x0075 }
            if (r5 != 0) goto L_0x0017
        L_0x0048:
            return r1
        L_0x0049:
            com.alibaba.android.arouter.core.LogisticsCenter.addRouteGroupDynamic(r4, r8)     // Catch:{ Exception -> 0x0075 }
            com.alibaba.android.arouter.facade.template.ILogger r8 = logger     // Catch:{ Exception -> 0x0075 }
            ...
            r3.append(r5)     // Catch:{ Exception -> 0x0075 }
            r3.append(r4)     // Catch:{ Exception -> 0x0075 }
            java.lang.String r4 = "] finish, "
            r3.append(r4)     // Catch:{ Exception -> 0x0075 }
            int r2 = r2.size()     // Catch:{ Exception -> 0x0075 }
            ...
            r8.info(r0, r2)     // Catch:{ Exception -> 0x0075 }
            r8 = 1
            return r8
        L_0x0075:
            r8 = move-exception
            com.alibaba.android.arouter.facade.template.ILogger r2 = logger
