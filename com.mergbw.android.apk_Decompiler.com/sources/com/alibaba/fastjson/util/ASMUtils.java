...
public class ASMUtils {
    ...
    public static java.lang.String[] lookupParameterNames(java.lang.reflect.AccessibleObject r8) {
        ...
        L_0x003f:
            ...
            return r8
        L_0x0065:
            com.alibaba.fastjson.asm.ClassReader r4 = new com.alibaba.fastjson.asm.ClassReader     // Catch:{ IOException -> 0x00a4 }
            r4.<init>(r3, r1)     // Catch:{ IOException -> 0x00a4 }
            com.alibaba.fastjson.asm.TypeCollector r5 = new com.alibaba.fastjson.asm.TypeCollector     // Catch:{ IOException -> 0x00a4 }
            r5.<init>(r2, r0)     // Catch:{ IOException -> 0x00a4 }
            r4.accept(r5)     // Catch:{ IOException -> 0x00a4 }
            java.lang.String[] r0 = r5.getParameterNamesForMethod()     // Catch:{ IOException -> 0x00a4 }
            r2 = r1
        L_0x0077:
            int r4 = r0.length     // Catch:{ IOException -> 0x00a4 }
            if (r2 >= r4) goto L_0x009e
            r4 = r8[r2]     // Catch:{ IOException -> 0x00a4 }
            if (r4 == 0) goto L_0x009b
            r5 = r1
        L_0x007f:
            int r6 = r4.length     // Catch:{ IOException -> 0x00a4 }
            if (r5 >= r6) goto L_0x009b
            r6 = r4[r5]     // Catch:{ IOException -> 0x00a4 }
            boolean r7 = r6 instanceof com.alibaba.fastjson.annotation.JSONField     // Catch:{ IOException -> 0x00a4 }
            if (r7 == 0) goto L_0x0098
            com.alibaba.fastjson.annotation.JSONField r6 = (com.alibaba.fastjson.annotation.JSONField) r6     // Catch:{ IOException -> 0x00a4 }
            java.lang.String r6 = r6.name()     // Catch:{ IOException -> 0x00a4 }
            if (r6 == 0) goto L_0x0098
            int r7 = r6.length()     // Catch:{ IOException -> 0x00a4 }
            if (r7 <= 0) goto L_0x0098
            r0[r2] = r6     // Catch:{ IOException -> 0x00a4 }
        L_0x0098:
            int r5 = r5 + 1
            goto L_0x007f
        L_0x009b:
        ...
        L_0x00a2:
            ...
            goto L_0x00aa
        L_0x00a4:
            java.lang.String[] r8 = new java.lang.String[r1]     // Catch:{ all -> 0x00a2 }
            com.alibaba.fastjson.util.IOUtils.close(r3)
            return r8
        L_0x00aa:
            com.alibaba.fastjson.util.IOUtils.close(r3)
