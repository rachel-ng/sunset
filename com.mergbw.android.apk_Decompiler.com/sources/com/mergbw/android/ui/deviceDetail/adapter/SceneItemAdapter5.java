...
import com.mergbw.android.databinding.LayoutSceneItem5Binding;
import com.mergbw.core.R;
import com.mergbw.core.bean.SceneData;
import java.util.ArrayList;
import java.util.List;

public class SceneItemAdapter5 extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ItemViewHolder(LayoutSceneItem5Binding.inflate(LayoutInflater.from(viewGroup.getContext()), viewGroup, false));
    }
    ...
    public void onBindViewHolder(ItemViewHolder itemViewHolder, int i) {
        ...
        itemViewHolder.mBinding.getRoot().setOnClickListener(new SceneItemAdapter5$$ExternalSyntheticLambda0(this, itemViewHolder));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onBindViewHolder$0$com-mergbw-android-ui-deviceDetail-adapter-SceneItemAdapter5  reason: not valid java name */
    public /* synthetic */ void m726lambda$onBindViewHolder$0$commergbwandroiduideviceDetailadapterSceneItemAdapter5(ItemViewHolder itemViewHolder, View view) {
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public final LayoutSceneItem5Binding mBinding;

        public ItemViewHolder(LayoutSceneItem5Binding layoutSceneItem5Binding) {
            super(layoutSceneItem5Binding.getRoot());
            this.mBinding = layoutSceneItem5Binding;
        }
    }
}
