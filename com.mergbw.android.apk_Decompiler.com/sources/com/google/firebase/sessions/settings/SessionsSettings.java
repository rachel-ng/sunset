...
public final class SessionsSettings {
    ...
    public final long m687getSessionRestartTimeoutUwyO8pc() {
        Duration r0 = this.localOverrideSettings.m688getSessionRestartTimeoutFghU774();
        if (r0 != null) {
            long r02 = r0.m206unboximpl();
            if (m686isValidSessionRestartTimeoutLRDsOJo(r02)) {
                return r02;
            }
        }
        Duration r03 = this.remoteSettings.m688getSessionRestartTimeoutFghU774();
        if (r03 != null) {
            long r04 = r03.m206unboximpl();
            if (m686isValidSessionRestartTimeoutLRDsOJo(r04)) {
                return r04;
            }
        }
    ...
    private final boolean m686isValidSessionRestartTimeoutLRDsOJo(long j) {
        return Duration.m186isPositiveimpl(j) && Duration.m181isFiniteimpl(j);
    }
