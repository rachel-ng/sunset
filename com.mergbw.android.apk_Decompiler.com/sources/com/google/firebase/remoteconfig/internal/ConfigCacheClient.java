...
public class ConfigCacheClient {
    ...
    public /* synthetic */ Void m670lambda$put$0$comgooglefirebaseremoteconfiginternalConfigCacheClient(ConfigContainer configContainer) throws Exception {
    ...
    public /* synthetic */ Task m671lambda$put$1$comgooglefirebaseremoteconfiginternalConfigCacheClient(boolean z, ConfigContainer configContainer, Void voidR) throws Exception {
        if (z) {
