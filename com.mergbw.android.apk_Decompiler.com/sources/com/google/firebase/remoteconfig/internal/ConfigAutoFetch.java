...
public class ConfigAutoFetch {
    ...
    public /* synthetic */ Task m669lambda$fetchLatestConfig$0$comgooglefirebaseremoteconfiginternalConfigAutoFetch(Task task, Task task2, long j, int i, Task task3) throws Exception {
