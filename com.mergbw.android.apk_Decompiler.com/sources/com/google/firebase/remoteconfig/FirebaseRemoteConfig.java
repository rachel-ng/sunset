...
public class FirebaseRemoteConfig {
    ...
    public Task<FirebaseRemoteConfigInfo> ensureInitialized() {
        ...
        Task call = Tasks.call(this.executor, new FirebaseRemoteConfig$$ExternalSyntheticLambda6(this));
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2, task3, call, this.firebaseInstallations.getId(), this.firebaseInstallations.getToken(false)}).continueWith(this.executor, new FirebaseRemoteConfig$$ExternalSyntheticLambda7(call));
    }
    ...
    public Task<Boolean> fetchAndActivate() {
        return fetch().onSuccessTask(this.executor, new FirebaseRemoteConfig$$ExternalSyntheticLambda8(this));
    }
    ...
    public /* synthetic */ Task m665lambda$fetchAndActivate$1$comgooglefirebaseremoteconfigFirebaseRemoteConfig(Void voidR) throws Exception {
        return activate();
    }
    ...
    public /* synthetic */ Task m664lambda$activate$2$comgooglefirebaseremoteconfigFirebaseRemoteConfig(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> fetch() {
        return this.fetchHandler.fetch().onSuccessTask(FirebaseExecutors.directExecutor(), new FirebaseRemoteConfig$$ExternalSyntheticLambda9());
    }
    ...
    public Task<Void> setConfigSettingsAsync(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new FirebaseRemoteConfig$$ExternalSyntheticLambda5(this, firebaseRemoteConfigSettings));
    }
    ...
    public /* synthetic */ Void m667lambda$setConfigSettingsAsync$5$comgooglefirebaseremoteconfigFirebaseRemoteConfig(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public Task<Void> reset() {
        return Tasks.call(this.executor, new FirebaseRemoteConfig$$ExternalSyntheticLambda4(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$reset$6$com-google-firebase-remoteconfig-FirebaseRemoteConfig  reason: not valid java name */
    public /* synthetic */ Void m666lambda$reset$6$comgooglefirebaseremoteconfigFirebaseRemoteConfig() throws Exception {
