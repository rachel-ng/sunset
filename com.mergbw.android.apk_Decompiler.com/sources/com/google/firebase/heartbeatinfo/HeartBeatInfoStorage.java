...
class HeartBeatInfoStorage {
    ...
    private synchronized String getFormattedDate(long j) {
        if (Build.VERSION.SDK_INT >= 26) {
            return new Date(j).toInstant().atOffset(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()).toLocalDateTime().format(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m());
        }
