...
public interface ComponentContainer {
    ...
    public final /* synthetic */ class CC {
        public static Object $default$get(ComponentContainer _this, Class cls) {
            return _this.get(Qualified.unqualified(cls));
        }

        public static Provider $default$getProvider(ComponentContainer _this, Class cls) {
            return _this.getProvider(Qualified.unqualified(cls));
        }

        public static Deferred $default$getDeferred(ComponentContainer _this, Class cls) {
            return _this.getDeferred(Qualified.unqualified(cls));
        }

        public static Set $default$setOf(ComponentContainer _this, Class cls) {
            return _this.setOf(Qualified.unqualified(cls));
        }

        public static Provider $default$setOfProvider(ComponentContainer _this, Class cls) {
