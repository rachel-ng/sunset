...
final class SipHashFunction extends AbstractHashFunction implements Serializable {
    ...
    public Hasher newHasher() {
        return new SipHasher(this.f47c, this.d, this.k0, this.k1);
    }
    ...
    public boolean equals(@CheckForNull Object obj) {
        ...
        if (this.f47c == sipHashFunction.f47c && this.d == sipHashFunction.d && this.k0 == sipHashFunction.k0 && this.k1 == sipHashFunction.k1) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (int) ((((long) ((getClass().hashCode() ^ this.f47c) ^ this.d)) ^ this.k0) ^ this.k1);
    }
    ...
    private static final class SipHasher extends AbstractStreamingHasher {
        ...
        public void processRemaining(ByteBuffer byteBuffer) {
            this.f48b += (long) byteBuffer.remaining();
            int i = 0;
        ...
        public HashCode makeHash() {
            long j = this.finalM ^ (this.f48b << 56);
            this.finalM = j;
            processM(j);
            this.v2 ^= 255;
            sipRound(this.d);
