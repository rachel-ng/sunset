    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                appendable.append(this.encoding[b2]);
                appendable.append(this.encoding[b2 | 256]);
            }
        }
    ...
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (i2 >= 3) {
                ...
                i += 3;
                byte b2 = i5 | ((bArr[i] & 255) << 16) | (bArr[i4] & 255);
                appendable.append(this.alphabet.encode(b2 >>> Ascii.DC2));
                appendable.append(this.alphabet.encode((b2 >>> 12) & 63));
