...
public final class H263Reader implements ElementaryStreamReader {
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            int i = findNalUnit + 3;
            byte b2 = parsableByteArray.getData()[i] & 255;
            ...
            if (nalUnitTargetBuffer != null) {
                ...
                if (b2 == 178 && parsableByteArray.getData()[findNalUnit + 2] == 1) {
                    this.userData.startNalUnit(b2);
                }
            }
            int i4 = limit - findNalUnit;
            this.sampleReader.onDataEnd(this.totalBytesWritten - ((long) i4), i4, this.hasOutputFormat);
            this.sampleReader.onStartCode(b2, this.pesTimeUs);
            position = i;
        }
        if (!this.hasOutputFormat) {
    ...
    private static final class SampleReader {
        ...
        public void onStartCode(int i, long j) {
            ...
            this.sampleIsKeyframe = false;
            boolean z = true;
            this.readingSample = i == 182 || i == H263Reader.START_CODE_VALUE_GROUP_OF_VOP;
            if (i != 182) {
                z = false;
            }
