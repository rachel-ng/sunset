...
final class RtspMediaPeriod implements MediaPeriod {
    ...
    private final class InternalListener implements ExtractorOutput, Loader.Callback<RtpDataLoadable>, SampleQueue.UpstreamFormatChangedListener, RtspClient.SessionInfoListener, RtspClient.PlaybackEventListener {
        ...
        public void onRtspSetupCompleted() {
            ...
            if (RtspMediaPeriod.this.pendingSeekPositionUs != C.TIME_UNSET) {
                ...
                j = RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry != C.TIME_UNSET ? Util.usToMs(RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry) : 0;
            }
        ...
        public void onPlaybackStarted(long j, ImmutableList<RtspTrackTiming> immutableList) {
            ...
            } else if (RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry != C.TIME_UNSET && RtspMediaPeriod.this.isUsingRtpTcp) {
    ...
    final class RtpLoadInfo {
        ...
        public /* synthetic */ void m503lambda$new$0$comgoogleandroidexoplayer2sourcertspRtspMediaPeriod$RtpLoadInfo(String str, RtpDataChannel rtpDataChannel) {
            this.transport = str;
