            ...
            if (index == null) {
                ...
                if (i != 0) {
                    if (i < 0) {
                        ...
                        segmentNum = j6 - (index2.getSegmentNum(timeUs, j2) - j5);
                        return new RepresentationHolder(j, representation2, this.selectedBaseUrl, this.chunkExtractor, segmentNum, index2);
                    } else {
                        j3 = dashSegmentIndex.getSegmentNum(timeUs3, j2);
                    }
                }
                segmentNum = j6 + (j3 - firstSegmentNum2);
                return new RepresentationHolder(j, representation2, this.selectedBaseUrl, this.chunkExtractor, segmentNum, index2);
            }
        }
