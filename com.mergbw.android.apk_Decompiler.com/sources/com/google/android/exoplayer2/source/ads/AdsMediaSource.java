...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public /* synthetic */ void m490lambda$prepareSourceInternal$0$comgoogleandroidexoplayer2sourceadsAdsMediaSource(ComponentListener componentListener2) {
    ...
    public /* synthetic */ void m491lambda$releaseSourceInternal$1$comgoogleandroidexoplayer2sourceadsAdsMediaSource(ComponentListener componentListener2) {
    ...
    private final class ComponentListener implements AdsLoader.EventListener {
        ...
        public /* synthetic */ void m494lambda$onAdPlaybackState$0$comgoogleandroidexoplayer2sourceadsAdsMediaSource$ComponentListener(AdPlaybackState adPlaybackState) {
            if (!this.stopped) {
    ...
    private final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1(this, mediaPeriodId));
        }
        ...
        public /* synthetic */ void m492lambda$onPrepareComplete$0$comgoogleandroidexoplayer2sourceadsAdsMediaSource$AdPrepareListener(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void onPrepareError(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0(this, mediaPeriodId, iOException));
        }
        ...
        public /* synthetic */ void m493lambda$onPrepareError$1$comgoogleandroidexoplayer2sourceadsAdsMediaSource$AdPrepareListener(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
