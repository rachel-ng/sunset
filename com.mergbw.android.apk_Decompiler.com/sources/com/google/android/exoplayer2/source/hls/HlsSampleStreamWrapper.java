...
final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, Loader.ReleaseCallback, SequenceableLoader, ExtractorOutput, SampleQueue.UpstreamFormatChangedListener {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x011e, code lost:
        if (r18.getSelectedIndexInTrackGroup() != r0.chunkSource.getTrackGroup().indexOf(r1.trackFormat)) goto L_0x0120;
     */
    ...
    private void buildTracksFromSampleStreams() {
        ...
        while (i7 < length) {
            ...
            if (i7 == i2) {
                ...
                Format format5 = (i != 2 || !MimeTypes.isAudio(format3.sampleMimeType)) ? null : this.muxedAudioFormat;
