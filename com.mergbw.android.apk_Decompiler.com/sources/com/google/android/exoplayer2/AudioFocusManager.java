...
final class AudioFocusManager {
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest2 == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest2 == null) {
                DiskLruCache$$ExternalSyntheticApiModelOutline0.m();
                builder = DiskLruCache$$ExternalSyntheticApiModelOutline0.m(this.focusGainToRequest);
            } else {
                DiskLruCache$$ExternalSyntheticApiModelOutline0.m();
                builder = DiskLruCache$$ExternalSyntheticApiModelOutline0.m(this.audioFocusRequest);
            }
    ...
    private class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public /* synthetic */ void m406lambda$onAudioFocusChange$0$comgoogleandroidexoplayer2AudioFocusManager$AudioFocusListener(int i) {
