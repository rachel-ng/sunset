...
public final class Cea708Decoder extends CeaDecoder {
        ...
        while (this.ccData.bytesLeft() >= 3) {
            ...
            if ((i == 2 || i == 3) && z2) {
                if (i == 3) {
                    ...
                    byte b2 = readUnsignedByte2 & Utf8.REPLACEMENT_BYTE;
                    if (b2 == 0) {
                        b2 = SignedBytes.MAX_POWER_OF_TWO;
                    }
                    DtvCcPacket dtvCcPacket = new DtvCcPacket(i2, b2);
    ...
    private static final class CueInfoBuilder {
        ...
        static {
            ...
            int i = argbColorFromCeaColor;
            int i2 = argbColorFromCeaColor;
            WINDOW_STYLE_FILL = new int[]{argbColorFromCeaColor, argbColorFromCeaColor2, i, i2, argbColorFromCeaColor2, argbColorFromCeaColor, argbColorFromCeaColor};
            PEN_STYLE_BACKGROUND = new int[]{argbColorFromCeaColor, argbColorFromCeaColor, i, i2, argbColorFromCeaColor, argbColorFromCeaColor2, argbColorFromCeaColor2};
        }
