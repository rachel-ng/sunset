...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.DeviceComponent {
    ...
    public ExoPlayerImpl(com.google.android.exoplayer2.ExoPlayer.Builder r38, com.google.android.exoplayer2.Player r39) {
        /*
            ...
            r1 = r37
            r0 = r38
            java.lang.String r2 = " [ExoPlayerLib/2.18.5] ["
            java.lang.String r3 = "Init "
            r37.<init>()
            com.google.android.exoplayer2.util.ConditionVariable r4 = new com.google.android.exoplayer2.util.ConditionVariable
            r4.<init>()
            ...
            r6.<init>(r3)     // Catch:{ all -> 0x02e9 }
            int r3 = java.lang.System.identityHashCode(r37)     // Catch:{ all -> 0x02e9 }
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x02e9 }
            r6.append(r3)     // Catch:{ all -> 0x02e9 }
            r6.append(r2)     // Catch:{ all -> 0x02e9 }
            java.lang.String r2 = com.google.android.exoplayer2.util.Util.DEVICE_DEBUG_INFO     // Catch:{ all -> 0x02e9 }
            r6.append(r2)     // Catch:{ all -> 0x02e9 }
            java.lang.String r2 = "]"
            r6.append(r2)     // Catch:{ all -> 0x02e9 }
            java.lang.String r2 = r6.toString()     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.util.Log.i(r5, r2)     // Catch:{ all -> 0x02e9 }
            android.content.Context r2 = r0.context     // Catch:{ all -> 0x02e9 }
            android.content.Context r2 = r2.getApplicationContext()     // Catch:{ all -> 0x02e9 }
            r1.applicationContext = r2     // Catch:{ all -> 0x02e9 }
            com.google.common.base.Function<com.google.android.exoplayer2.util.Clock, com.google.android.exoplayer2.analytics.AnalyticsCollector> r3 = r0.analyticsCollectorFunction     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.util.Clock r5 = r0.clock     // Catch:{ all -> 0x02e9 }
            java.lang.Object r3 = r3.apply(r5)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.analytics.AnalyticsCollector r3 = (com.google.android.exoplayer2.analytics.AnalyticsCollector) r3     // Catch:{ all -> 0x02e9 }
            r1.analyticsCollector = r3     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.util.PriorityTaskManager r5 = r0.priorityTaskManager     // Catch:{ all -> 0x02e9 }
            r1.priorityTaskManager = r5     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.audio.AudioAttributes r5 = r0.audioAttributes     // Catch:{ all -> 0x02e9 }
            r1.audioAttributes = r5     // Catch:{ all -> 0x02e9 }
            int r5 = r0.videoScalingMode     // Catch:{ all -> 0x02e9 }
            r1.videoScalingMode = r5     // Catch:{ all -> 0x02e9 }
            int r5 = r0.videoChangeFrameRateStrategy     // Catch:{ all -> 0x02e9 }
            r1.videoChangeFrameRateStrategy = r5     // Catch:{ all -> 0x02e9 }
            boolean r5 = r0.skipSilenceEnabled     // Catch:{ all -> 0x02e9 }
            r1.skipSilenceEnabled = r5     // Catch:{ all -> 0x02e9 }
            long r5 = r0.detachSurfaceTimeoutMs     // Catch:{ all -> 0x02e9 }
            r1.detachSurfaceTimeoutMs = r5     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.ExoPlayerImpl$ComponentListener r15 = new com.google.android.exoplayer2.ExoPlayerImpl$ComponentListener     // Catch:{ all -> 0x02e9 }
            r14 = 0
            r15.<init>()     // Catch:{ all -> 0x02e9 }
            r1.componentListener = r15     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.ExoPlayerImpl$FrameMetadataListener r13 = new com.google.android.exoplayer2.ExoPlayerImpl$FrameMetadataListener     // Catch:{ all -> 0x02e9 }
            r13.<init>()     // Catch:{ all -> 0x02e9 }
            r1.frameMetadataListener = r13     // Catch:{ all -> 0x02e9 }
            android.os.Handler r6 = new android.os.Handler     // Catch:{ all -> 0x02e9 }
            android.os.Looper r5 = r0.looper     // Catch:{ all -> 0x02e9 }
            r6.<init>(r5)     // Catch:{ all -> 0x02e9 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.RenderersFactory> r5 = r0.renderersFactorySupplier     // Catch:{ all -> 0x02e9 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e9 }
            r7 = r5
            com.google.android.exoplayer2.RenderersFactory r7 = (com.google.android.exoplayer2.RenderersFactory) r7     // Catch:{ all -> 0x02e9 }
            r8 = r6
            r9 = r15
            r10 = r15
            r11 = r15
            r12 = r15
            com.google.android.exoplayer2.Renderer[] r7 = r7.createRenderers(r8, r9, r10, r11, r12)     // Catch:{ all -> 0x02e9 }
            r1.renderers = r7     // Catch:{ all -> 0x02e9 }
            int r5 = r7.length     // Catch:{ all -> 0x02e9 }
            r12 = 0
        ...
        L_0x0094:
            r5 = r12
        L_0x0095:
            com.google.android.exoplayer2.util.Assertions.checkState(r5)     // Catch:{ all -> 0x02e9 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.trackselection.TrackSelector> r5 = r0.trackSelectorSupplier     // Catch:{ all -> 0x02e9 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e9 }
            r10 = r5
            com.google.android.exoplayer2.trackselection.TrackSelector r10 = (com.google.android.exoplayer2.trackselection.TrackSelector) r10     // Catch:{ all -> 0x02e9 }
            r1.trackSelector = r10     // Catch:{ all -> 0x02e9 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.source.MediaSource$Factory> r5 = r0.mediaSourceFactorySupplier     // Catch:{ all -> 0x02e9 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.source.MediaSource$Factory r5 = (com.google.android.exoplayer2.source.MediaSource.Factory) r5     // Catch:{ all -> 0x02e9 }
            r1.mediaSourceFactory = r5     // Catch:{ all -> 0x02e9 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.upstream.BandwidthMeter> r5 = r0.bandwidthMeterSupplier     // Catch:{ all -> 0x02e9 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e9 }
            r9 = r5
            com.google.android.exoplayer2.upstream.BandwidthMeter r9 = (com.google.android.exoplayer2.upstream.BandwidthMeter) r9     // Catch:{ all -> 0x02e9 }
            r1.bandwidthMeter = r9     // Catch:{ all -> 0x02e9 }
            boolean r5 = r0.useLazyPreparation     // Catch:{ all -> 0x02e9 }
            r1.useLazyPreparation = r5     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.SeekParameters r5 = r0.seekParameters     // Catch:{ all -> 0x02e9 }
            r1.seekParameters = r5     // Catch:{ all -> 0x02e9 }
            r16 = r15
            long r14 = r0.seekBackIncrementMs     // Catch:{ all -> 0x02e9 }
            r1.seekBackIncrementMs = r14     // Catch:{ all -> 0x02e9 }
            long r14 = r0.seekForwardIncrementMs     // Catch:{ all -> 0x02e9 }
            r1.seekForwardIncrementMs = r14     // Catch:{ all -> 0x02e9 }
            boolean r5 = r0.pauseAtEndOfMediaItems     // Catch:{ all -> 0x02e9 }
            r1.pauseAtEndOfMediaItems = r5     // Catch:{ all -> 0x02e9 }
            android.os.Looper r15 = r0.looper     // Catch:{ all -> 0x02e9 }
            r1.applicationLooper = r15     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.util.Clock r14 = r0.clock     // Catch:{ all -> 0x02e9 }
            r1.clock = r14     // Catch:{ all -> 0x02e9 }
        ...
        L_0x00da:
            r5 = r39
        L_0x00dc:
            r1.wrappingPlayer = r5     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.util.ListenerSet r8 = new com.google.android.exoplayer2.util.ListenerSet     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda15 r11 = new com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda15     // Catch:{ all -> 0x02e9 }
            r11.<init>(r1)     // Catch:{ all -> 0x02e9 }
            r8.<init>(r15, r14, r11)     // Catch:{ all -> 0x02e9 }
            r1.listeners = r8     // Catch:{ all -> 0x02e9 }
            java.util.concurrent.CopyOnWriteArraySet r8 = new java.util.concurrent.CopyOnWriteArraySet     // Catch:{ all -> 0x02e9 }
            r8.<init>()     // Catch:{ all -> 0x02e9 }
            r1.audioOffloadListeners = r8     // Catch:{ all -> 0x02e9 }
            java.util.ArrayList r8 = new java.util.ArrayList     // Catch:{ all -> 0x02e9 }
            r8.<init>()     // Catch:{ all -> 0x02e9 }
            r1.mediaSourceHolderSnapshots = r8     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.source.ShuffleOrder$DefaultShuffleOrder r8 = new com.google.android.exoplayer2.source.ShuffleOrder$DefaultShuffleOrder     // Catch:{ all -> 0x02e9 }
            r8.<init>(r12)     // Catch:{ all -> 0x02e9 }
            r1.shuffleOrder = r8     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.trackselection.TrackSelectorResult r8 = new com.google.android.exoplayer2.trackselection.TrackSelectorResult     // Catch:{ all -> 0x02e9 }
            int r11 = r7.length     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.RendererConfiguration[] r11 = new com.google.android.exoplayer2.RendererConfiguration[r11]     // Catch:{ all -> 0x02e9 }
            int r12 = r7.length     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.trackselection.ExoTrackSelection[] r12 = new com.google.android.exoplayer2.trackselection.ExoTrackSelection[r12]     // Catch:{ all -> 0x02e9 }
            r20 = r6
            com.google.android.exoplayer2.Tracks r6 = com.google.android.exoplayer2.Tracks.EMPTY     // Catch:{ all -> 0x02e9 }
            r21 = r9
            r9 = 0
            r8.<init>(r11, r12, r6, r9)     // Catch:{ all -> 0x02e9 }
            r1.emptyTrackSelectorResult = r8     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Timeline$Period r6 = new com.google.android.exoplayer2.Timeline$Period     // Catch:{ all -> 0x02e9 }
            r6.<init>()     // Catch:{ all -> 0x02e9 }
            r1.period = r6     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Player$Commands$Builder r6 = new com.google.android.exoplayer2.Player$Commands$Builder     // Catch:{ all -> 0x02e9 }
            r6.<init>()     // Catch:{ all -> 0x02e9 }
            r12 = 21
            int[] r9 = new int[r12]     // Catch:{ all -> 0x02e9 }
            r9 = {1, 2, 3, 13, 14, 15, 16, 17, 18, 19, 31, 20, 30, 21, 22, 23, 24, 25, 26, 27, 28} // fill-array     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.addAll((int[]) r9)     // Catch:{ all -> 0x02e9 }
            boolean r9 = r10.isSetParametersSupported()     // Catch:{ all -> 0x02e9 }
            r11 = 29
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.addIf(r11, r9)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Player$Commands r6 = r6.build()     // Catch:{ all -> 0x02e9 }
            r1.permanentAvailableCommands = r6     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Player$Commands$Builder r9 = new com.google.android.exoplayer2.Player$Commands$Builder     // Catch:{ all -> 0x02e9 }
            r9.<init>()     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r9.addAll((com.google.android.exoplayer2.Player.Commands) r6)     // Catch:{ all -> 0x02e9 }
            r11 = 4
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.add(r11)     // Catch:{ all -> 0x02e9 }
            r9 = 10
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.add(r9)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.Player$Commands r6 = r6.build()     // Catch:{ all -> 0x02e9 }
            r1.availableCommands = r6     // Catch:{ all -> 0x02e9 }
            r6 = 0
            com.google.android.exoplayer2.util.HandlerWrapper r9 = r14.createHandler(r15, r6)     // Catch:{ all -> 0x02e9 }
            r1.playbackInfoUpdateHandler = r9     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda16 r9 = new com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda16     // Catch:{ all -> 0x02e9 }
            r9.<init>(r1)     // Catch:{ all -> 0x02e9 }
            r1.playbackInfoUpdateListener = r9     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.PlaybackInfo r6 = com.google.android.exoplayer2.PlaybackInfo.createDummy(r8)     // Catch:{ all -> 0x02e9 }
            r1.playbackInfo = r6     // Catch:{ all -> 0x02e9 }
            r3.setPlayer(r5, r15)     // Catch:{ all -> 0x02e9 }
            int r5 = com.google.android.exoplayer2.util.Util.SDK_INT     // Catch:{ all -> 0x02e9 }
            r6 = 31
            if (r5 >= r6) goto L_0x0177
            com.google.android.exoplayer2.analytics.PlayerId r5 = new com.google.android.exoplayer2.analytics.PlayerId     // Catch:{ all -> 0x02e9 }
            r5.<init>()     // Catch:{ all -> 0x02e9 }
            goto L_0x017d
        L_0x0177:
            boolean r5 = r0.usePlatformDiagnostics     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.analytics.PlayerId r5 = com.google.android.exoplayer2.ExoPlayerImpl.Api31.registerMediaMetricsListener(r2, r1, r5)     // Catch:{ all -> 0x02e9 }
        L_0x017d:
            r22 = r5
            com.google.android.exoplayer2.ExoPlayerImplInternal r6 = new com.google.android.exoplayer2.ExoPlayerImplInternal     // Catch:{ all -> 0x02e9 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.LoadControl> r5 = r0.loadControlSupplier     // Catch:{ all -> 0x02e9 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e9 }
            r23 = r5
            com.google.android.exoplayer2.LoadControl r23 = (com.google.android.exoplayer2.LoadControl) r23     // Catch:{ all -> 0x02e9 }
            int r5 = r1.repeatMode     // Catch:{ all -> 0x02e9 }
            boolean r12 = r1.shuffleModeEnabled     // Catch:{ all -> 0x02e9 }
            r25 = r14
            com.google.android.exoplayer2.SeekParameters r14 = r1.seekParameters     // Catch:{ all -> 0x02e9 }
            r26 = r15
            com.google.android.exoplayer2.LivePlaybackSpeedControl r15 = r0.livePlaybackSpeedControl     // Catch:{ all -> 0x02e9 }
            r27 = r14
            r28 = r15
            long r14 = r0.releaseTimeoutMs     // Catch:{ all -> 0x02e9 }
            r29 = r4
            boolean r4 = r1.pauseAtEndOfMediaItems     // Catch:{ all -> 0x02e9 }
            r30 = r2
            android.os.Looper r2 = r0.playbackLooper     // Catch:{ all -> 0x02e9 }
            r31 = r5
            r5 = r6
            r0 = r6
            r32 = r20
            ...
            r19 = r26
            r23 = r2
            r5.<init>(r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r18, r19, r20, r21, r22, r23)     // Catch:{ all -> 0x02e9 }
            r1.internalPlayer = r0     // Catch:{ all -> 0x02e9 }
            r2 = 1065353216(0x3f800000, float:1.0)
            r1.volume = r2     // Catch:{ all -> 0x02e9 }
            r2 = 0
            r1.repeatMode = r2     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.MediaMetadata r4 = com.google.android.exoplayer2.MediaMetadata.EMPTY     // Catch:{ all -> 0x02e9 }
            r1.mediaMetadata = r4     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.MediaMetadata r4 = com.google.android.exoplayer2.MediaMetadata.EMPTY     // Catch:{ all -> 0x02e9 }
            r1.playlistMetadata = r4     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.MediaMetadata r4 = com.google.android.exoplayer2.MediaMetadata.EMPTY     // Catch:{ all -> 0x02e9 }
            r1.staticAndDynamicMediaMetadata = r4     // Catch:{ all -> 0x02e9 }
            r4 = -1
            r1.maskingWindowIndex = r4     // Catch:{ all -> 0x02e9 }
            int r4 = com.google.android.exoplayer2.util.Util.SDK_INT     // Catch:{ all -> 0x02e9 }
            r5 = 21
            if (r4 >= r5) goto L_0x01fa
            int r4 = r1.initializeKeepSessionIdAudioTrack(r2)     // Catch:{ all -> 0x02e9 }
            r1.audioSessionId = r4     // Catch:{ all -> 0x02e9 }
            goto L_0x0200
        L_0x01fa:
            int r4 = com.google.android.exoplayer2.util.Util.generateAudioSessionIdV21(r30)     // Catch:{ all -> 0x02e9 }
            r1.audioSessionId = r4     // Catch:{ all -> 0x02e9 }
        L_0x0200:
            com.google.android.exoplayer2.text.CueGroup r4 = com.google.android.exoplayer2.text.CueGroup.EMPTY_TIME_ZERO     // Catch:{ all -> 0x02e9 }
            r1.currentCueGroup = r4     // Catch:{ all -> 0x02e9 }
            r4 = 1
            r1.throwsWhenUsingWrongThread = r4     // Catch:{ all -> 0x02e9 }
            r1.addListener(r3)     // Catch:{ all -> 0x02e9 }
            android.os.Handler r5 = new android.os.Handler     // Catch:{ all -> 0x02e9 }
            r6 = r26
            r5.<init>(r6)     // Catch:{ all -> 0x02e9 }
            r6 = r33
            r6.addEventListener(r5, r3)     // Catch:{ all -> 0x02e9 }
            r3 = r36
            r1.addAudioOffloadListener(r3)     // Catch:{ all -> 0x02e9 }
            r5 = r0
            r0 = r38
            long r6 = r0.foregroundModeTimeoutMs     // Catch:{ all -> 0x02e9 }
            r8 = 0
            int r6 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
            if (r6 <= 0) goto L_0x022b
            long r6 = r0.foregroundModeTimeoutMs     // Catch:{ all -> 0x02e9 }
            r5.experimentalSetForegroundModeTimeoutMs(r6)     // Catch:{ all -> 0x02e9 }
        L_0x022b:
            com.google.android.exoplayer2.AudioBecomingNoisyManager r5 = new com.google.android.exoplayer2.AudioBecomingNoisyManager     // Catch:{ all -> 0x02e9 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e9 }
            r7 = r32
            r5.<init>(r6, r7, r3)     // Catch:{ all -> 0x02e9 }
            r1.audioBecomingNoisyManager = r5     // Catch:{ all -> 0x02e9 }
            boolean r6 = r0.handleAudioBecomingNoisy     // Catch:{ all -> 0x02e9 }
            r5.setEnabled(r6)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.AudioFocusManager r5 = new com.google.android.exoplayer2.AudioFocusManager     // Catch:{ all -> 0x02e9 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e9 }
            r5.<init>(r6, r7, r3)     // Catch:{ all -> 0x02e9 }
            r1.audioFocusManager = r5     // Catch:{ all -> 0x02e9 }
            boolean r6 = r0.handleAudioFocus     // Catch:{ all -> 0x02e9 }
            if (r6 == 0) goto L_0x024b
            com.google.android.exoplayer2.audio.AudioAttributes r14 = r1.audioAttributes     // Catch:{ all -> 0x02e9 }
            goto L_0x024d
        L_0x024b:
            r14 = r24
        L_0x024d:
            r5.setAudioAttributes(r14)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.StreamVolumeManager r5 = new com.google.android.exoplayer2.StreamVolumeManager     // Catch:{ all -> 0x02e9 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e9 }
            r5.<init>(r6, r7, r3)     // Catch:{ all -> 0x02e9 }
            r1.streamVolumeManager = r5     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.audio.AudioAttributes r3 = r1.audioAttributes     // Catch:{ all -> 0x02e9 }
            int r3 = r3.usage     // Catch:{ all -> 0x02e9 }
            int r3 = com.google.android.exoplayer2.util.Util.getStreamTypeForAudioUsage(r3)     // Catch:{ all -> 0x02e9 }
            r5.setStreamType(r3)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.WakeLockManager r3 = new com.google.android.exoplayer2.WakeLockManager     // Catch:{ all -> 0x02e9 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e9 }
            r3.<init>(r6)     // Catch:{ all -> 0x02e9 }
            r1.wakeLockManager = r3     // Catch:{ all -> 0x02e9 }
            int r6 = r0.wakeMode     // Catch:{ all -> 0x02e9 }
        ...
        L_0x0273:
            r12 = r2
        L_0x0274:
            r3.setEnabled(r12)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.WifiLockManager r3 = new com.google.android.exoplayer2.WifiLockManager     // Catch:{ all -> 0x02e9 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e9 }
            r3.<init>(r6)     // Catch:{ all -> 0x02e9 }
            r1.wifiLockManager = r3     // Catch:{ all -> 0x02e9 }
            int r0 = r0.wakeMode     // Catch:{ all -> 0x02e9 }
            r6 = 2
        ...
        L_0x0288:
            r3.setEnabled(r12)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.DeviceInfo r0 = createDeviceInfo(r5)     // Catch:{ all -> 0x02e9 }
            r1.deviceInfo = r0     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.video.VideoSize r0 = com.google.android.exoplayer2.video.VideoSize.UNKNOWN     // Catch:{ all -> 0x02e9 }
            r1.videoSize = r0     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.util.Size r0 = com.google.android.exoplayer2.util.Size.UNKNOWN     // Catch:{ all -> 0x02e9 }
            r1.surfaceSize = r0     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.audio.AudioAttributes r0 = r1.audioAttributes     // Catch:{ all -> 0x02e9 }
            r5 = r34
            r5.setAudioAttributes(r0)     // Catch:{ all -> 0x02e9 }
            int r0 = r1.audioSessionId     // Catch:{ all -> 0x02e9 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e9 }
            r2 = 10
            r1.sendRendererMessage(r4, r2, r0)     // Catch:{ all -> 0x02e9 }
            int r0 = r1.audioSessionId     // Catch:{ all -> 0x02e9 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e9 }
            r1.sendRendererMessage(r6, r2, r0)     // Catch:{ all -> 0x02e9 }
            com.google.android.exoplayer2.audio.AudioAttributes r0 = r1.audioAttributes     // Catch:{ all -> 0x02e9 }
            r2 = 3
            r1.sendRendererMessage(r4, r2, r0)     // Catch:{ all -> 0x02e9 }
            int r0 = r1.videoScalingMode     // Catch:{ all -> 0x02e9 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e9 }
            r2 = 4
            r1.sendRendererMessage(r6, r2, r0)     // Catch:{ all -> 0x02e9 }
            int r0 = r1.videoChangeFrameRateStrategy     // Catch:{ all -> 0x02e9 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e9 }
            r2 = 5
            r1.sendRendererMessage(r6, r2, r0)     // Catch:{ all -> 0x02e9 }
            boolean r0 = r1.skipSilenceEnabled     // Catch:{ all -> 0x02e9 }
            java.lang.Boolean r0 = java.lang.Boolean.valueOf(r0)     // Catch:{ all -> 0x02e9 }
            r2 = 9
            r1.sendRendererMessage(r4, r2, r0)     // Catch:{ all -> 0x02e9 }
            r0 = 7
            r2 = r35
            r1.sendRendererMessage(r6, r0, r2)     // Catch:{ all -> 0x02e9 }
            r0 = 6
            r3 = 8
            r1.sendRendererMessage(r0, r3, r2)     // Catch:{ all -> 0x02e9 }
            r29.open()
            return
        L_0x02e9:
            r0 = move-exception
    ...
    public /* synthetic */ void m408lambda$new$0$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener, FlagSet flagSet) {
    ...
    public /* synthetic */ void m410lambda$new$2$comgoogleandroidexoplayer2ExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        this.playbackInfoUpdateHandler.post(new ExoPlayerImpl$$ExternalSyntheticLambda12(this, playbackInfoUpdate));
    }
    ...
    public void setRepeatMode(int i) {
        ...
        if (this.repeatMode != i) {
            ...
            this.listeners.queueEvent(8, new ExoPlayerImpl$$ExternalSyntheticLambda17(i));
    ...
    public void setShuffleModeEnabled(boolean z) {
        ...
        if (this.shuffleModeEnabled != z) {
            ...
            this.listeners.queueEvent(9, new ExoPlayerImpl$$ExternalSyntheticLambda0(z));
            updateAvailableCommands();
            this.listeners.flushEvents();
        }
    }
    ...
    public void release() {
        ...
        Log.i(TAG, "Release " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.18.5] [" + Util.DEVICE_DEBUG_INFO + "] [" + ExoPlayerLibraryInfo.registeredModules() + "]");
        verifyApplicationThread();
        ...
        if (!this.internalPlayer.release()) {
            this.listeners.sendEvent(10, new ExoPlayerImpl$$ExternalSyntheticLambda21());
        }
    ...
    public void setTrackSelectionParameters(TrackSelectionParameters trackSelectionParameters) {
        ...
        if (this.trackSelector.isSetParametersSupported() && !trackSelectionParameters.equals(this.trackSelector.getParameters())) {
            ...
            this.listeners.sendEvent(19, new ExoPlayerImpl$$ExternalSyntheticLambda23(trackSelectionParameters));
        }
    }
    ...
    public /* synthetic */ void m411lambda$setPlaylistMetadata$7$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener) {
    ...
    public void setAudioAttributes(AudioAttributes audioAttributes2, boolean z) {
        ...
        if (!this.playerReleased) {
            if (!Util.areEqual(this.audioAttributes, audioAttributes2)) {
                ...
                this.listeners.queueEvent(20, new ExoPlayerImpl$$ExternalSyntheticLambda11(audioAttributes2));
            }
    ...
    public void setAudioSessionId(int i) {
        ...
        if (this.audioSessionId != i) {
            ...
            this.listeners.sendEvent(21, new ExoPlayerImpl$$ExternalSyntheticLambda18(i));
        }
    }
    ...
    public void setVolume(float f) {
        ...
        if (this.volume != constrainValue) {
            ...
            this.listeners.sendEvent(22, new ExoPlayerImpl$$ExternalSyntheticLambda13(constrainValue));
        }
    }
    ...
    public void m409lambda$new$1$comgoogleandroidexoplayer2ExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        long j;
        boolean z;
    ...
    private void updatePlaybackInfo(PlaybackInfo playbackInfo2, int i, int i2, boolean z, boolean z2, int i3, long j, int i4, boolean z3) {
        ...
        Pair<Boolean, Integer> evaluateMediaItemTransitionReason = evaluateMediaItemTransitionReason(playbackInfo2, playbackInfo4, z2, i3, !equals, z3);
        ...
        boolean equals2 = mediaMetadata2.equals(this.mediaMetadata);
        ...
        if (!equals) {
            this.listeners.queueEvent(0, new ExoPlayerImpl$$ExternalSyntheticLambda24(playbackInfo3, i));
        }
        if (z2) {
            this.listeners.queueEvent(11, new ExoPlayerImpl$$ExternalSyntheticLambda2(i5, getPreviousPositionInfo(i5, playbackInfo4, i4), getPositionInfo(j)));
        }
        if (booleanValue) {
            this.listeners.queueEvent(1, new ExoPlayerImpl$$ExternalSyntheticLambda3(mediaItem, intValue));
        }
        if (playbackInfo4.playbackError != playbackInfo3.playbackError) {
            this.listeners.queueEvent(10, new ExoPlayerImpl$$ExternalSyntheticLambda4(playbackInfo3));
            if (playbackInfo3.playbackError != null) {
                this.listeners.queueEvent(10, new ExoPlayerImpl$$ExternalSyntheticLambda5(playbackInfo3));
            }
        }
        if (playbackInfo4.trackSelectorResult != playbackInfo3.trackSelectorResult) {
            ...
            this.listeners.queueEvent(2, new ExoPlayerImpl$$ExternalSyntheticLambda6(playbackInfo3));
        }
        if (!equals2) {
            this.listeners.queueEvent(14, new ExoPlayerImpl$$ExternalSyntheticLambda7(this.mediaMetadata));
        }
        if (z6) {
            this.listeners.queueEvent(3, new ExoPlayerImpl$$ExternalSyntheticLambda8(playbackInfo3));
        }
        if (z5 || z4) {
            this.listeners.queueEvent(-1, new ExoPlayerImpl$$ExternalSyntheticLambda9(playbackInfo3));
        }
        if (z5) {
            this.listeners.queueEvent(4, new ExoPlayerImpl$$ExternalSyntheticLambda10(playbackInfo3));
        }
        if (z4) {
            this.listeners.queueEvent(5, new ExoPlayerImpl$$ExternalSyntheticLambda25(playbackInfo3, i2));
        }
        if (playbackInfo4.playbackSuppressionReason != playbackInfo3.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ExoPlayerImpl$$ExternalSyntheticLambda26(playbackInfo3));
        }
        if (isPlaying(playbackInfo4) != isPlaying(playbackInfo2)) {
            this.listeners.queueEvent(7, new ExoPlayerImpl$$ExternalSyntheticLambda27(playbackInfo3));
        }
        if (!playbackInfo4.playbackParameters.equals(playbackInfo3.playbackParameters)) {
            this.listeners.queueEvent(12, new ExoPlayerImpl$$ExternalSyntheticLambda28(playbackInfo3));
        }
        if (z) {
    ...
    public /* synthetic */ void m412lambda$updateAvailableCommands$26$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener) {
    ...
    private final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener, SphericalGLSurfaceView.VideoSurfaceListener, AudioFocusManager.PlayerControl, AudioBecomingNoisyManager.EventListener, StreamVolumeManager.Listener, ExoPlayer.AudioOffloadListener {
        ...
        public void onCues(CueGroup cueGroup) {
            ...
            ExoPlayerImpl.this.listeners.sendEvent(27, new ExoPlayerImpl$ComponentListener$$ExternalSyntheticLambda1(cueGroup));
        }
        ...
        public /* synthetic */ void m413lambda$onMetadata$4$comgoogleandroidexoplayer2ExoPlayerImpl$ComponentListener(Player.Listener listener) {
        ...
        public void onStreamTypeChanged(int i) {
            ...
            if (!access$2400.equals(ExoPlayerImpl.this.deviceInfo)) {
                ...
                ExoPlayerImpl.this.listeners.sendEvent(29, new ExoPlayerImpl$ComponentListener$$ExternalSyntheticLambda7(access$2400));
            }
        }
    ...
    private static final class Api31 {
        ...
        public static PlayerId registerMediaMetricsListener(Context context, ExoPlayerImpl exoPlayerImpl, boolean z) {
            ...
            if (create == null) {
                ...
                return new PlayerId(DiskLruCache$$ExternalSyntheticApiModelOutline0.m());
            }
            if (z) {
