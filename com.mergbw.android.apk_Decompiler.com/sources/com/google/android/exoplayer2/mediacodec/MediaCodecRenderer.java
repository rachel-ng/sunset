...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x0021, code lost:
        if (r1 >= r0.largestQueuedPresentationTimeUs) goto L_0x0036;
     */
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                Log.w(TAG, "Drm session requires secure decoder for " + this.inputFormat.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos + Consts.DOT);
            }
        }
        return decoderInfos;
    }
    ...
    private boolean drainOutputBuffer(long r20, long r22) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x00ce:
            ...
            boolean r0 = r15.codecReceivedEos
            if (r0 == 0) goto L_0x010c
            com.google.android.exoplayer2.mediacodec.MediaCodecAdapter r5 = r15.codec     // Catch:{ IllegalStateException -> 0x00ff }
            java.nio.ByteBuffer r6 = r15.outputBuffer     // Catch:{ IllegalStateException -> 0x00ff }
            int r7 = r15.outputIndex     // Catch:{ IllegalStateException -> 0x00ff }
            android.media.MediaCodec$BufferInfo r0 = r15.outputBufferInfo     // Catch:{ IllegalStateException -> 0x00ff }
            int r8 = r0.flags     // Catch:{ IllegalStateException -> 0x00ff }
            android.media.MediaCodec$BufferInfo r0 = r15.outputBufferInfo     // Catch:{ IllegalStateException -> 0x00ff }
            long r10 = r0.presentationTimeUs     // Catch:{ IllegalStateException -> 0x00ff }
            boolean r12 = r15.isDecodeOnlyOutputBuffer     // Catch:{ IllegalStateException -> 0x00ff }
            boolean r13 = r15.isLastOutputBuffer     // Catch:{ IllegalStateException -> 0x00ff }
            com.google.android.exoplayer2.Format r9 = r15.outputFormat     // Catch:{ IllegalStateException -> 0x00ff }
            r17 = 1
            r0 = r19
            r1 = r20
            r3 = r22
            ...
            r17 = r14
            r14 = r18
            boolean r0 = r0.processOutputBuffer(r1, r3, r5, r6, r7, r8, r9, r10, r12, r13, r14)     // Catch:{ IllegalStateException -> 0x0101 }
            goto L_0x012d
        L_0x00ff:
            r17 = r14
        L_0x0101:
