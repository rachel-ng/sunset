...
public final class MediaCodecUtil {
    ...
    public static List<MediaCodecInfo> getDecoderInfosSortedByFormatSupport(List<MediaCodecInfo> list, Format format) {
        ...
        sortByScore(arrayList, new MediaCodecUtil$$ExternalSyntheticLambda7(format));
        return arrayList;
    }
    ...
    private static void applyWorkarounds(String str, List<MediaCodecInfo> list) {
        if (MimeTypes.AUDIO_RAW.equals(str)) {
            ...
            sortByScore(list, new MediaCodecUtil$$ExternalSyntheticLambda5());
        }
        if (Util.SDK_INT < 21 && list.size() > 1) {
            String str2 = list.get(0).name;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new MediaCodecUtil$$ExternalSyntheticLambda6());
            }
        }
    ...
    private static <T> void sortByScore(List<T> list, ScoreProvider<T> scoreProvider) {
        Collections.sort(list, new MediaCodecUtil$$ExternalSyntheticLambda4(scoreProvider));
    }
