...
public final class MediaCodecInfo {
    ...
    private static final class Api29 {
        ...
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            List m = videoCapabilities.getSupportedPerformancePoints();
            if (m == null || m.isEmpty() || MediaCodecInfo.needsIgnorePerformancePointsWorkaround()) {
                return 0;
            }
            FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m$1();
            MediaCodecInfo.VideoCapabilities.PerformancePoint m2 = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(i, i2, (int) d);
            for (int i3 = 0; i3 < m.size(); i3++) {
                if (FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(m.get(i3)).covers(m2)) {
                    return 2;
                }
            }
            return 1;
