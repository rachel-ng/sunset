...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    private class PreacquiredSessionReference implements DrmSessionManager.DrmSessionReference {
        ...
        public void acquire(Format format) {
            ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).post(new DefaultDrmSessionManager$PreacquiredSessionReference$$ExternalSyntheticLambda0(this, format));
        }
        ...
        public /* synthetic */ void m453lambda$acquire$0$comgoogleandroidexoplayer2drmDefaultDrmSessionManager$PreacquiredSessionReference(Format format) {
        ...
        public void release() {
            Util.postOrRun((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler), new DefaultDrmSessionManager$PreacquiredSessionReference$$ExternalSyntheticLambda1(this));
        }
        ...
        public /* synthetic */ void m454lambda$release$1$comgoogleandroidexoplayer2drmDefaultDrmSessionManager$PreacquiredSessionReference() {
            if (!this.isReleased) {
