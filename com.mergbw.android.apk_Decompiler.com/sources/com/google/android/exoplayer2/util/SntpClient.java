...
public final class SntpClient {
    ...
    private static void writeTimestamp(byte[] bArr, int i, long j) {
        ...
        bArr[i + 1] = (byte) ((int) (j4 >> 16));
        bArr[i + 2] = (byte) ((int) (j4 >> 8));
        bArr[i + 3] = (byte) ((int) j4);
        long j5 = (j3 * 4294967296L) / 1000;
        bArr[i + 4] = (byte) ((int) (j5 >> 24));
        bArr[i + 5] = (byte) ((int) (j5 >> 16));
        bArr[i + 6] = (byte) ((int) (j5 >> 8));
        bArr[i + 7] = (byte) ((int) (Math.random() * 255.0d));
    }
