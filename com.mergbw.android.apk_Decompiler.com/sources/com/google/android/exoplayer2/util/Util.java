...
public final class Util {
    ...
    public static <T> ListenableFuture<T> postOrRunWithCompletion(Handler handler, Runnable runnable, T t) {
        ...
        postOrRun(handler, new Util$$ExternalSyntheticLambda5(create, runnable, t));
        return create;
    }
    ...
    public static <T, U> ListenableFuture<T> transformFutureAsync(ListenableFuture<U> listenableFuture, AsyncFunction<U, T> asyncFunction) {
        SettableFuture create = SettableFuture.create();
        create.addListener(new Util$$ExternalSyntheticLambda6(create, listenableFuture), MoreExecutors.directExecutor());
        listenableFuture.addListener(new Util$$ExternalSyntheticLambda7(listenableFuture, create, asyncFunction), MoreExecutors.directExecutor());
        return create;
    }
    ...
    static /* synthetic */ void lambda$transformFutureAsync$2(com.google.common.util.concurrent.ListenableFuture r0, com.google.common.util.concurrent.SettableFuture r1, com.google.common.util.concurrent.AsyncFunction r2) {
        ...
        L_0x0025:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.util.Util.lambda$transformFutureAsync$2(com.google.common.util.concurrent.ListenableFuture, com.google.common.util.concurrent.SettableFuture, com.google.common.util.concurrent.AsyncFunction):void");
    }
    ...
    public static ExecutorService newSingleThreadExecutor(String str) {
        return Executors.newSingleThreadExecutor(new Util$$ExternalSyntheticLambda8(str));
    }
    ...
    public static String getUserAgent(Context context, String str) {
        ...
        return str + RemoteSettings.FORWARD_SLASH_STRING + str2 + " (Linux;Android " + Build.VERSION.RELEASE + ") ExoPlayerLib/2.18.5";
    }
    ...
    public static Locale getDefaultDisplayLocale() {
        return SDK_INT >= 24 ? Locale.getDefault(Chip$$ExternalSyntheticApiModelOutline0.m()) : Locale.getDefault();
    }
    ...
    private static String[] getSystemLocalesV24(Configuration configuration) {
        return split(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(configuration)), ",");
    }
