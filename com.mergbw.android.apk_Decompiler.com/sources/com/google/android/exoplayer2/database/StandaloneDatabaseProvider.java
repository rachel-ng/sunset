...
public class StandaloneDatabaseProvider extends SQLiteOpenHelper implements DatabaseProvider {
    ...
    private static void wipeDatabase(SQLiteDatabase sQLiteDatabase) {
        String str;
        Cursor query = sQLiteDatabase.query("sqlite_master", new String[]{SessionDescription.ATTR_TYPE, AppMeasurementSdk.ConditionalUserProperty.NAME}, (String) null, (String[]) null, (String) null, (String) null, (String) null);
