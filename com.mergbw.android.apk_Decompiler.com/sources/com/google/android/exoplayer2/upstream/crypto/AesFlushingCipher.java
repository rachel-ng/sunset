...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            instance.init(i, new SecretKeySpec(bArr, Util.splitAtFirst(instance.getAlgorithm(), RemoteSettings.FORWARD_SLASH_STRING)[0]), new IvParameterSpec(getInitializationVector(j, j3)));
            if (i2 != 0) {
