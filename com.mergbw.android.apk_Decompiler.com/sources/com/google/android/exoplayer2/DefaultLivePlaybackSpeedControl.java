...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        if (this.currentTargetLiveOffsetUs > j2) {
            ...
            long j3 = ((long) ((this.adjustedPlaybackSpeed - 1.0f) * msToUs)) + ((long) ((this.maxPlaybackSpeed - 1.0f) * msToUs));
            this.currentTargetLiveOffsetUs = Longs.max(j2, this.idealTargetLiveOffsetUs, this.currentTargetLiveOffsetUs - j3);
            return;
        }
