...
public final /* synthetic */ class DefaultTrackSelector$$ExternalSyntheticLambda5 implements DefaultTrackSelector.TrackInfo.Factory {
    ...
    public /* synthetic */ DefaultTrackSelector$$ExternalSyntheticLambda5(DefaultTrackSelector defaultTrackSelector, DefaultTrackSelector.Parameters parameters, boolean z) {
    ...
    public final List create(int i, TrackGroup trackGroup, int[] iArr) {
        return this.f$0.m508lambda$selectAudioTrack$3$comgoogleandroidexoplayer2trackselectionDefaultTrackSelector(this.f$1, this.f$2, i, trackGroup, iArr);
    }
}
