...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public final Pair<RendererConfiguration[], ExoTrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) throws ExoPlaybackException {
        ...
        for (int i2 = 0; i2 < rendererCount; i2++) {
            rendererConfigurationArr[i2] = (parameters2.getRendererDisabled(i2) || parameters2.disabledTrackTypes.contains(Integer.valueOf(mappedTrackInfo.getRendererType(i2))) || (mappedTrackInfo.getRendererType(i2) != -2 && createTrackSelections[i2] == null)) ? null : RendererConfiguration.DEFAULT;
        }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters2) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new DefaultTrackSelector$$ExternalSyntheticLambda5(this, parameters2, z), new DefaultTrackSelector$$ExternalSyntheticLambda6());
    }
    ...
    public /* synthetic */ List m508lambda$selectAudioTrack$3$comgoogleandroidexoplayer2trackselectionDefaultTrackSelector(Parameters parameters2, boolean z, int i, TrackGroup trackGroup, int[] iArr) {
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectTextTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, Parameters parameters2, String str) throws ExoPlaybackException {
        return selectTracksForType(3, mappedTrackInfo, iArr, new DefaultTrackSelector$$ExternalSyntheticLambda7(parameters2, str), new DefaultTrackSelector$$ExternalSyntheticLambda8());
    }
    ...
    private static class SpatializerWrapperV32 {
        ...
        private SpatializerWrapperV32(Spatializer spatializer2) {
            ...
            this.spatializationSupported = Chip$$ExternalSyntheticApiModelOutline0.m(spatializer2) != 0;
        }
        ...
        public boolean isEnabled() {
            return Chip$$ExternalSyntheticApiModelOutline0.m(this.spatializer);
        }
