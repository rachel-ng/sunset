...
public final class TrackSelectionDialogBuilder {
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            View inflate = LayoutInflater.from((Context) cls.getMethod("getContext", (Class[]) null).invoke(newInstance, (Object[]) null)).inflate(R.layout.exo_track_selection_dialog, (ViewGroup) null);
            ...
            return (Dialog) cls.getMethod("create", (Class[]) null).invoke(newInstance, (Object[]) null);
    ...
    public /* synthetic */ void m532lambda$setUpDialogView$1$comgoogleandroidexoplayer2uiTrackSelectionDialogBuilder(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
