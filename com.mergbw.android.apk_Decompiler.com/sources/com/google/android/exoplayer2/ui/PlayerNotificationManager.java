        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (access$500 != null && PlayerNotificationManager.this.isNotificationStarted && intent.getIntExtra(PlayerNotificationManager.EXTRA_INSTANCE_ID, PlayerNotificationManager.this.instanceId) == PlayerNotificationManager.this.instanceId) {
                ...
                if (PlayerNotificationManager.ACTION_PLAY.equals(action)) {
                    if (access$500.getPlaybackState() == 1 && access$500.isCommandAvailable(2)) {
                        access$500.prepare();
                    } else if (access$500.getPlaybackState() == 4 && access$500.isCommandAvailable(4)) {
                        access$500.seekToDefaultPosition();
                    }
                    if (access$500.isCommandAvailable(1)) {
                        access$500.play();
                    }
