    ...
    private static final class Api29 {
        ...
        public static int[] getDirectPlaybackSupportedEncodings() {
            ...
            while (it.hasNext()) {
                ...
                if (FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(new AudioFormat.Builder().setChannelMask(12).setEncoding(num.intValue()).setSampleRate(48000).build(), DEFAULT_AUDIO_ATTRIBUTES)) {
        ...
        public static int getMaxSupportedChannelCountForPassthrough(int i, int i2) {
            for (int i3 = 8; i3 > 0; i3--) {
                if (FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(new AudioFormat.Builder().setEncoding(i).setSampleRate(i2).setChannelMask(Util.getAudioTrackChannelConfig(i3)).build(), DEFAULT_AUDIO_ATTRIBUTES)) {
                    return i3;
                }
            }
            return 0;
