...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(android.content.Context r17, android.util.AttributeSet r18, int r19) {
        /*
            ...
            com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda6 r1 = new com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda6
            r1.<init>()
            r0.lengthCounter = r1
    ...
    private void updateCursorColor() {
        ...
        if (editText2 != null && editText2.getTextCursorDrawable() != null) {
            Drawable m = this.editText.getTextCursorDrawable();
            if (isOnError() && (colorStateList = this.cursorErrorColor) != null) {
                colorStateList2 = colorStateList;
            }
            DrawableCompat.setTintList(m, colorStateList2);
        }
    }
