...
final class zzhff {
    private static final zzhfc zza = new zzhfd();
    ...
    static int zzd(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x00bd:
            r1 = r4
        L_0x00be:
            com.google.android.gms.internal.ads.zzhfe r8 = new com.google.android.gms.internal.ads.zzhfe
            int r1 = r1 + -1
            r8.<init>(r1, r0)
            throw r8
        L_0x00c6:
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzhcd {
        zzhfc zzhfc = zza;
        if (byteBuffer.hasArray()) {
            return zzhfc.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (byteBuffer.isDirect()) {
            return zzhfd.zzd(byteBuffer, i, i2);
        } else {
            return zzhfc.zzd(byteBuffer, i, i2);
        }
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzhcd {
