...
interface zzna {
    ...
    void zza(int i, zzia zzia) throws IOException;

    <K, V> void zza(int i, zzkk<K, V> zzkk, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzll zzll) throws IOException;
    ...
    @Deprecated
    void zza(int i, List<?> list, zzll zzll) throws IOException;
    ...
    void zzb(int i, Object obj, zzll zzll) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzll zzll) throws IOException;
