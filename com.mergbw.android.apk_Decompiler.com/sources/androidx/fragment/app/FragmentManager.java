...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m46lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m47lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    public /* synthetic */ void m48lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m49lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle saveAllStateInternal = m45lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m45lambda$attachController$4$androidxfragmentappFragmentManager() {
        ...
        if (!allSavedState.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                bundle2.putParcelable(RemoteConfigConstants.ResponseFieldKey.STATE, next2);
