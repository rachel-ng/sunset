...
public final class DeletionRequest {
    ...
    public DeletionRequest(int i, int i2, Instant instant, Instant instant2, List<? extends Uri> list, List<? extends Uri> list2) {
        Intrinsics.checkNotNullParameter(instant, TtmlNode.START);
        Intrinsics.checkNotNullParameter(instant2, TtmlNode.END);
    ...
    public /* synthetic */ DeletionRequest(int r8, int r9, java.time.Instant r10, java.time.Instant r11, java.util.List r12, java.util.List r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            ...
            java.time.Instant r10 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m()
        ...
        L_0x000d:
            ...
            java.time.Instant r11 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m$1()
    ...
    public static final class Builder {
        ...
        public Builder(int i, int i2) {
            this.deletionMode = i;
            this.matchBehavior = i2;
            Instant m = Trace$$ExternalSyntheticApiModelOutline0.m();
            Intrinsics.checkNotNullExpressionValue(m, "MIN");
            this.start = m;
            Instant m$1 = Trace$$ExternalSyntheticApiModelOutline0.m$1();
        ...
        public final Builder setEnd(Instant instant) {
            Intrinsics.checkNotNullParameter(instant, TtmlNode.END);
            Builder builder = this;
            this.end = instant;
            return this;
        }
