    ...
    private static final class Api33Ext4Impl extends AdSelectionManager {
        ...
        public Api33Ext4Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.media.AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$1()
                java.lang.Object r2 = r2.getSystemService(r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.adselection.AdSelectionManager r2 = androidx.media.AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)
        ...
        public java.lang.Object selectAds(androidx.privacysandbox.ads.adservices.adselection.AdSelectionConfig r5, kotlin.coroutines.Continuation<? super androidx.privacysandbox.ads.adservices.adselection.AdSelectionOutcome> r6) {
            ...
            L_0x0048:
                r5 = r4
            L_0x0049:
                android.adservices.adselection.AdSelectionOutcome r6 = androidx.media.AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)
        ...
        private final AdSelectionConfig convertAdSelectionConfig(AdSelectionConfig adSelectionConfig) {
            AdSelectionConfig m = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m().setAdSelectionSignals(convertAdSelectionSignals(adSelectionConfig.getAdSelectionSignals())).setCustomAudienceBuyers(convertBuyers(adSelectionConfig.getCustomAudienceBuyers())).setDecisionLogicUri(adSelectionConfig.getDecisionLogicUri()).setSeller(AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(adSelectionConfig.getSeller().getIdentifier())).setPerBuyerSignals(convertPerBuyerSignals(adSelectionConfig.getPerBuyerSignals())).setSellerSignals(convertAdSelectionSignals(adSelectionConfig.getSellerSignals())).setTrustedScoringSignalsUri(adSelectionConfig.getTrustedScoringSignalsUri()).build();
        ...
        private final AdSelectionSignals convertAdSelectionSignals(androidx.privacysandbox.ads.adservices.common.AdSelectionSignals adSelectionSignals) {
            AdSelectionSignals m = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(adSelectionSignals.getSignals());
        ...
        private final List<AdTechIdentifier> convertBuyers(List<androidx.privacysandbox.ads.adservices.common.AdTechIdentifier> list) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdTechIdentifier identifier : list) {
                AdTechIdentifier m = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(identifier.getIdentifier());
        ...
        private final Map<AdTechIdentifier, AdSelectionSignals> convertPerBuyerSignals(Map<androidx.privacysandbox.ads.adservices.common.AdTechIdentifier, androidx.privacysandbox.ads.adservices.common.AdSelectionSignals> map) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdTechIdentifier next : map.keySet()) {
                AdTechIdentifier m = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(next.getIdentifier());
        ...
        private final AdSelectionOutcome convertResponse(AdSelectionOutcome adSelectionOutcome) {
            long m = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(adSelectionOutcome);
            Uri m2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(adSelectionOutcome);
        ...
        public final ReportImpressionRequest convertReportImpressionRequest(ReportImpressionRequest reportImpressionRequest) {
            AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m();
            return AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(reportImpressionRequest.getAdSelectionId(), convertAdSelectionConfig(reportImpressionRequest.getAdSelectionConfig()));
        }
