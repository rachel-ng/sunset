...
public class ExifInterface {
    ...
    private static class ExifAttribute {
        ...
        public java.lang.Object getValue(java.nio.ByteOrder r11) {
            ...
            L_0x00ff:
                int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0181 }
                byte[] r5 = androidx.exifinterface.media.ExifInterface.EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0181 }
                int r5 = r5.length     // Catch:{ IOException -> 0x0181 }
            ...
            L_0x0117:
                ...
                goto L_0x0107
            L_0x011a:
                byte[] r11 = androidx.exifinterface.media.ExifInterface.EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0181 }
                int r4 = r11.length     // Catch:{ IOException -> 0x0181 }
            L_0x011d:
            ...
            L_0x014b:
                ...
                int r5 = r11.length     // Catch:{ IOException -> 0x0181 }
                r6 = 1
                if (r5 != r6) goto L_0x016c
                byte r5 = r11[r4]     // Catch:{ IOException -> 0x0181 }
                if (r5 < 0) goto L_0x016c
                if (r5 > r6) goto L_0x016c
                java.lang.String r11 = new java.lang.String     // Catch:{ IOException -> 0x0181 }
                int r5 = r5 + 48
                char r5 = (char) r5     // Catch:{ IOException -> 0x0181 }
                char[] r6 = new char[r6]     // Catch:{ IOException -> 0x0181 }
                r6[r4] = r5     // Catch:{ IOException -> 0x0181 }
                r11.<init>(r6)     // Catch:{ IOException -> 0x0181 }
    ...
    public void setAttribute(java.lang.String r18, java.lang.String r19) {
        ...
        L_0x00b3:
            ...
            goto L_0x0110
        L_0x00ec:
            double r8 = java.lang.Double.parseDouble(r2)     // Catch:{ NumberFormatException -> 0x00fa }
            androidx.exifinterface.media.ExifInterface$Rational r10 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ NumberFormatException -> 0x00fa }
            r10.<init>(r8)     // Catch:{ NumberFormatException -> 0x00fa }
            java.lang.String r2 = r10.toString()     // Catch:{ NumberFormatException -> 0x00fa }
            goto L_0x0110
        L_0x00fa:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder
            r3.<init>(r5)
    ...
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x0030:
            ...
            java.io.File r3 = java.io.File.createTempFile(r3, r4)     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            java.lang.String r4 = r14.mFilename     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            r5 = 0
            if (r4 == 0) goto L_0x0050
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            r4.<init>(r7)     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            goto L_0x005e
        L_0x0050:
            java.io.FileDescriptor r4 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r4, r5, r7)     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
            r4.<init>(r7)     // Catch:{ Exception -> 0x0159, all -> 0x0156 }
        L_0x005e:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0152, all -> 0x014e }
            r7.<init>(r3)     // Catch:{ Exception -> 0x0152, all -> 0x014e }
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r4, r7)     // Catch:{ Exception -> 0x014c, all -> 0x014a }
        ...
        L_0x0119:
            ...
            r2 = r4
        L_0x011c:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x0132 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0132 }
            r5.<init>(r0)     // Catch:{ all -> 0x0132 }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ all -> 0x0132 }
            r5.append(r0)     // Catch:{ all -> 0x0132 }
            java.lang.String r0 = r5.toString()     // Catch:{ all -> 0x0132 }
            r4.<init>(r0, r2)     // Catch:{ all -> 0x0132 }
            throw r4     // Catch:{ all -> 0x0132 }
        L_0x0132:
            r0 = move-exception
        L_0x0133:
            r2 = r11
        L_0x0134:
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r2)     // Catch:{ all -> 0x013b }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r8)     // Catch:{ all -> 0x013b }
        ...
        L_0x0159:
            ...
            r7 = r2
        L_0x015b:
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x0163 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:60:0x0172 A[LOOP:0: B:8:0x0034->B:60:0x0172, LOOP_END] */
     ...
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing exception handler attribute for start block: B:54:0x0137 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void getHeifAttributes(final androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r14) throws java.io.IOException {
        /*
            ...
            r2.<init>()
            androidx.exifinterface.media.ExifInterface$1 r3 = new androidx.exifinterface.media.ExifInterface$1     // Catch:{ RuntimeException -> 0x0137 }
            r3.<init>(r14)     // Catch:{ RuntimeException -> 0x0137 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api23Impl.setDataSource(r2, r3)     // Catch:{ RuntimeException -> 0x0137 }
            r3 = 33
            java.lang.String r3 = r2.extractMetadata(r3)     // Catch:{ RuntimeException -> 0x0137 }
            r4 = 34
            java.lang.String r4 = r2.extractMetadata(r4)     // Catch:{ RuntimeException -> 0x0137 }
            r5 = 26
            java.lang.String r5 = r2.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x0137 }
            r6 = 17
            java.lang.String r6 = r2.extractMetadata(r6)     // Catch:{ RuntimeException -> 0x0137 }
            boolean r5 = r0.equals(r5)     // Catch:{ RuntimeException -> 0x0137 }
            if (r5 == 0) goto L_0x0048
            r0 = 29
            java.lang.String r0 = r2.extractMetadata(r0)     // Catch:{ RuntimeException -> 0x0137 }
            r5 = 30
            java.lang.String r5 = r2.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x0137 }
            r6 = 31
            java.lang.String r6 = r2.extractMetadata(r6)     // Catch:{ RuntimeException -> 0x0137 }
            goto L_0x0064
        L_0x0048:
            boolean r0 = r0.equals(r6)     // Catch:{ RuntimeException -> 0x0137 }
        ...
        L_0x0064:
            ...
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r8 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0137 }
            r8 = r8[r7]     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r9 = "ImageWidth"
            int r10 = java.lang.Integer.parseInt(r0)     // Catch:{ RuntimeException -> 0x0137 }
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0137 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r10, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x0137 }
            r8.put(r9, r10)     // Catch:{ RuntimeException -> 0x0137 }
        L_0x007a:
            if (r5 == 0) goto L_0x008f
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r8 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0137 }
            r8 = r8[r7]     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r9 = "ImageLength"
            int r10 = java.lang.Integer.parseInt(r5)     // Catch:{ RuntimeException -> 0x0137 }
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0137 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r10, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x0137 }
            r8.put(r9, r10)     // Catch:{ RuntimeException -> 0x0137 }
        L_0x008f:
            ...
            int r9 = java.lang.Integer.parseInt(r6)     // Catch:{ RuntimeException -> 0x0137 }
            r10 = 90
        ...
        L_0x00a9:
            r9 = r8
        L_0x00aa:
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r10 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0137 }
            r10 = r10[r7]     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r11 = "Orientation"
            java.nio.ByteOrder r12 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0137 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r9 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r12)     // Catch:{ RuntimeException -> 0x0137 }
            r10.put(r11, r9)     // Catch:{ RuntimeException -> 0x0137 }
        L_0x00b9:
            if (r3 == 0) goto L_0x010c
            if (r4 == 0) goto L_0x010c
            int r3 = java.lang.Integer.parseInt(r3)     // Catch:{ RuntimeException -> 0x0137 }
            int r4 = java.lang.Integer.parseInt(r4)     // Catch:{ RuntimeException -> 0x0137 }
            if (r4 <= r8) goto L_0x0104
            long r9 = (long) r3     // Catch:{ RuntimeException -> 0x0137 }
            r14.seek(r9)     // Catch:{ RuntimeException -> 0x0137 }
            byte[] r9 = new byte[r8]     // Catch:{ RuntimeException -> 0x0137 }
            int r10 = r14.read(r9)     // Catch:{ RuntimeException -> 0x0137 }
            if (r10 != r8) goto L_0x00fc
            int r3 = r3 + r8
            int r4 = r4 + -6
            byte[] r8 = IDENTIFIER_EXIF_APP1     // Catch:{ RuntimeException -> 0x0137 }
            boolean r8 = java.util.Arrays.equals(r9, r8)     // Catch:{ RuntimeException -> 0x0137 }
            if (r8 == 0) goto L_0x00f4
            byte[] r8 = new byte[r4]     // Catch:{ RuntimeException -> 0x0137 }
            int r14 = r14.read(r8)     // Catch:{ RuntimeException -> 0x0137 }
            if (r14 != r4) goto L_0x00ec
            r13.mOffsetToExifData = r3     // Catch:{ RuntimeException -> 0x0137 }
            r13.readExifSegment(r8, r7)     // Catch:{ RuntimeException -> 0x0137 }
            goto L_0x010c
        L_0x00ec:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r0 = "Can't read exif"
            r14.<init>(r0)     // Catch:{ RuntimeException -> 0x0137 }
            throw r14     // Catch:{ RuntimeException -> 0x0137 }
        L_0x00f4:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0137 }
        ...
        L_0x0104:
            ...
            throw r14     // Catch:{ RuntimeException -> 0x0137 }
        L_0x010c:
            boolean r14 = DEBUG     // Catch:{ RuntimeException -> 0x0137 }
            if (r14 == 0) goto L_0x0131
            java.lang.String r14 = "ExifInterface"
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x0137 }
            r3.<init>(r1)     // Catch:{ RuntimeException -> 0x0137 }
            r3.append(r0)     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r0 = "x"
            r3.append(r0)     // Catch:{ RuntimeException -> 0x0137 }
            r3.append(r5)     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r0 = ", rotation "
            r3.append(r0)     // Catch:{ RuntimeException -> 0x0137 }
            r3.append(r6)     // Catch:{ RuntimeException -> 0x0137 }
            java.lang.String r0 = r3.toString()     // Catch:{ RuntimeException -> 0x0137 }
            android.util.Log.d(r14, r0)     // Catch:{ RuntimeException -> 0x0137 }
        L_0x0131:
            r2.release()
            return
        L_0x0135:
            ...
            goto L_0x013f
        L_0x0137:
            java.lang.UnsupportedOperationException r14 = new java.lang.UnsupportedOperationException     // Catch:{ all -> 0x0135 }
            java.lang.String r0 = "Failed to read EXIF from HEIF file. Given stream is either malformed or unsupported."
            r14.<init>(r0)     // Catch:{ all -> 0x0135 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:91:0x026b  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r30, int r31) throws java.io.IOException {
        ...
        L_0x0069:
            ...
            java.lang.Integer r26 = java.lang.Integer.valueOf(r15)
        ...
        L_0x0165:
            ...
            androidx.exifinterface.media.ExifInterface$ExifAttribute r6 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r6, (java.nio.ByteOrder) r9)
        ...
        L_0x02d2:
            java.nio.ByteOrder r4 = r0.mExifByteOrder
            java.lang.String r4 = r8.getStringValue(r4)
     ...
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing exception handler attribute for start block: B:68:0x0149 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.util.Pair<java.lang.Integer, java.lang.Integer> guessDataFormat(java.lang.String r10) {
        ...
        L_0x00ff:
            ...
            return r10
        L_0x0105:
            long r0 = java.lang.Long.parseLong(r10)     // Catch:{ NumberFormatException -> 0x0149 }
            java.lang.Long r2 = java.lang.Long.valueOf(r0)     // Catch:{ NumberFormatException -> 0x0149 }
            r2.getClass()     // Catch:{ NumberFormatException -> 0x0149 }
            ...
            android.util.Pair r0 = new android.util.Pair     // Catch:{ NumberFormatException -> 0x0149 }
            r1 = 3
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch:{ NumberFormatException -> 0x0149 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r4)     // Catch:{ NumberFormatException -> 0x0149 }
            r0.<init>(r1, r2)     // Catch:{ NumberFormatException -> 0x0149 }
            return r0
        L_0x012e:
            r2.getClass()     // Catch:{ NumberFormatException -> 0x0149 }
            ...
            r1 = 9
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch:{ NumberFormatException -> 0x0149 }
            r0.<init>(r1, r7)     // Catch:{ NumberFormatException -> 0x0149 }
            return r0
        L_0x013f:
            android.util.Pair r0 = new android.util.Pair     // Catch:{ NumberFormatException -> 0x0149 }
            java.lang.Integer r1 = java.lang.Integer.valueOf(r4)     // Catch:{ NumberFormatException -> 0x0149 }
            r0.<init>(r1, r7)     // Catch:{ NumberFormatException -> 0x0149 }
            return r0
        L_0x0149:
            java.lang.Double.parseDouble(r10)     // Catch:{ NumberFormatException -> 0x0158 }
            android.util.Pair r10 = new android.util.Pair     // Catch:{ NumberFormatException -> 0x0158 }
            r0 = 12
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ NumberFormatException -> 0x0158 }
            r10.<init>(r0, r7)     // Catch:{ NumberFormatException -> 0x0158 }
            return r10
        L_0x0158:
            android.util.Pair r10 = new android.util.Pair
            r10.<init>(r5, r7)
