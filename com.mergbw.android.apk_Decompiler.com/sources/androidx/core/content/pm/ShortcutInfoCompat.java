...
public class ShortcutInfoCompat {
    ...
    static LocusIdCompat getLocusId(ShortcutInfo shortcutInfo) {
        if (Build.VERSION.SDK_INT < 29) {
            return getLocusIdFromExtra(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
        }
        if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            this.mInfo = shortcutInfoCompat;
            shortcutInfoCompat.mContext = context;
            shortcutInfoCompat.mId = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPackageName = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            ...
            shortcutInfoCompat.mCategories = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPersons = ShortcutInfoCompat.getPersonsFromExtra(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
            shortcutInfoCompat.mUser = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLastChangedTimestamp = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 30) {
                shortcutInfoCompat.mIsCached = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            }
            ...
            shortcutInfoCompat.mHasKeyFieldsOnly = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            ...
            shortcutInfoCompat.mExtras = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
        }
                ...
                if (this.mCapabilityBindingParams != null) {
                    ...
                    for (String next : this.mCapabilityBindingParams.keySet()) {
                        ...
                        for (String str : map.keySet()) {
                            ...
                            persistableBundle.putStringArray(next + RemoteSettings.FORWARD_SLASH_STRING + str, list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                        }
                    }
                }
