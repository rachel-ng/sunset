...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f23top;
    }
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f23top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f23top, insets.right, insets.bottom);
    }
    ...
    private static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i, boolean z) {
            ...
            if (i != 1) {
                ...
                return Insets.of(0, Math.max(getRootStableInsets().f23top, getSystemWindowInsets().f23top), 0, 0);
            } else {
                return Insets.of(0, getSystemWindowInsets().f23top, 0, 0);
            }
        }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f23top - i2);
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f23top, insets.right, insets.bottom);
            }
        }
            ...
            for (int i4 = 1; i4 <= 256; i4 <<= 1) {
                if ((i & i4) != 0) {
                    if (i4 == 1) {
                        ...
                        i2 = HalfKt$$ExternalSyntheticApiModelOutline0.m$2();
                    } else if (i4 == 4) {
                        i2 = HalfKt$$ExternalSyntheticApiModelOutline0.m$3();
                    } else if (i4 == 8) {
