...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_PAGE_LEFT = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 29 ? AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$1() : null, 16908360, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        public static final AccessibilityActionCompat ACTION_PAGE_RIGHT;
        public static final AccessibilityActionCompat ACTION_PAGE_UP = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 29 ? AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m() : null, 16908358, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                accessibilityAction = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$2();
            } else {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                accessibilityAction2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$3();
            } else {
                accessibilityAction2 = null;
            }
            ACTION_SET_PROGRESS = new AccessibilityActionCompat(accessibilityAction2, 16908349, (CharSequence) null, (AccessibilityViewCommand) null, AccessibilityViewCommand.SetProgressArguments.class);
            if (Build.VERSION.SDK_INT >= 28) {
                accessibilityAction3 = AccessibilityNodeInfo.AccessibilityAction.ACTION_HIDE_TOOLTIP;
            } else {
                accessibilityAction3 = null;
            }
            ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(accessibilityAction3, 16908357, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
            if (Build.VERSION.SDK_INT >= 30) {
                accessibilityAction4 = AccessibilityNodeInfo.AccessibilityAction.ACTION_PRESS_AND_HOLD;
            } else {
                accessibilityAction4 = null;
            }
            ACTION_PRESS_AND_HOLD = new AccessibilityActionCompat(accessibilityAction4, 16908362, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
            if (Build.VERSION.SDK_INT >= 30) {
                accessibilityAction5 = AccessibilityNodeInfo.AccessibilityAction.ACTION_IME_ENTER;
            } else {
                accessibilityAction5 = null;
            }
            ACTION_IME_ENTER = new AccessibilityActionCompat(accessibilityAction5, 16908372, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
            if (Build.VERSION.SDK_INT >= 32) {
                accessibilityAction6 = AccessibilityNodeInfo.AccessibilityAction.ACTION_DRAG_START;
            } else {
                accessibilityAction6 = null;
            }
            ACTION_DRAG_START = new AccessibilityActionCompat(accessibilityAction6, 16908373, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
            if (Build.VERSION.SDK_INT >= 32) {
                accessibilityAction7 = AccessibilityNodeInfo.AccessibilityAction.ACTION_DRAG_DROP;
            } else {
                accessibilityAction7 = null;
            }
            ACTION_DRAG_DROP = new AccessibilityActionCompat(accessibilityAction7, 16908374, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
    ...
    public boolean isImportantForAccessibility() {
        if (Build.VERSION.SDK_INT >= 24) {
            return AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(this.mInfo);
        }
        return true;
    }
    ...
    public CharSequence getTooltipText() {
        if (Build.VERSION.SDK_INT >= 28) {
            return AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mInfo);
        }
    ...
    public CharSequence getPaneTitle() {
        if (Build.VERSION.SDK_INT >= 28) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(this.mInfo);
        }
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        ...
        if (Build.VERSION.SDK_INT < 29 || (m = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m(this.mInfo)) == null) {
            return null;
        }
