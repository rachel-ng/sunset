        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j4) {
                ...
                if (b3 >= 0) {
                    ...
                    long j6 = 2 + j4;
                    byte b4 = (UnsafeUtil.getByte(j5) << 7) ^ b3;
                    if (b4 < 0) {
                        b2 = b4 ^ Byte.MIN_VALUE;
                    } else {
                        long j7 = 3 + j4;
                        byte b5 = b4 ^ (UnsafeUtil.getByte(j6) << 14);
                        if (b5 >= 0) {
                            j = (long) (b5 ^ 16256);
                            j6 = j7;
                        } else {
                            ...
                            if (b6 < 0) {
                                ...
                                long j8 = 5 + j4;
                                long j9 = ((long) b6) ^ (((long) UnsafeUtil.getByte(j6)) << 28);
                                if (j9 >= 0) {
                                    j3 = 266354560;
                                } else {
                                    long j10 = 6 + j4;
        ...
        public int readRawVarint32() throws IOException {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (b4 >= 0) {
                    ...
                    long j3 = 2 + j;
                    byte b5 = (UnsafeUtil.getByte(j2) << 7) ^ b4;
                    if (b5 < 0) {
                        b2 = b5 ^ Byte.MIN_VALUE;
                    } else {
                        long j4 = 3 + j;
                        byte b6 = (UnsafeUtil.getByte(j3) << 14) ^ b5;
                        if (b6 >= 0) {
                            b3 = b6 ^ 16256;
                        } else {
                            long j5 = 4 + j;
                            byte b7 = b6 ^ (UnsafeUtil.getByte(j4) << Ascii.NAK);
                            if (b7 < 0) {
                                b2 = -2080896 ^ b7;
                            } else {
                                j4 = 5 + j;
                                byte b8 = UnsafeUtil.getByte(j5);
                                byte b9 = (b7 ^ (b8 << Ascii.FS)) ^ 266354560;
                                if (b8 < 0) {
                                    j5 = 6 + j;
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (b2 >= 0) {
                    ...
                    if (b3 < 0) {
                        ...
                        long j7 = 3 + j4;
                        byte b4 = (UnsafeUtil.getByte(j6) << 14) ^ b3;
                        if (b4 >= 0) {
                            j = (long) (b4 ^ 16256);
                            j6 = j7;
                        } else {
                            ...
                            if (b5 < 0) {
                                ...
                                long j9 = 5 + j4;
                                long j10 = (((long) UnsafeUtil.getByte(j8)) << 28) ^ ((long) b5);
                                if (j10 >= 0) {
                                    j3 = 266354560;
                                } else {
                                    long j11 = 6 + j4;
