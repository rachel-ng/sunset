...
public class Motion implements TypedValues {
    ...
    public MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.f15top = this.mStartMotionPath.y;
        floatRect.right = floatRect.left + this.mStartMotionPath.width;
        floatRect.bottom = floatRect.f15top + this.mStartMotionPath.height;
        FloatRect floatRect2 = new FloatRect();
        floatRect2.left = this.mEndMotionPath.x;
        floatRect2.f15top = this.mEndMotionPath.y;
        floatRect2.right = floatRect2.left + this.mEndMotionPath.width;
        floatRect2.bottom = floatRect2.f15top + this.mEndMotionPath.height;
    ...
    public void setStartState(ViewState viewState, MotionWidget motionWidget, int i, int i2, int i3) {
        ...
        if (i == 1) {
            ...
            rect.left = ((viewState.f17top + viewState.bottom) - viewState.width()) / 2;
            rect.f16top = i2 - ((i4 + viewState.height()) / 2);
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f16top + viewState.height();
        } else if (i == 2) {
            int i5 = viewState.left + viewState.right;
            rect.left = i3 - (((viewState.f17top + viewState.bottom) + viewState.width()) / 2);
            rect.f16top = (i5 - viewState.height()) / 2;
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f16top + viewState.height();
        }
        this.mStartMotionPath.setBounds((float) rect.left, (float) rect.f16top, (float) rect.width(), (float) rect.height());
    ...
    public void rotate(Rect rect, Rect rect2, int i, int i2, int i3) {
        if (i == 1) {
            ...
            rect2.left = ((rect.f16top + rect.bottom) - rect.width()) / 2;
            rect2.f16top = i3 - ((i4 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f16top + rect.height();
        } else if (i == 2) {
            int i5 = rect.left + rect.right;
            rect2.left = i2 - (((rect.f16top + rect.bottom) + rect.width()) / 2);
            rect2.f16top = (i5 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f16top + rect.height();
        } else if (i == 3) {
            ...
            int i7 = rect.f16top;
            int i8 = rect.bottom;
            rect2.left = ((rect.height() / 2) + rect.f16top) - (i6 / 2);
            rect2.f16top = i3 - ((i6 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f16top + rect.height();
        } else if (i == 4) {
            int i9 = rect.left + rect.right;
            rect2.left = i2 - (((rect.bottom + rect.f16top) + rect.width()) / 2);
            rect2.f16top = (i9 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f16top + rect.height();
        }
    }
