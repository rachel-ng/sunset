    ...
    public CLObject parse() throws CLParsingException {
        ...
        if (i2 != -1) {
            ...
            while (i3 < length) {
                ...
                if (cLElement.isDone()) {
                    cLElement = getNextJsonElement(i3, c4, cLElement, charArray);
                    ...
                    if (!z2) {
                        if (cLElement instanceof CLToken) {
                            ...
                            if (!cLToken.validate(c4, (long) i3)) {
                                throw new CLParsingException("parsing incorrect token " + cLToken.content() + " at line " + this.lineNumber, cLToken);
                            }
                        }
                        if (((cLElement instanceof CLKey) || z2) && (((c2 = charArray[(int) cLElement.start]) == '\'' || c2 == '\"') && c2 == c4)) {
                            cLElement.setStart(cLElement.start + 1);
                            cLElement.setEnd((long) (i3 - 1));
                        }
                        if (!cLElement.isDone() && (c4 == '}' || c4 == ']' || c4 == ',' || c4 == ' ' || c4 == 9 || c4 == 13 || c4 == 10 || c4 == ':')) {
                            long j = (long) (i3 - 1);
                            cLElement.setEnd(j);
                            if (c4 == '}' || c4 == ']') {
