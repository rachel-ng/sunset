    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m986constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m986constructorimpl(Unit.INSTANCE);
        if (Result.m993isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m360successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m358closedJP2dKIU(Result.m989exceptionOrNullimpl(obj2));
        }
