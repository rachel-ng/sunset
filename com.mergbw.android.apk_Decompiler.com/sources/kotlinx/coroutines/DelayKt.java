...
public final class DelayKt {
    ...
    public static final Object m324delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m325toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m325toDelayMillisLRDsOJo(long j) {
        if (Duration.m151compareToLRDsOJo(j, Duration.Companion.m254getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m170getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
