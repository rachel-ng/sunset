...
class Platform {
    ...
    Platform(boolean z) {
        ...
        if (z) {
            try {
                constructor = Platform$$ExternalSyntheticApiModelOutline0.m$2().getDeclaredConstructor(new Class[]{Class.class, Integer.TYPE});
    ...
    public Object invokeDefaultMethod(Method method, Class<?> cls, Object obj, Object... objArr) throws Throwable {
        ...
        if (constructor != null) {
            lookup = Platform$$ExternalSyntheticApiModelOutline0.m((Object) constructor.newInstance(new Object[]{cls, -1}));
        } else {
            lookup = Platform$$ExternalSyntheticApiModelOutline0.m();
        }
