...
public final class UMathKt {
    ...
    private static final int m2205minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2187minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m2206mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m2195minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m2203maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2175maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m2204maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m2183maxOfeb3DHEI(j, j2);
    }
}
