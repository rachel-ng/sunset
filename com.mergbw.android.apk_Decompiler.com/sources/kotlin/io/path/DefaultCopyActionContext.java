...
final class DefaultCopyActionContext implements CopyActionContext {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0038, code lost:
        if (java.nio.file.Files.isDirectory(r6, (java.nio.file.LinkOption[]) java.util.Arrays.copyOf(new java.nio.file.LinkOption[]{kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()}, 1)) == false) goto L_0x003a;
     */
