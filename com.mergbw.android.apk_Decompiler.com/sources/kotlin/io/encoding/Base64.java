...
public class Base64 {
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        int i5 = i2;
        int i6 = i3;
        Intrinsics.checkNotNullParameter(bArr3, FirebaseAnalytics.Param.SOURCE);
        Intrinsics.checkNotNullParameter(bArr4, FirebaseAnalytics.Param.DESTINATION);
        ...
        while (i5 + 2 < i6) {
            ...
            for (int i9 = 0; i9 < min; i9++) {
                int i10 = i5 + 2;
                i5 += 3;
                byte b2 = ((bArr3[i5 + 1] & 255) << 8) | ((bArr3[i5] & 255) << 16) | (bArr3[i10] & 255);
                bArr4[i8] = access$getBase64UrlEncodeMap$p[b2 >>> Ascii.DC2];
                bArr4[i8 + 1] = access$getBase64UrlEncodeMap$p[(b2 >>> 12) & 63];
                int i11 = i8 + 3;
                bArr4[i8 + 2] = access$getBase64UrlEncodeMap$p[(b2 >>> 6) & 63];
                i8 += 4;
                bArr4[i11] = access$getBase64UrlEncodeMap$p[b2 & Utf8.REPLACEMENT_BYTE];
            }
            if (min == i7 && i5 != i6) {
                int i12 = i8 + 1;
    ...
    private final int decodeImpl(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            byte b2 = bArr3[i9] & 255;
            int i13 = access$getBase64UrlDecodeMap$p[b2];
            if (i13 >= 0) {
                i9++;
                i8 = (i8 << 6) | i13;
                int i14 = i7 + 6;
                ...
                sb.append((char) b2);
                sb.append("'(");
                String num = Integer.toString(b2, CharsKt.checkRadix(8));
        ...
        if (i7 != -2) {
            ...
            byte b3 = bArr3[skipIllegalSymbolsIfMime] & 255;
            StringBuilder sb2 = new StringBuilder("Symbol '");
            sb2.append((char) b3);
            sb2.append("'(");
            String num2 = Integer.toString(b3, CharsKt.checkRadix(8));
