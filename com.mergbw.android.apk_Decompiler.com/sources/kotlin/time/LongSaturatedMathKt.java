...
public final class LongSaturatedMathKt {
    ...
    public static final long m280saturatingAddpTJri5U(long j, long j2) {
        long r4 = Duration.m172getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m279checkInfiniteSumDefinedPjuGub4(j, j2, r4);
        }
        if ((1 | (r4 - 1)) == Long.MAX_VALUE) {
            return m281saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + r4;
        if (((j ^ j3) & (r4 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m279checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m184isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m281saturatingAddInHalvespTJri5U(long j, long j2) {
        long r0 = Duration.m155divUwyO8pc(j2, 2);
        if (((Duration.m172getInWholeNanosecondsimpl(r0) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (((double) j) + Duration.m195toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m280saturatingAddpTJri5U(m280saturatingAddpTJri5U(j, r0), Duration.m187minusLRDsOJo(j2, r0));
    }

    public static final long saturatingDiff(long j, long j2) {
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m204unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            ...
            return Duration.m188plusLRDsOJo(duration, DurationKt.toDuration(j5, DurationUnit.NANOSECONDS));
        }
