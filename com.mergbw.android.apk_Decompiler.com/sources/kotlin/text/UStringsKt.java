...
public final class UStringsKt {
    ...
    public static final String m124toStringLxnNnR4(byte b2, int i) {
    ...
    public static final String m126toStringolVBNx4(short s, int i) {
    ...
    public static final String m125toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m123toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m1054unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m1317unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m1133unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m1212unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1133unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m1081constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m998boximpl(UByte.m1004constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1133unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m1081constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1261boximpl(UShort.m1267constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m1081constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m1081constructorimpl(i3 * r3);
            int r7 = UInt.m1081constructorimpl(UInt.m1081constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m1160constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m1160constructorimpl(j * r5);
            long r13 = ULong.m1160constructorimpl(ULong.m1160constructorimpl(((long) UInt.m1081constructorimpl(digitOf)) & 4294967295L) + r9);
